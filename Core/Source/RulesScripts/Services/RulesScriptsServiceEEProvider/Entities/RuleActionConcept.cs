 ...
 * Template: Sistran.Core.Application.RulesScriptsServices.EEProvider.RuleActionConcept.dict v1.0
 * FileSize=5574 Header=278 CRC=1685640835
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad RuleActionConcept.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.RulesScriptsServices.EEProvider.RuleActionConcept.dict"),
    Serializable(),
    DescriptionKey("RULE_ACTION_CONCEPT_ENTITY"),
    TableMap(TableName="RULE_ACTION_CONCEPT", Schema="SCR"),
    ]
    public partial class RuleActionConcept :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<RuleActionConcept>(ruleBaseId, entityId, conceptId);
		}
#endregion
	    ...
	    public RuleActionConcept(int ruleBaseId, int entityId, int conceptId):
			this(RuleActionConcept.CreatePrimaryKey(ruleBaseId, entityId, conceptId), null)
	    {
	    }
		...
		/// </param>
	    public RuleActionConcept(PrimaryKey key, IDictionary initialValues):
