 ...
 * Template: Sistran.Core.Application.AutomaticDebitServices.EEProvider.AppliedCouponsView.dict v1.0
 * FileSize=34318 Header=280 CRC=2645687396
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AppliedCouponsV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AutomaticDebitServices.EEProvider.AppliedCouponsView.dict"),
    Serializable(),
    DescriptionKey("APPLIED_COUPONS_V_ENTITY"),
    TableMap(TableName="APPLIED_COUPONS_V", Schema="ACC"),
    ]
    public partial class AppliedCouponsView :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<AppliedCouponsView>(bankNetworkId);
		}
#endregion
	    ...
	    public AppliedCouponsView(int bankNetworkId):
			this(AppliedCouponsView.CreatePrimaryKey(bankNetworkId), null)
	    {
	    }
		...
		/// </param>
	    public AppliedCouponsView(PrimaryKey key, IDictionary initialValues):
