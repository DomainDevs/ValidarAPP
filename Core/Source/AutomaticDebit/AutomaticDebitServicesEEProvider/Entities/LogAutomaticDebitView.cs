 ...
 * Template: Sistran.Core.Application.AutomaticDebitServices.EEProvider.LogAutomaticDebitView.dict v1.0
 * FileSize=13547 Header=281 CRC=43107660
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad LogAutomaticDebitV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AutomaticDebitServices.EEProvider.LogAutomaticDebitView.dict"),
    Serializable(),
    DescriptionKey("LOG_AUTOMATIC_DEBIT_V_ENTITY"),
    TableMap(TableName="LOG_AUTOMATIC_DEBIT_V", Schema="ACC"),
    ]
    public partial class LogAutomaticDebitView :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int logAutomaticDebitId, int? automaticDebitStatusId)
	    {
		...
		/// <param name="logAutomaticDebitId">Propiedad clave LogAutomaticDebitId.</param>
		/// <param name="automaticDebitStatusId">Propiedad clave AutomaticDebitStatusId.</param>
		public static PrimaryKey CreatePrimaryKey(int logAutomaticDebitId, int? automaticDebitStatusId)
	    {
			return InternalCreatePrimaryKey<LogAutomaticDebitView>(logAutomaticDebitId, automaticDebitStatusId);
		}
#endregion
		...
		/// <summary>
		/// Atributo para la propiedad ShipmentId.
		/// </summary>
        private string _shipmentId = null;
	    //*** Object Constructors ********************************
	    ...
	    public LogAutomaticDebitView(int logAutomaticDebitId, int? automaticDebitStatusId):
			this(LogAutomaticDebitView.CreatePrimaryKey(logAutomaticDebitId, automaticDebitStatusId), null)
	    {
	    }
		...
		/// </param>
	    public LogAutomaticDebitView(PrimaryKey key, IDictionary initialValues):
