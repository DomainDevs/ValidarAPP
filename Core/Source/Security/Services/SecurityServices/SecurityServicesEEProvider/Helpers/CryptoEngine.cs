...
namespace Sistran.Core.Application.SecurityServices.EEProvider.Helper
{
    /// <summary>
    ...
    public class CryptoEngine
    {
        ...
        public CryptoEngine()
        {
            if (_parameter == null)
            {
                _parameter = DelegateService.commonServiceCore.GetParameterByDescription("ENCRIPTION_RATE");
            }
            this.m_nBoxLen = (long)CryptoEngine._parameter.NumberParameter;
        ...
        public bool Encrypt()
        {
            ...
            try
            {
                ...
                // change format ISO_LATIN
                Encoding enc_default = Encoding.GetEncoding("Windows-1252");
        ...
        //
        protected byte[] m_nBox;
        //
        // Len of nBox
        //
        public long m_nBoxLen;
