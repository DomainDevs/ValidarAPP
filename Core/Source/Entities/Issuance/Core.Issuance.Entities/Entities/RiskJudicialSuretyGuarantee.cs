 ...
 * Template: Sistran.Core.Application.Issuance.RiskJudicialSuretyGuarantee.dict v1.0
...
{
    /// <summary>
    /// Definición de entidad RiskJudicialSuretyGuarantee.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.RiskJudicialSuretyGuarantee.dict"),
    Serializable(),
    DescriptionKey("RISK_JUDICIAL_SURETY_GUARANTEE_ENTITY"),
    TableMap(TableName = "RISK_JUDICIAL_SURETY_GUARANTEE", Schema = "ISS"),
    ]
    public partial class RiskJudicialSuretyGuarantee :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<RiskJudicialSuretyGuarantee>(riskId, guaranteeId);
        }
        #endregion
        ...
        public RiskJudicialSuretyGuarantee(int riskId, int guaranteeId) :
            this(RiskJudicialSuretyGuarantee.CreatePrimaryKey(riskId, guaranteeId), null)
        {
        }
        ...
        /// </param>
        public RiskJudicialSuretyGuarantee(PrimaryKey key, IDictionary initialValues) :
