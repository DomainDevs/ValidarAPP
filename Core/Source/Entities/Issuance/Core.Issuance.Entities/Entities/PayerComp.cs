 ...
 * Template: Sistran.Core.Application.Issuance.PayerComp.dict v1.0
 * FileSize=19664 Header=249 CRC=3702144119
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad PayerComp.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.PayerComp.dict"),
    Serializable(),
    DescriptionKey("PAYER_COMP_ENTITY"),
    TableMap(TableName = "PAYER_COMP", Schema = "ISS"),
    ]
    public partial class PayerComp :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        public static class Properties
        {
			...
			public static readonly string ComponentAmountLocal = "ComponentAmountLocal";
        }
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int endorsementId, int policyId, int payerCompId, int componentCode, int payerId)
        {
        ...
        /// <param name="componentCode">Propiedad clave ComponentCode.</param>
        /// <param name="payerId">Propiedad clave PayerId.</param>
        public static PrimaryKey CreatePrimaryKey(int endorsementId, int policyId, int payerCompId, int componentCode, int payerId)
        {
            return InternalCreatePrimaryKey<PayerComp>(endorsementId, policyId, payerCompId, componentCode, payerId);
        }
        #endregion
		...
		/// <summary>
        /// Atributo para la propiedad ComponentAmountLocal.
        /// </summary>
        private decimal _componentAmountLocal;
        //*** Object Constructors ********************************
        ...
        public PayerComp(int endorsementId, int policyId, int payerCompId, int componentCode, int payerId) :
            this(PayerComp.CreatePrimaryKey(endorsementId, policyId, payerCompId, componentCode, payerId), null)
        {
        }
        ...
        /// </param>
        public PayerComp(PrimaryKey key, IDictionary initialValues) :
        ...
        /// <value>Propiedad ComponentAmount.</value>
        [
        DescriptionKey("COMPONENT_AMOUNT_LOCAL_PROPERTY"),
        PersistentProperty(),
        ColumnMap(ColumnName = "COMPONENT_AMOUNT_LOCAL", DbType = System.Data.DbType.Decimal),
        ]
        public decimal ComponentAmountLocal
        {
            get
            {
                return this._componentAmountLocal;
            }
            set
            {
                this._componentAmountLocal = value;
            }
        }
