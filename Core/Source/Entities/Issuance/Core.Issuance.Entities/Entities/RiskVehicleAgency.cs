 ...
 * Template: Sistran.Core.Application.Issuance.RiskVehicleAgency.dict v1.0
 * FileSize=13864 Header=256 CRC=174586799
 ******************************************/
...
namespace Sistran.Core.Application.Issuance.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.RiskVehicleAgency.dict"),
    Serializable(),
    DescriptionKey("RISK_VEHICLE_AGENCY_ENTITY"),
    TableMap(TableName = "RISK_VEHICLE_AGENCY", Schema = "ISS"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<RiskVehicleAgency>(riskId);
        }
        #endregion
        ...
        public RiskVehicleAgency(int riskId) :
            this(RiskVehicleAgency.CreatePrimaryKey(riskId), null)
        {
        }
