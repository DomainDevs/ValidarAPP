 ...
 * Template: Sistran.Core.Application.Issuance.RiskDetailDescription.dict v1.0
 * FileSize=4016 Header=260 CRC=3466388553
 ******************************************/
...
namespace Sistran.Core.Application.Issuance.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.RiskDetailDescription.dict"),
    Serializable(),
    DescriptionKey("RISK_DETAIL_DESCRIPTION_ENTITY"),
    TableMap(TableName = "RISK_DETAIL_DESCRIPTION", Schema = "ISS"),
    ]
