 ...
 * Template: Sistran.Core.Application.Issuance.CoRisk.dict v1.0
 * FileSize=5088 Header=244 CRC=625619208
 ******************************************/
...
namespace Sistran.Core.Application.Issuance.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.CoRisk.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<CoRisk>(riskId);
        }
        #endregion
        ...
        public CoRisk(int riskId) :
            this(CoRisk.CreatePrimaryKey(riskId), null)
        {
        }
