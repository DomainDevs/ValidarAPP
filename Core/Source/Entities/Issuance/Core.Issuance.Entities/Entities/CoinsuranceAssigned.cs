 ...
 * Template: Sistran.Core.Application.Issuance.CoinsuranceAssigned.dict v1.0
 * FileSize=7320 Header=258 CRC=1500562077
 ******************************************/
...
namespace Sistran.Core.Application.Issuance.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.CoinsuranceAssigned.dict"),
    Serializable(),
    DescriptionKey("COINSURANCE_ASSIGNED_ENTITY"),
    TableMap(TableName = "COINSURANCE_ASSIGNED", Schema = "ISS"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<CoinsuranceAssigned>(endorsementId, policyId, insuranceCompanyId);
        }
        #endregion
        ...
        public CoinsuranceAssigned(int endorsementId, int policyId, decimal insuranceCompanyId) :
            this(CoinsuranceAssigned.CreatePrimaryKey(endorsementId, policyId, insuranceCompanyId), null)
        {
        }
