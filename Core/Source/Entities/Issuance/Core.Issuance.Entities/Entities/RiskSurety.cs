 ...
 * Template: Sistran.Core.Application.Issuance.RiskSurety.dict v1.0
 * FileSize=10111 Header=250 CRC=2559209802
 ******************************************/
...
namespace Sistran.Core.Application.Issuance.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.RiskSurety.dict"),
    Serializable(),
    DescriptionKey("RISK_SURETY_ENTITY"),
    TableMap(TableName = "RISK_SURETY", Schema = "ISS"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<RiskSurety>(riskId);
        }
        #endregion
        ...
        public RiskSurety(int riskId) :
            this(RiskSurety.CreatePrimaryKey(riskId), null)
        {
        }
