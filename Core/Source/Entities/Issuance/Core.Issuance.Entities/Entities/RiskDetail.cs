 ...
 * Template: Sistran.Core.Application.Issuance.RiskDetail.dict v1.0
 * FileSize=4508 Header=248 CRC=701447294
 ******************************************/
...
namespace Sistran.Core.Application.Issuance.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Issuance.RiskDetail.dict"),
    Serializable(),
    DescriptionKey("RISK_DETAIL_ENTITY"),
    TableMap(TableName = "RISK_DETAIL", Schema = "ISS"),
    ]
