 ...
 * Template: Sistran.Core.Application.Parameters.DirectoryType.dict v1.0
 * FileSize=4920 Header=253 CRC=300528945
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad DirectoryType.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Parameters.DirectoryType.dict"),
    Serializable(),
    DescriptionKey("DIRECTORY_TYPE_ENTITY"),
    TableMap(TableName = "DIRECTORY_TYPE", Schema = "PARAM"),
    ]
        ...
        BusinessObject2
    {
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int directoryTypeCode)
        {
        ...
        /// </summary>
        /// <param name="directoryTypeCode">Propiedad clave DirectoryTypeCode.</param>
        public static PrimaryKey CreatePrimaryKey(int directoryTypeCode)
        {
            return InternalCreatePrimaryKey<DirectoryType>(directoryTypeCode);
        }
        #endregion
        ...
        public DirectoryType(int directoryTypeCode) :
            this(DirectoryType.CreatePrimaryKey(directoryTypeCode), null)
        {
        }
        ...
        /// </param>
        public DirectoryType(PrimaryKey key, IDictionary initialValues) :
