 ...
 * Template: Sistran.Core.Application.Parameters.PrintStatus.dict v1.0
 * FileSize=3724 Header=261 CRC=1158697802
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad PrintStatus.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Parameters.PrintStatus.dict"),
    Serializable(),
    DescriptionKey("PRINT_STATUS_ENTITY"),
    TableMap(TableName="PRINT_STATUS", Schema="PARAM"),
    ]
...
#region static
	    ...
	    {
			return InternalCreatePrimaryKey<PrintStatus>(id);
		}
		...
		{
			return InternalCreatePrimaryKey<PrintStatus>();
		}
		#endregion
	    ...
	    public PrintStatus(int id):
			this(PrintStatus.CreatePrimaryKey(id), null)
	    {
	    }
		...
		/// <param name="id">Id key property.</param>
		public PrintStatus() :
			this(PrintStatus.CreatePrimaryKey(), null)
		{
		}
		...
		/// </param>
		public PrintStatus(PrimaryKey key, IDictionary initialValues):
