 ...
 * Template: Sistran.Core.Application.Parameters.PaymentMethodType.dict v1.0
 * FileSize=5048 Header=258 CRC=3020638470
 ******************************************/
...
namespace Sistran.Core.Application.Parameters.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Parameters.PaymentMethodType.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.PaymentMethodTypeCode, null);
        ...
        {
            return InternalCreatePrimaryKey<PaymentMethodType>();
        }
        #endregion
        ...
        public PaymentMethodType() :
           this(PaymentMethodType.CreatePrimaryKey(), null)
        {
        }
