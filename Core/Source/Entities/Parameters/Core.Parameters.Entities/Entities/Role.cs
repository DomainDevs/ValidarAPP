 ...
 * Template: Sistran.Core.Application.Parameters.Role.dict v1.0
 * FileSize=3773 Header=245 CRC=1380356706
 ******************************************/
...
namespace Sistran.Core.Application.Parameters.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Parameters.Role.dict"),
    Serializable(),
    DescriptionKey("ROLE_ENTITY"),
    TableMap(TableName = "ROLE", Schema = "PARAM"),
    ]
