 ...
 * Template: Sistran.Core.Application.Parameters.DefaultValues.dict v1.0
 * FileSize=7605 Header=254 CRC=2143720497
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad DefaultValues.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Parameters.DefaultValues.dict"),
    Serializable(),
    DescriptionKey("DEFAULT_VALUES_ENTITY"),
    TableMap(TableName = "DEFAULT_VALUES", Schema = "PARAM"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<DefaultValues>(valueId);
        }
        #endregion
        ...
        /// <summary>
        /// Atributo para la propiedad DefaultValue.
        /// </summary>
        ...
        public DefaultValues(int valueId) :
            this(DefaultValues.CreatePrimaryKey(valueId), null)
        {
        }
        ...
        /// </param>
        public DefaultValues(PrimaryKey key, IDictionary initialValues) :
        ...
        /// <summary>
        /// Devuelve o setea el valor de la propiedad DefaultValue.
        /// </summary>
        /// <value>Propiedad DefaultValue.</value>
        [
        DescriptionKey("DEFAULT_VALUE_PROPERTY"),
        PersistentProperty(IsNullable = true),
        ColumnMap(ColumnName = "DEFAULT_VALUE", DbType = System.Data.DbType.String),
        ]
