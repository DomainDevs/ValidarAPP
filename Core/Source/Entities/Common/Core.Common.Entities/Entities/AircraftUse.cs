 ...
 * Template: Sistran.Core.Application.Common.AircraftUse.dict v1.0
 * FileSize=5464 Header=248 CRC=1753521223
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AircraftUse.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.AircraftUse.dict"),
    Serializable(),
    DescriptionKey("AIRCRAFT_USE_ENTITY"),
    TableMap(TableName="AIRCRAFT_USE", Schema="COMM"),
    ]
    public partial class AircraftUse :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int aircraftUseCode)
	    {
        ...
        /// </summary>
        /// <param name="aircraftUseCode">Propiedad clave AircraftUseCode.</param>
        public static PrimaryKey CreatePrimaryKey(int aircraftUseCode)
	    {
			return InternalCreatePrimaryKey<AircraftUse>(aircraftUseCode);
		}

        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<AircraftUse>();
        }
        #endregion
	    ...
	    public AircraftUse(int aircraftUseCode):
			this(AircraftUse.CreatePrimaryKey(aircraftUseCode), null)
	    {
	    }

        public AircraftUse() :
           this(AircraftUse.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public AircraftUse(PrimaryKey key, IDictionary initialValues):
