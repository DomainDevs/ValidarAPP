 ...
 * Template: Sistran.Core.Application.Common.AircraftType.dict v1.0
 * FileSize=5495 Header=249 CRC=3083941481
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AircraftType.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.AircraftType.dict"),
    Serializable(),
    DescriptionKey("AIRCRAFT_TYPE_ENTITY"),
    TableMap(TableName="AIRCRAFT_TYPE", Schema="COMM"),
    ]
...
#region static
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int aircraftTypeCode)
	    {
        ...
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.AircraftTypeCode, null);
        ...
        /// </summary>
        /// <param name="aircraftTypeCode">Propiedad clave AircraftTypeCode.</param>
        public static PrimaryKey CreatePrimaryKey(int aircraftTypeCode)
	    {
			return InternalCreatePrimaryKey<AircraftType>(aircraftTypeCode);
		}
        ...
        {
            return InternalCreatePrimaryKey<AircraftType>();
        }
        #endregion
	    ...
	    public AircraftType(int aircraftTypeCode):
			this(AircraftType.CreatePrimaryKey(aircraftTypeCode), null)
	    {
	    }
        ...
        /// </summary>
        public AircraftType() :
           this(AircraftType.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public AircraftType(PrimaryKey key, IDictionary initialValues):
