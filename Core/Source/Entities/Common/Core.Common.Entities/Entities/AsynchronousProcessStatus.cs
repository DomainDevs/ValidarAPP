 ...
 * Template: Sistran.Core.Application.Common.AsynchronousProcessStatus.dict v1.0
 * FileSize=4405 Header=261 CRC=475587933
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad AsynchronousProcessStatus.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.AsynchronousProcessStatus.dict"),
    Serializable(),
    DescriptionKey("ASYNCHRONOUS_PROCESS_STATUS_ENTITY"),
    TableMap(TableName = "ASYNCHRONOUS_PROCESS_STATUS", Schema = "COMM"),
    ]
    public partial class AsynchronousProcessStatus :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<AsynchronousProcessStatus>(id);
        }
        #endregion
        ...
        public AsynchronousProcessStatus(int id) :
            this(AsynchronousProcessStatus.CreatePrimaryKey(id), null)
        {
        }
        ...
        /// </param>
        public AsynchronousProcessStatus(PrimaryKey key, IDictionary initialValues) :
