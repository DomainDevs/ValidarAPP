 ...
 * Template: Sistran.Core.Application.Common.Parameter.dict v1.0
 * FileSize=8237 Header=246 CRC=2594803644
 ******************************************/
...
namespace Sistran.Core.Application.Common.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.Parameter.dict"),
    Serializable(),
    DescriptionKey("PARAMETER_ENTITY"),
    TableMap(TableName = "PARAMETER", Schema = "COMM"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<Parameter>();
        }
        /// <summary>
        ...
        //*** Object Constructors ********************************
        public Parameter() :
            this(Parameter.CreatePrimaryKey(), null)
        {
        }
        /// <summary>
