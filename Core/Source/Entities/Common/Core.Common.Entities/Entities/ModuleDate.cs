 ...
 * Template: Sistran.Core.Application.Common.ModuleDate.dict v1.0
 * FileSize=8850 Header=245 CRC=73260843
 ******************************************/
...
namespace Sistran.Core.Application.Common.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.ModuleDate.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<ModuleDate>();
        }
        ...
        public ModuleDate() :
           this(ModuleDate.CreatePrimaryKey(), null)
        {
        }
        /// <summary>
        /// Constructor de instancia de la clase en base a las propiedades claves.
