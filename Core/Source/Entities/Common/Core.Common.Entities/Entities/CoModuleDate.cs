 ...
 * Template: Sistran.Core.Application.Common.CoModuleDate.dict v1.0
 * FileSize=8870 Header=249 CRC=1973967879
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Common.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.CoModuleDate.dict"),
    Serializable(),
    DescriptionKey("CO_MODULE_DATE_ENTITY"),
    TableMap(TableName="CO_MODULE_DATE", Schema="COMM"),
    ]
    public partial class CoModuleDate :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<CoModuleDate>(moduleCode);
		}
#endregion
