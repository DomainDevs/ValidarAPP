 ...
 * Template: Sistran.Core.Application.Common.EconomicActivity.dict v1.0
...
{
    /// <summary>
    /// Definición de entidad EconomicActivity.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.EconomicActivity.dict"),
    Serializable(),
    DescriptionKey("ECONOMIC_ACTIVITY_ENTITY"),
    TableMap(TableName = "ECONOMIC_ACTIVITY", Schema = "COMM"),
    ]
        ...
        BusinessObject2
    {
        ...
        public EconomicActivity() :
                   this(EconomicActivity.CreatePrimaryKey(), null)
        { }
        ...
        public EconomicActivity(int economicActivityCode) :
        ...
        /// </param>
        public EconomicActivity(PrimaryKey key, IDictionary initialValues) :
