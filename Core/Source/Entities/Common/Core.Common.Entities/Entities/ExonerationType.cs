 ...
 * Template: Sistran.Core.Application.Common.ExonerationType.dict v1.0
 * FileSize=6324 Header=252 CRC=3778471460
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad ExonerationType.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.ExonerationType.dict"),
    Serializable(),
    DescriptionKey("EXONERATION_TYPE_ENTITY"),
    TableMap(TableName="EXONERATION_TYPE", Schema="COMM"),
    ]
    public partial class ExonerationType :
        BusinessObject2
    {
#region static
		/// <summary>
		...
		/// <param name="exonerationTypeCode">Propiedad clave ExonerationTypeCode.</param>
		/// <returns>Clave primaria.</returns>
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int exonerationTypeCode)
	    {
		    Dictionary<string, object> keys = new Dictionary<string, object>();
		    keys.Add(Properties.ExonerationTypeCode, exonerationTypeCode);
		...
		/// </summary>
		/// <param name="exonerationTypeCode">Propiedad clave ExonerationTypeCode.</param>
		public static PrimaryKey CreatePrimaryKey(int exonerationTypeCode)
	    {
			return InternalCreatePrimaryKey<ExonerationType>(exonerationTypeCode);
		}
#endregion
		...
		/// </summary>
		/// <param name="exonerationTypeCode">ExonerationTypeCode key property.</param>
	    public ExonerationType(int exonerationTypeCode):
			this(ExonerationType.CreatePrimaryKey(exonerationTypeCode), null)
	    {
	    }
		...
		/// </param>
	    public ExonerationType(PrimaryKey key, IDictionary initialValues):
        ...
        public int ExonerationTypeCode
	    {
		    get
		    {
				return (int)this._primaryKey[Properties.ExonerationTypeCode];
		    }
		    set
		    {
				this._primaryKey[Properties.ExonerationTypeCode] = value;
			}
	    }
