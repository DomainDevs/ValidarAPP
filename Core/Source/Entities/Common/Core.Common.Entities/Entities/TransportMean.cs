 ...
 * Template: Sistran.Core.Application.Common.TransportMean.dict v1.0
 * FileSize=5526 Header=249 CRC=352797924
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Common.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.TransportMean.dict"),
    Serializable(),
...
#region static
        ...
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.TransportMeanCode, null);
        ...
        {
            return InternalCreatePrimaryKey<TransportMean>();
        }
        #endregion
        ...
        public TransportMean() :
            this(TransportMean.CreatePrimaryKey(), null)
        {
        }
