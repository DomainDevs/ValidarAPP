 ...
 * Template: CPT.CoInfringementState.dict v1.0
 * FileSize=4135 Header=227 CRC=970809678
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Common.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.CoInfringementState.dict"),
    Serializable(),
