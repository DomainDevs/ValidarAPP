 ...
 * Template: Sistran.Core.Application.Common.FieldType.dict v1.0
 * FileSize=3679 Header=246 CRC=1492261836
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad FieldType.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Common.FieldType.dict"),
    Serializable(),
    DescriptionKey("FIELD_TYPE_ENTITY"),
    TableMap(TableName = "FIELD_TYPE", Schema = "COMM"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<FieldType>(id);
        }
        #endregion
        ...
        public FieldType(int id) :
            this(FieldType.CreatePrimaryKey(id), null)
        {
        }
        ...
        /// </param>
        public FieldType(PrimaryKey key, IDictionary initialValues) :
