 ...
 * Template: Sistran.Core.Application.UniqueUser.Parameter.dict v1.0
 * FileSize=8243 Header=249 CRC=209028397
 ******************************************/
...
namespace Sistran.Core.Application.UniqueUser.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniqueUser.Parameter.dict"),
    Serializable(),
    DescriptionKey("PARAMETER_ENTITY"),
    TableMap(TableName = "PARAMETER", Schema = "UU"),
    ]
