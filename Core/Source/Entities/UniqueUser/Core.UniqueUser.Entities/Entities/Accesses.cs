 ...
 * Template: Sistran.Core.Application.UniqueUser.Accesses.dict v1.0
 * FileSize=8564 Header=249 CRC=2527774172
 ******************************************/
...
namespace Sistran.Core.Application.UniqueUser.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniqueUser.Accesses.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        /// <summary>
        /// Indicate if ParentAccessId property value is null.
        /// </summary>
        private bool _isParentAccessIdNull = true;
        /// <summary>
        ...
        /// <summary>
        /// Indicate if AccessObjectId property value is null.
        /// </summary>
        private bool _isAccessObjectIdNull = true;
        //*** Object Constructors ********************************

        public Accesses() :
            this(Accesses.CreatePrimaryKey(), null)
        {
        }
        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<Accesses>();
        }
        protected static PrimaryKey InternalCreatePrimaryKey<T>()
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.AccessId, null);
        ...
        public int? AccessObjectId
        {
            get
            {
                if (this._isAccessObjectIdNull)
                {
                    throw new InvalidUseOfNullPropertyException(
                        this.GetType().FullName, "AccessObjectId");
                }
            ...
            set
            {
                ...
                this._isAccessObjectIdNull = false;
            }
        }
        ...
        public int? ParentAccessId
        {
            get
            {
                if (this._isParentAccessIdNull)
                {
                    throw new InvalidUseOfNullPropertyException(
                        this.GetType().FullName, "ParentAccessId");
                }
            ...
            set
            {
                ...
                this._isParentAccessIdNull = false;
            }
        }

        /// <summary>
        /// Return or set if ParentAccessId property value is null.
        /// </summary>
        /// <value>true if ParentAccessId property value is null, false otherwise.</value>
        public bool IsParentAccessIdNull
        {
            get
            {
                return this._isParentAccessIdNull;
            }
            set
            {
                if (!value)
                {
                    throw new InvalidPropertyValueException(
                        this.GetType().FullName, "IsParentAccessIdNull", value);
                }
                this._isParentAccessIdNull = true;
            }
        }
        ...
        /// <summary>
        /// Return or set if AccessObjectId property value is null.
        /// </summary>
        /// <value>true if AccessObjectId property value is null, false otherwise.</value>
        public bool IsAccessObjectIdNull
        {
            get
            {
                return this._isAccessObjectIdNull;
            }
            set
            {
                if (!value)
                {
                    throw new InvalidPropertyValueException(
                        this.GetType().FullName, "IsAccessObjectIdNull", value);
                }
                this._isAccessObjectIdNull = true;
            }
        }
