 ...
 * Template: Sistran.Core.Application.UniqueUser.Submodules.dict v1.0
 * FileSize=8534 Header=251 CRC=1799794050
 ******************************************/
...
namespace Sistran.Core.Application.UniqueUser.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniqueUser.Submodules.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        public Submodules() :
            this(Submodules.CreatePrimaryKey(), null)
        {
        }
        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<Submodules>();
        }
        protected static PrimaryKey InternalCreatePrimaryKey<T>()
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.ModuleCode, null);
            keys.Add(Properties.SubmoduleCode, null);
