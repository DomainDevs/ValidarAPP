 ...
 * Template: Sistran.Core.Application.UniqueUser.Modules.dict v1.0
 * FileSize=5895 Header=248 CRC=4092532082
 ******************************************/
...
namespace Sistran.Core.Application.UniqueUser.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniqueUser.Modules.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        public Modules() :
            this(Modules.CreatePrimaryKey(), null)
        {
        }

        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<Modules>();
        }
