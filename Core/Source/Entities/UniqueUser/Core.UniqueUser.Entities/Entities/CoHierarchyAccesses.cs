 ...
 * Template: Sistran.Core.Application.UniqueUser.CoHierarchyAccesses.dict v1.0
 * FileSize=5945 Header=260 CRC=2401531618
 ******************************************/
...
namespace Sistran.Core.Application.UniqueUser.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniqueUser.CoHierarchyAccesses.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        public CoHierarchyAccesses() :
            this(CoHierarchyAccesses.CreatePrimaryKey(), null)
        {
        }
        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<CoHierarchyAccesses>();
        }
