 ...
 * Template: Sistran.Core.Application.UniqueUser.Entities.AccessPermissions.dict v1.0
 * FileSize=4493 Header=267 CRC=2251278750
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AccessPermissions.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniqueUser.Entities.AccessPermissions.dict"),
    Serializable(),
    DescriptionKey("ACCESS_PERMISSIONS_ENTITY"),
    TableMap(TableName="ACCESS_PERMISSIONS", Schema="UU"),
    ]
...
#region static
	    ...
	    {
			return InternalCreatePrimaryKey<AccessPermissions>(id);
		}
#endregion
	    ...
	    public AccessPermissions(int id):
			this(AccessPermissions.CreatePrimaryKey(id), null)
	    {
	    }
		...
		/// </param>
	    public AccessPermissions(PrimaryKey key, IDictionary initialValues):
