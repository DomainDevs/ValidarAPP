...
namespace Sistran.Core.Application.Script.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Script.RuleSet.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.RuleSetId, null);
        ...
        {
            return InternalCreatePrimaryKey<RuleSet>();
        }
        ...
        /// </summary>
        public RuleSet() :
            this(RuleSet.CreatePrimaryKey(), null)
        {
        }
