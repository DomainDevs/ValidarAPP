 ...
 * Template: Sistran.Core.Application.Script.RangeConcept.dict v1.0
 * FileSize=4636 Header=247 CRC=99856374
 ******************************************/
...
namespace Sistran.Core.Application.Script.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Script.RangeConcept.dict"),
    Serializable(),
    DescriptionKey("RANGE_CONCEPT_ENTITY"),
    TableMap(TableName = "RANGE_CONCEPT", Schema = "SCR"),
    ]
    public partial class RangeConcept :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<RangeConcept>(conceptId, entityId);
        }
        #endregion
        ...
        public RangeConcept(int conceptId, int entityId) :
            this(RangeConcept.CreatePrimaryKey(conceptId, entityId), null)
        {
        }
