...
namespace Sistran.Core.Application.Script.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Script.Concept.dict"),
    Serializable(),
    ...
    public partial class Concept : BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<Concept>(entityId);
        }
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<Concept>();
        }
        ...
        public Concept() :
            this(Concept.CreatePrimaryKey(), null)
        {
        }
        public Concept(int entityId) :
            this(Concept.CreatePrimaryKey(entityId), null)
        {
        }
        /// <summary>
