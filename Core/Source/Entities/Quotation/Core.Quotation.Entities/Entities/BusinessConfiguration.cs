 ...
 * Template: namespace.BusinessConfiguration.dict v1.0
 * FileSize=7532 Header=236 CRC=2965607404
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Quotation.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.BusinessConfiguration.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<BusinessConfiguration>();
        }
