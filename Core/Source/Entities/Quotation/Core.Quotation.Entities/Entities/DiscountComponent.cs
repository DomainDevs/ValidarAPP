 ...
 * Template: Sistran.Core.Application.Quotation.DiscountComponent.dict v1.0
 * FileSize=5161 Header=257 CRC=3938685236
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad DiscountComponent.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.DiscountComponent.dict"),
    Serializable(),
    DescriptionKey("DISCOUNT_COMPONENT_ENTITY"),
    TableMap(TableName = "DISCOUNT_COMPONENT", Schema = "QUO"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<DiscountComponent>(componentCode);
        }
        #endregion
        ...
        public DiscountComponent(int componentCode) :
            this(DiscountComponent.CreatePrimaryKey(componentCode), null)
        {
        }
        ...
        /// </param>
        public DiscountComponent(PrimaryKey key, IDictionary initialValues) :
