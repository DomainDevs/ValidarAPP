 ...
 * Template: Sistran.Core.Application.Quotation.RiskDetailAccessory.dict v1.0
 * FileSize=5334 Header=258 CRC=280577144
 ******************************************/
...
namespace Sistran.Core.Application.Quotation.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskDetailAccessory.dict"),
    Serializable(),
    DescriptionKey("RISK_DETAIL_ACCESSORY_ENTITY"),
    TableMap(TableName = "RISK_DETAIL_ACCESSORY", Schema = "QUO"),
    ]
