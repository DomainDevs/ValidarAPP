 ...
 * Template: Sistran.Core.Application.Quotation.CommissAgent.dict v1.0
 * FileSize=14464 Header=252 CRC=584645960
 ******************************************/
...
namespace Sistran.Core.Application.Quotation.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.CommissAgent.dict"),
    Serializable(),
    DescriptionKey("COMMISS_AGENT_ENTITY"),
    TableMap(TableName = "COMMISS_AGENT", Schema = "QUO"),
    ]
