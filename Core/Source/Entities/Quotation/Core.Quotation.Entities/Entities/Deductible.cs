 ...
 * Template: Sistran.Core.Application.Quotation.Deductible.dict v1.0
 * FileSize=12337 Header=251 CRC=3108404179
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad Deductible.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.Deductible.dict"),
    Serializable(),
    DescriptionKey("DEDUCTIBLE_ENTITY"),
    TableMap(TableName = "DEDUCTIBLE", Schema = "QUO"),
    ]
        ...
        BusinessObject2
    {
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int deductId)
        {
        ...
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.DeductId, null);
        ...
        {
            return InternalCreatePrimaryKey<Deductible>();
        }
        ...
        /// </summary>
        /// <param name="deductId">Propiedad clave DeductId.</param>
        public static PrimaryKey CreatePrimaryKey(int deductId)
        {
            return InternalCreatePrimaryKey<Deductible>(deductId);
        }
        ...
        public Deductible() :
            this(Deductible.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </summary>
        /// <param name="deductId">DeductId key property.</param>
        public Deductible(int deductId) :
            this(Deductible.CreatePrimaryKey(deductId), null)
        {
        }
        ...
        /// </param>
        public Deductible(PrimaryKey key, IDictionary initialValues) :
