 ...
 * Template: Sistran.Core.Application.Quotation.RiskVehicleAgency.dict v1.0
 * FileSize=14806 Header=258 CRC=1819711737
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad RiskVehicleAgency.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskVehicleAgency.dict"),
    Serializable(),
    DescriptionKey("RISK_VEHICLE_AGENCY_ENTITY"),
    TableMap(TableName = "RISK_VEHICLE_AGENCY", Schema = "QUO"),
    ]
    public partial class RiskVehicleAgency :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<RiskVehicleAgency>(quotationId, riskId);
        }
        #endregion
        ...
        public RiskVehicleAgency(int quotationId, int riskId) :
            this(RiskVehicleAgency.CreatePrimaryKey(quotationId, riskId), null)
        {
        }
        ...
        /// </param>
        public RiskVehicleAgency(PrimaryKey key, IDictionary initialValues) :
