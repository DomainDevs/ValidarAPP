 ...
 * Template: Sistran.Core.Application.Quotation.RiskDriverLicense.dict v1.0
 * FileSize=4689 Header=256 CRC=488804215
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad RiskDriverLicense.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskDriverLicense.dict"),
    Serializable(),
    DescriptionKey("RISK_DRIVER_LICENSE_ENTITY"),
    TableMap(TableName = "RISK_DRIVER_LICENSE", Schema = "QUO"),
    ]
    public partial class RiskDriverLicense :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<RiskDriverLicense>(quotationId, riskId);
        }
        #endregion
        ...
        public RiskDriverLicense(int quotationId, int riskId) :
            this(RiskDriverLicense.CreatePrimaryKey(quotationId, riskId), null)
        {
        }
        ...
        /// </param>
        public RiskDriverLicense(PrimaryKey key, IDictionary initialValues) :
