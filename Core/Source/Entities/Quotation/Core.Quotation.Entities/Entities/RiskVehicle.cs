 ...
 * Template: Sistran.Core.Application.Quotation.RiskVehicle.dict v1.0
 * FileSize=17333 Header=252 CRC=1263799441
 ******************************************/
...
namespace Sistran.Core.Application.Quotation.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskVehicle.dict"),
    Serializable(),
    DescriptionKey("RISK_VEHICLE_ENTITY"),
    TableMap(TableName = "RISK_VEHICLE", Schema = "QUO"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<RiskVehicle>(quotationId, riskId);
        }
        #endregion
        ...
        public RiskVehicle(int quotationId, int riskId) :
            this(RiskVehicle.CreatePrimaryKey(quotationId, riskId), null)
        {
        }
