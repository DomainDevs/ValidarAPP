 ...
 * Template: test.ExpenseComponent.dict v1.0
 * FileSize=7079 Header=226 CRC=1911333952
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad ExpenseComponent.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.ExpenseComponent.dict"),
    Serializable(),
    DescriptionKey("EXPENSE_COMPONENT_ENTITY"),
    TableMap(TableName = "EXPENSE_COMPONENT", Schema = "QUO"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<ExpenseComponent>(componentCode);
        }
        #endregion
        ...
        public ExpenseComponent(int componentCode) :
            this(ExpenseComponent.CreatePrimaryKey(componentCode), null)
        {
        }
        ...
        /// </param>
        public ExpenseComponent(PrimaryKey key, IDictionary initialValues) :
