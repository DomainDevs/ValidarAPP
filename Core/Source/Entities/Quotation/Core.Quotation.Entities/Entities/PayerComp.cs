 ...
 * Template: Sistran.Core.Application.Quotation.PayerComp.dict v1.0
 * FileSize=19001 Header=250 CRC=2740404413
 ******************************************/
...
namespace Sistran.Core.Application.Quotation.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.PayerComp.dict"),
    Serializable(),
    DescriptionKey("PAYER_COMP_ENTITY"),
    TableMap(TableName = "PAYER_COMP", Schema = "QUO"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<PayerComp>(quotationId, customerTypeCode, payerId, componentCode, payerCompId);
        }
        #endregion
        ...
        public PayerComp(int quotationId, int customerTypeCode, int payerId, int componentCode, int payerCompId) :
            this(PayerComp.CreatePrimaryKey(quotationId, customerTypeCode, payerId, componentCode, payerCompId), null)
        {
        }
