 ...
 * Template: Sistran.Core.Application.Quotation.RiskVehicleDriver.dict v1.0
 * FileSize=10952 Header=258 CRC=1987613857
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad RiskVehicleDriver.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskVehicleDriver.dict"),
    Serializable(),
    DescriptionKey("RISK_VEHICLE_DRIVER_ENTITY"),
    TableMap(TableName = "RISK_VEHICLE_DRIVER", Schema = "QUO"),
    ]
    public partial class RiskVehicleDriver :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int quotationId, int riskId, int customerTypeCode, int driverId)
        {
        ...
        /// <param name="customerTypeCode">Propiedad clave CustomerTypeCode.</param>
        /// <param name="driverId">Propiedad clave DriverId.</param>
        public static PrimaryKey CreatePrimaryKey(int quotationId, int riskId, int customerTypeCode, int driverId)
        {
            return InternalCreatePrimaryKey<RiskVehicleDriver>(quotationId, riskId, customerTypeCode, driverId);
        }
        #endregion
        ...
        public RiskVehicleDriver(int quotationId, int riskId, int customerTypeCode, int driverId) :
            this(RiskVehicleDriver.CreatePrimaryKey(quotationId, riskId, customerTypeCode, driverId), null)
        {
        }
        ...
        /// </param>
        public RiskVehicleDriver(PrimaryKey key, IDictionary initialValues) :
