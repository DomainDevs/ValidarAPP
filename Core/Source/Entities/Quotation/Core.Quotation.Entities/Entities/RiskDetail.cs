 ...
 * Template: Sistran.Core.Application.Quotation.RiskDetail.dict v1.0
 * FileSize=4510 Header=249 CRC=601324480
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad RiskDetail.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskDetail.dict"),
    Serializable(),
    DescriptionKey("RISK_DETAIL_ENTITY"),
    TableMap(TableName = "RISK_DETAIL", Schema = "QUO"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<RiskDetail>(riskDetailId);
        }
        #endregion
        ...
        public RiskDetail(int riskDetailId) :
            this(RiskDetail.CreatePrimaryKey(riskDetailId), null)
        {
        }
        ...
        /// </param>
        public RiskDetail(PrimaryKey key, IDictionary initialValues) :
