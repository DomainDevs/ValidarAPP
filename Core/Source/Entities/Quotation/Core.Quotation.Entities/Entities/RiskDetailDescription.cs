 ...
 * Template: Sistran.Core.Application.Quotation.RiskDetailDescription.dict v1.0
 * FileSize=4018 Header=260 CRC=965355066
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad RiskDetailDescription.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskDetailDescription.dict"),
    Serializable(),
    DescriptionKey("RISK_DETAIL_DESCRIPTION_ENTITY"),
    TableMap(TableName = "RISK_DETAIL_DESCRIPTION", Schema = "QUO"),
    ]
    public partial class RiskDetailDescription :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<RiskDetailDescription>(riskDetailId);
        }
        #endregion
        ...
        public RiskDetailDescription(int riskDetailId) :
            this(RiskDetailDescription.CreatePrimaryKey(riskDetailId), null)
        {
        }
        ...
        /// </param>
        public RiskDetailDescription(PrimaryKey key, IDictionary initialValues) :
