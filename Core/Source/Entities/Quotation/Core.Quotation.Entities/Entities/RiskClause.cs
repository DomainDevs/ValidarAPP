 ...
 * Template: Sistran.Core.Application.Quotation.RiskClause.dict v1.0
 * FileSize=4795 Header=250 CRC=1228403888
 ******************************************/
...
namespace Sistran.Core.Application.Quotation.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskClause.dict"),
    Serializable(),
    DescriptionKey("RISK_CLAUSE_ENTITY"),
    TableMap(TableName = "RISK_CLAUSE", Schema = "QUO"),
    ]
        ...
        BusinessObject2
    {
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int quotationId, int riskId, int clauseId)
        {
        ...
        /// <param name="riskId">Propiedad clave RiskId.</param>
        /// <param name="clauseId">Propiedad clave ClauseId.</param>
        public static PrimaryKey CreatePrimaryKey(int quotationId, int riskId, int clauseId)
        {
            return InternalCreatePrimaryKey<RiskClause>(quotationId, riskId, clauseId);
        }
        #endregion
        ...
        public RiskClause(int quotationId, int riskId, int clauseId) :
            this(RiskClause.CreatePrimaryKey(quotationId, riskId, clauseId), null)
        {
        }
