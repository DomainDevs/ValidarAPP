 ...
 * Template: Sistran.Core.Application.Quotation.RiskPayerTaxCond.dict v1.0
 * FileSize=7445 Header=256 CRC=1943951063
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad RiskPayerTaxCond.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.RiskPayerTaxCond.dict"),
    Serializable(),
    DescriptionKey("RISK_PAYER_TAX_COND_ENTITY"),
    TableMap(TableName = "RISK_PAYER_TAX_COND", Schema = "QUO"),
    ]
    public partial class RiskPayerTaxCond :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int quotationId, int riskId, int payerId, int customerTypeCode, int taxCode)
        {
        ...
        /// <param name="customerTypeCode">Propiedad clave CustomerTypeCode.</param>
        /// <param name="taxCode">Propiedad clave TaxCode.</param>
        public static PrimaryKey CreatePrimaryKey(int quotationId, int riskId, int payerId, int customerTypeCode, int taxCode)
        {
            return InternalCreatePrimaryKey<RiskPayerTaxCond>(quotationId, riskId, payerId, customerTypeCode, taxCode);
        }
        #endregion
        ...
        public RiskPayerTaxCond(int quotationId, int riskId, int payerId, int customerTypeCode, int taxCode) :
            this(RiskPayerTaxCond.CreatePrimaryKey(quotationId, riskId, payerId, customerTypeCode, taxCode), null)
        {
        }
        ...
        /// </param>
        public RiskPayerTaxCond(PrimaryKey key, IDictionary initialValues) :
