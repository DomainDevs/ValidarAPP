 ...
 * Template: Sistran.Core.Application.Quotation.PayerCompPrueba.dict v1.0
 * FileSize=19057 Header=256 CRC=4156760609
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad PayerCompPrueba.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.PayerCompPrueba.dict"),
    Serializable(),
    DescriptionKey("PAYER_COMP_PRUEBA_ENTITY"),
    TableMap(TableName = "PAYER_COMP_PRUEBA", Schema = "QUO"),
    ]
    public partial class PayerCompPrueba :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int quotationId, int customerTypeCode, int payerId, int componentCode, int payerCompId)
        {
        ...
        /// <param name="componentCode">Propiedad clave ComponentCode.</param>
        /// <param name="payerCompId">Propiedad clave PayerCompId.</param>
        public static PrimaryKey CreatePrimaryKey(int quotationId, int customerTypeCode, int payerId, int componentCode, int payerCompId)
        {
            return InternalCreatePrimaryKey<PayerCompPrueba>(quotationId, customerTypeCode, payerId, componentCode, payerCompId);
        }
        #endregion
        ...
        public PayerCompPrueba(int quotationId, int customerTypeCode, int payerId, int componentCode, int payerCompId) :
            this(PayerCompPrueba.CreatePrimaryKey(quotationId, customerTypeCode, payerId, componentCode, payerCompId), null)
        {
        }
        ...
        /// </param>
        public PayerCompPrueba(PrimaryKey key, IDictionary initialValues) :
