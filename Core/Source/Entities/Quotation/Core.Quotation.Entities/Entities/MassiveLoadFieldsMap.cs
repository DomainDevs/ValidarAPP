 ...
 * Template: Sistran.Core.Application.Quotation.MassiveLoadFieldsMap.dict v1.0
 * FileSize=5567 Header=259 CRC=271378060
 ******************************************/
...
namespace Sistran.Core.Application.Quotation.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Quotation.MassiveLoadFieldsMap.dict"),
    Serializable(),
    DescriptionKey("MASSIVE_LOAD_FIELDS_MAP_ENTITY"),
    TableMap(TableName = "MASSIVE_LOAD_FIELDS_MAP", Schema = "QUO"),
    ]
    public partial class MassiveLoadFieldsMap :
        BusinessObject2
    {
        #region static
        /// <summary>
