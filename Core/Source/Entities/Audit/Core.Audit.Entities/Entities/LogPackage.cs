 ...
 * Template: Sistran.Core.Application.Audit.LogPackage.dict v1.0
 * FileSize=4489 Header=246 CRC=3018904965
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad LogPackage.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Audit.LogPackage.dict"),
    Serializable(),
    DescriptionKey("LOG_PACKAGE_ENTITY"),
    TableMap(TableName="LOG_PACKAGE", Schema="AUD"),
    ]
...
#region static
	    ...
	    {
			return InternalCreatePrimaryKey<LogPackage>(id);
		}
#endregion
		...
		/// <summary>
		/// Atributo para la propiedad PackageName.
		/// </summary>
	    ...
	    public LogPackage(int id):
			this(LogPackage.CreatePrimaryKey(id), null)
	    {
	    }
		...
		/// </param>
	    public LogPackage(PrimaryKey key, IDictionary initialValues):
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad PackageName.
		/// </summary>
		/// <value>Propiedad PackageName.</value>
	    [
		DescriptionKey("PACKAGE_NAME_PROPERTY"),
		PersistentProperty(),
        ColumnMap(ColumnName="PACKAGE_NAME", DbType=System.Data.DbType.String),
	    ]
        public string PackageName
	    {
		    ...
		    set
		    {
				if(value == null)
				{
					throw new PropertyNotNullableException(this.GetType().FullName, Properties.PackageName);
				}
