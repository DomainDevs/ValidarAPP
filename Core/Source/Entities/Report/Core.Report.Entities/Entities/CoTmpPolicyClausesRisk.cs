 ...
 * Template: Sistran.Core.Application.Report.CoTmpPolicyClausesRisk.dict v1.0
 * FileSize=6197 Header=258 CRC=868169974
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad CoTmpPolicyClausesRisk.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Report.CoTmpPolicyClausesRisk.dict"),
    Serializable(),
    DescriptionKey("CO_TMP_POLICY_CLAUSES_RISK_ENTITY"),
    TableMap(TableName = "CO_TMP_POLICY_CLAUSES_RISK", Schema = "REPORT"),
    ]
    public partial class CoTmpPolicyClausesRisk :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<CoTmpPolicyClausesRisk>();
        }
        #endregion
        ...
        /// </summary>
        public CoTmpPolicyClausesRisk() :
            this(CoTmpPolicyClausesRisk.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public CoTmpPolicyClausesRisk(PrimaryKey key, IDictionary initialValues) :
