 ...
 * Template: Sistran.Core.Application.Events.CoEventAuthorizationUsers.dict v1.0
...
namespace Sistran.Core.Application.Events.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Events.CoEventAuthorizationUsers.dict"),
    Serializable(),
