 ...
 * Template: Core.Events.Entities.CoEventGroup.dict v1.0
 * FileSize=8171 Header=237 CRC=590102407
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Events.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Events.CoEventGroup.dict"),
    Serializable(),
