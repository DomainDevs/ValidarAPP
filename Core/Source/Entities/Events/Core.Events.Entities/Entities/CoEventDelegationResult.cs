 ...
 * Template: Sistran.Core.Application.Events.CoEventDelegationResult.dict v1.0
...
namespace Sistran.Core.Application.Events.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Events.CoEventDelegationResult.dict"),
    Serializable(),
