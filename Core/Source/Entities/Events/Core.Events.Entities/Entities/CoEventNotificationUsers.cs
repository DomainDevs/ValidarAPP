 ...
 * Template: Sistran.Core.Application.Events.CoEventNotificationUsers.dict v1.0
...
namespace Sistran.Core.Application.Events.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Events.CoEventNotificationUsers.dict"),
    Serializable(),
