 ...
 * Template: Sistran.Core.Application.AuthorizationPolicies.UserNotification.dict v1.0
 * FileSize=5534 Header=268 CRC=2636506079
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad UserNotification.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AuthorizationPolicies.UserNotification.dict"),
    Serializable(),
    DescriptionKey("USER_NOTIFICATION_ENTITY"),
    TableMap(TableName = "USER_NOTIFICATION", Schema = "AUTHO"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<UserNotification>(policiesId, userId, hierarchyId);
        }
        #endregion
        ...
        public UserNotification(int policiesId, int userId, int hierarchyId) :
            this(UserNotification.CreatePrimaryKey(policiesId, userId, hierarchyId), null)
        {
        }
        ...
        /// </param>
        public UserNotification(PrimaryKey key, IDictionary initialValues) :
