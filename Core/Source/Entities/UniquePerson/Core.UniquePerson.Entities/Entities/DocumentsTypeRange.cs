 ...
 * Template: Sistran.Core.Application.UniquePerson.DocumentsTypeRange.dict v1.0
...
namespace Sistran.Core.Application.UniquePerson.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePerson.DocumentsTypeRange.dict"),
    Serializable(),
