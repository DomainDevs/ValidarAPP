 ...
 * Template: Sistran.Core.Application.UniquePerson.InsuredGuaranteeLog.dict v1.0
...
namespace Sistran.Core.Application.UniquePerson.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePerson.InsuredGuaranteeLog.dict"),
    Serializable(),
