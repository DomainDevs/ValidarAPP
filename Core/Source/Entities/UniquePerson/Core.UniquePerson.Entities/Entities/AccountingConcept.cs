 ...
 * Template: Sistran.Core.Application.UniquePerson.AccountingConcept.dict v1.0
...
namespace Sistran.Core.Application.UniquePerson.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePerson.AccountingConcept.dict"),
    Serializable(),
