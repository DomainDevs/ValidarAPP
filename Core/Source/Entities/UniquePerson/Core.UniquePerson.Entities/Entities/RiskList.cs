 ...
 * Template: Sistran.Core.Application.UniquePerson.RiskList.dict v1.0
...
namespace Sistran.Core.Application.UniquePerson.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePerson.RiskList.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        /// <value>Propiedad UserId.</value>
        [
        DescriptionKey("RISK_LIST_TYPE"),
        PersistentProperty(),
        ColumnMap(ColumnName = "RISK_LIST_TYPE", DbType = System.Data.DbType.Int16),
        ]
        public int RiskListType
        {
            get
            {
