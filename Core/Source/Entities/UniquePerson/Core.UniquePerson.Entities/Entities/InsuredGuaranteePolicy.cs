 ...
 * Template: Sistran.Core.Application.UniquePerson.InsuredGuaranteePolicy.dict v1.0
...
namespace Sistran.Core.Application.UniquePerson.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePerson.InsuredGuaranteePolicy.dict"),
    Serializable(),
