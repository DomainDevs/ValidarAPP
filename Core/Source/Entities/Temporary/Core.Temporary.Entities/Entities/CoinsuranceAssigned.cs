 ...
 * Template: Sistran.Core.Application.Temporary.CoinsuranceAssigned.dict v1.0
 * FileSize=6294 Header=259 CRC=1241205451
 ******************************************/
...
namespace Sistran.Core.Application.Temporary.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Temporary.CoinsuranceAssigned.dict"),
    Serializable(),
    DescriptionKey("COINSURANCE_ASSIGNED_ENTITY"),
    TableMap(TableName = "COINSURANCE_ASSIGNED", Schema = "TMP"),
    ]
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<CoinsuranceAssigned>(tempId, insuranceCompanyId);
        }
        #endregion
        ...
        public CoinsuranceAssigned(int tempId, decimal insuranceCompanyId) :
            this(CoinsuranceAssigned.CreatePrimaryKey(tempId, insuranceCompanyId), null)
        {
        }
