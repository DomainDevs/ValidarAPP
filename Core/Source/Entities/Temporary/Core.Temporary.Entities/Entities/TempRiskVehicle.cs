 ...
 * Template: Sistran.Core.Application.Temporary.TempRiskVehicle.dict v1.0
 * FileSize=17313 Header=256 CRC=2977296716
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad TempRiskVehicle.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Temporary.TempRiskVehicle.dict"),
    Serializable(),
    DescriptionKey("TEMP_RISK_VEHICLE_ENTITY"),
    TableMap(TableName = "TEMP_RISK_VEHICLE", Schema = "TMP"),
    ]
    public partial class TempRiskVehicle :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<TempRiskVehicle>(tempId, riskId);
        }
        #endregion
        ...
        public TempRiskVehicle(int tempId, int riskId) :
            this(TempRiskVehicle.CreatePrimaryKey(tempId, riskId), null)
        {
        }
        ...
        /// </param>
        public TempRiskVehicle(PrimaryKey key, IDictionary initialValues) :
