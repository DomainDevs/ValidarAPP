 ...
 * Template: Sistran.Core.Application.Temporary.TempCoinsuranceAccepted.dict v1.0
 * FileSize=8072 Header=262 CRC=324022030
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad TempCoinsuranceAccepted.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Temporary.TempCoinsuranceAccepted.dict"),
    Serializable(),
    DescriptionKey("TEMP_COINSURANCE_ACCEPTED_ENTITY"),
    TableMap(TableName = "TEMP_COINSURANCE_ACCEPTED", Schema = "TMP"),
    ]
    public partial class TempCoinsuranceAccepted :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<TempCoinsuranceAccepted>(tempId, insuranceCompanyId);
        }
        #endregion
        ...
        public TempCoinsuranceAccepted(int tempId, decimal insuranceCompanyId) :
            this(TempCoinsuranceAccepted.CreatePrimaryKey(tempId, insuranceCompanyId), null)
        {
        }
        ...
        /// </param>
        public TempCoinsuranceAccepted(PrimaryKey key, IDictionary initialValues) :
