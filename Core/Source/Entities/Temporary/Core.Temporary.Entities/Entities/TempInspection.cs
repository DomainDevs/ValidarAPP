 ...
 * Template: Sistran.Core.Application.Temporary.TempInspection.dict v1.0
 * FileSize=16884 Header=255 CRC=3427530655
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad TempInspection.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Temporary.TempInspection.dict"),
    Serializable(),
    DescriptionKey("TEMP_INSPECTION_ENTITY"),
    TableMap(TableName = "TEMP_INSPECTION", Schema = "TMP"),
    ]
    public partial class TempInspection :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<TempInspection>(tempId, riskId);
        }
        #endregion
        ...
        public TempInspection(int tempId, int riskId) :
            this(TempInspection.CreatePrimaryKey(tempId, riskId), null)
        {
        }
        ...
        /// </param>
        public TempInspection(PrimaryKey key, IDictionary initialValues) :
