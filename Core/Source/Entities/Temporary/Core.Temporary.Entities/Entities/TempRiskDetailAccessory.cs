 ...
 * Template: Sistran.Core.Application.Temporary.TempRiskDetailAccessory.dict v1.0
 * FileSize=5372 Header=263 CRC=1618744482
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad TempRiskDetailAccessory.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Temporary.TempRiskDetailAccessory.dict"),
    Serializable(),
    DescriptionKey("TEMP_RISK_DETAIL_ACCESSORY_ENTITY"),
    TableMap(TableName = "TEMP_RISK_DETAIL_ACCESSORY", Schema = "TMP"),
    ]
    public partial class TempRiskDetailAccessory :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<TempRiskDetailAccessory>(riskDetailId);
        }
        #endregion
        ...
        public TempRiskDetailAccessory(int riskDetailId) :
            this(TempRiskDetailAccessory.CreatePrimaryKey(riskDetailId), null)
        {
        }
        ...
        /// </param>
        public TempRiskDetailAccessory(PrimaryKey key, IDictionary initialValues) :
