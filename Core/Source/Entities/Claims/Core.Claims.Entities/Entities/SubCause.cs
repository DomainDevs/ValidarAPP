 ...
 * Template: Sistran.Core.Application.Claims.SubCause.dict v1.0
 * FileSize=4393 Header=244 CRC=323578839
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.SubCause.dict"),
    Serializable(),
