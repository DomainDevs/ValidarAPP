 ...
 * Template: Sistran.Core.Application.Claims.PaymentRequestClaim.dict v1.0
 * FileSize=10039 Header=258 CRC=1764340903
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad PaymentRequestClaim.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.PaymentRequestClaim.dict"),
    Serializable(),
    DescriptionKey("PAYMENT_REQUEST_CLAIM_ENTITY"),
    TableMap(TableName="PAYMENT_REQUEST_CLAIM", Schema="PAYM"),
    ]
    public partial class PaymentRequestClaim :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int paymentRequestCode, int claimCode, int subClaim, int estimationTypeCode, int paymentVoucherConcept)
	    {
		    ...
		    keys.Add(Properties.PaymentVoucherConceptCode, paymentVoucherConcept);
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>()
        {
            ...
            keys.Add(Properties.SubClaim, null);
	    ...
	    {
			return InternalCreatePrimaryKey<PaymentRequestClaim>(paymentRequestCode, claimCode, subClaim, estimationTypeCode, voucherConceptCode);
		}
        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<PaymentRequestClaim>();
        }
        #endregion
	    ...
	    public PaymentRequestClaim(int paymentRequestCode, int claimCode, int subClaim, int estimationTypeCode, int paymentVoucherConcept) :
			this(PaymentRequestClaim.CreatePrimaryKey(paymentRequestCode, claimCode, subClaim, estimationTypeCode, paymentVoucherConcept), null)
	    {
	    }
        public PaymentRequestClaim() :
            this(PaymentRequestClaim.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public PaymentRequestClaim(PrimaryKey key, IDictionary initialValues):
