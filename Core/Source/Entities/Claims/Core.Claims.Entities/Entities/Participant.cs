 ...
 * Template: Sistran.Core.Application.Claims.Participant.dict v1.0
 * FileSize=5818 Header=248 CRC=4287206370
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.Participant.dict"),
    Serializable(),
