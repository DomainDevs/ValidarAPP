 ...
 * Template: Sistran.Core.Application.Claims.TextOperation.dict v1.0
 * FileSize=3764 Header=250 CRC=1636310500
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.TextOperation.dict"),
    Serializable(),
