 ...
 * Template: Sistran.Core.Application.Claims.PendingOperations.dict v1.0
 * FileSize=5012 Header=254 CRC=2852523347
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.PendingOperations.dict"),
    Serializable(),
