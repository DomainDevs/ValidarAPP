 ...
 * Template: Sistran.Core.Application.Claims.ClaimNumber.dict v1.0
 * FileSize=5014 Header=248 CRC=4223651345
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimNumber.dict"),
    Serializable(),
