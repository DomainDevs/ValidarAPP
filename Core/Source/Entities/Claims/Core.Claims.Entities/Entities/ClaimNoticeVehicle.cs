 ...
 * Template: Sistran.Core.Application.Claims.ClaimNoticeRiskVehicle.dict v1.0
 * FileSize=9933 Header=258 CRC=874954274
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimNoticeRiskVehicle.dict"),
    Serializable(),
    DescriptionKey("CLAIM_NOTICE_RISK_VEHICLE_ENTITY"),
    TableMap(TableName="CLAIM_NOTICE_RISK_VEHICLE", Schema="CLM"),
    ]
    public partial class ClaimNoticeVehicle :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<ClaimNoticeVehicle>(claimNoticeCode);
		}

        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<ClaimNoticeVehicle>();
        }
        #endregion
	    ...
	    public ClaimNoticeVehicle(int claimNoticeCode):
			this(ClaimNoticeVehicle.CreatePrimaryKey(claimNoticeCode), null)
	    {
	    }

        public ClaimNoticeVehicle() :
            this(ClaimNoticeVehicle.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public ClaimNoticeVehicle(PrimaryKey key, IDictionary initialValues):
