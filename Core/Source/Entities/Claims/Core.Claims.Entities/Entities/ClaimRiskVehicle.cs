 ...
 * Template: Sistran.Core.Application.Claims.ClaimRiskVehicle.dict v1.0
 * FileSize=9743 Header=253 CRC=3953200894
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad ClaimRiskVehicle.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimRiskVehicle.dict"),
    Serializable(),
    DescriptionKey("CLAIM_RISK_VEHICLE_ENTITY"),
    TableMap(TableName="CLAIM_RISK_VEHICLE", Schema="CLM"),
    ]
    public partial class ClaimRiskVehicle :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<ClaimRiskVehicle>(claimCode);
		}

        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<ClaimRiskVehicle>();
        }
        #endregion
	    ...
	    public ClaimRiskVehicle(int claimCode):
			this(ClaimRiskVehicle.CreatePrimaryKey(claimCode), null)
	    {
	    }

        public ClaimRiskVehicle() :
            this(ClaimRiskVehicle.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public ClaimRiskVehicle(PrimaryKey key, IDictionary initialValues):
