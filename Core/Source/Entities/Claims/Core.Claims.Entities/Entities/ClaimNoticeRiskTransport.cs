 ...
 * Template: Sistran.Core.Application.Claims.ClaimNoticeRiskTransport.dict v1.0
 * FileSize=6904 Header=261 CRC=3552010264
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimNoticeRiskTransport.dict"),
    Serializable(),
