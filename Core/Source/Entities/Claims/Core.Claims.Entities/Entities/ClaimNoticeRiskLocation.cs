 ...
 * Template: Sistran.Core.Application.Claims.ClaimNoticeRiskLocation.dict v1.0
 * FileSize=5931 Header=260 CRC=3459909065
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimNoticeRiskLocation.dict"),
    Serializable(),
