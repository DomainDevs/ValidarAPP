 ...
 * Template: Sistran.Core.Application.Claims.ClaimCoverageSupplier.dict v1.0
 * FileSize=7627 Header=258 CRC=1089695417
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimCoverageSupplier.dict"),
    Serializable(),
