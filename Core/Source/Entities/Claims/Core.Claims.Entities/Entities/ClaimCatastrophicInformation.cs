 ...
 * Template: Sistran.Core.Application.Claims.ClaimCatastrophicInformation.dict v1.0
 * FileSize=8640 Header=265 CRC=4116028632
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimCatastrophicInformation.dict"),
    Serializable(),
