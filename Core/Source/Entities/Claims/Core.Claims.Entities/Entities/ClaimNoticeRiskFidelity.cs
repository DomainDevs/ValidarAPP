 ...
 * Template: Sistran.Core.Application.Claims.ClaimNoticeRiskFidelity.dict v1.0
 * FileSize=6270 Header=260 CRC=2230727822
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimNoticeRiskFidelity.dict"),
    Serializable(),
