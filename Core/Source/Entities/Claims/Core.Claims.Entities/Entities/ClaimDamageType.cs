 ...
 * Template: Sistran.Core.Application.Claims.ClaimDamageType.dict v1.0
 * FileSize=4596 Header=251 CRC=549279910
 ******************************************/
using System;
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.ClaimDamageType.dict"),
    Serializable(),
