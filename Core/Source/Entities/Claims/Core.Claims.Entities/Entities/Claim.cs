 ...
 * Template: Sistran.Core.Application.Claims.Claim.dict v1.0
...
namespace Sistran.Core.Application.Claims.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Claims.Claim.dict"),
    Serializable(),
...
#region static
		...
		public static class Properties
		{
            ...
            public static readonly string JudicialDecisionDate = "JudicialDecisionDate";
        }
        ...
        /// <summary>
		/// Atributo para la propiedad AdministrativeFirmDate.
		/// </summary>
        private DateTime? _judicialDecisionDate;
        //*** Object Constructors ********************************
        ...
        /// <summary>
		/// Devuelve o setea el valor de la propiedad JudicialDecisionDate.
		/// </summary>
		/// <value>Propiedad JudicialDecisionDate.</value>
	    [
        DescriptionKey("JUDICIAL_DECISION_DATE_PROPERTY"),
        PersistentProperty(IsNullable = true),
        ColumnMap(ColumnName = "JUDICIAL_DECISION_DATE", DbType = System.Data.DbType.String),
        ]
        public DateTime? JudicialDecisionDate
        {
            get
            {
                return this._judicialDecisionDate;
            }
            set
            {
                this._judicialDecisionDate = value;
            }
        }
    }
}