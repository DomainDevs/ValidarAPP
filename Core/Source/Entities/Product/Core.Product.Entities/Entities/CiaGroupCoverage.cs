 ...
 * Template: Sistran.Core.Application.Product.CiaGroupCoverage.dict v1.0
 * FileSize=6313 Header=253 CRC=224596310
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad CiaGroupCoverage.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Product.CiaGroupCoverage.dict"),
    Serializable(),
    DescriptionKey("CIA_GROUP_COVERAGE_ENTITY"),
    TableMap(TableName = "CIA_GROUP_COVERAGE", Schema = "PROD"),
    ]
    public partial class CiaGroupCoverage :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<CiaGroupCoverage>(coverageId, productId, coverGroupId);
        }
        #endregion
        ...
        public CiaGroupCoverage(int coverageId, int productId, int coverGroupId) :
            this(CiaGroupCoverage.CreatePrimaryKey(coverageId, productId, coverGroupId), null)
        {
        }
        ...
        /// </param>
        public CiaGroupCoverage(PrimaryKey key, IDictionary initialValues) :
