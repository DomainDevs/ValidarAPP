 ...
 * Template: Sistran.Core.Application.Massive.ColletiveEmissionRow.dict v1.0
 * FileSize=9629 Header=258 CRC=1668582158
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad ColletiveEmissionRow.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Massive.CollectiveEmissionRow.dict"),
    Serializable(),
    DescriptionKey("COLLECTIVE_EMISSION_ROW_ENTITY"),
    TableMap(TableName = "COLLECTIVE_EMISSION_ROW", Schema = "MSV"),
    ]
    public partial class CollectiveEmissionRow :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<CollectiveEmissionRow>(id);
        }
        #endregion
        ...
        public CollectiveEmissionRow(int id) :
            this(CollectiveEmissionRow.CreatePrimaryKey(id), null)
        {
        }

        public CollectiveEmissionRow() :
           this(CollectiveEmissionRow.CreatePrimaryKey(), null)
        {
        }
        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<CollectiveEmissionRow>();
        }
        ...
        /// </param>
        public CollectiveEmissionRow(PrimaryKey key, IDictionary initialValues) :
