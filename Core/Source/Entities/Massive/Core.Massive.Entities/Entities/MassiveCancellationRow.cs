 ...
 * Template: asdasd.MassiveCancellationRow.dict v1.0
 * FileSize=13200 Header=235 CRC=2492360418
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad MassiveCancellationRow.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Massive.MassiveCancellationRow.dict"),
    Serializable(),
    DescriptionKey("MASSIVE_CANCELLATION_ROW_ENTITY"),
    TableMap(TableName = "MASSIVE_CANCELLATION_ROW", Schema = "MSV"),
    ]
    public partial class MassiveCancellationRow :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<MassiveCancellationRow>(id);
        }

        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<MassiveCancellationRow>();
        }
        ...
        /// <summary>
        /// Atributo para la propiedad SubCoveredRiskTypeCode.
        /// </summary>
        private int _subCoveredRiskTypeCode;
        //*** Object Constructors ********************************
        ...
        public MassiveCancellationRow(int id) :
            this(MassiveCancellationRow.CreatePrimaryKey(id), null)
        {
        }
        ...
        /// </param>
        public MassiveCancellationRow(PrimaryKey key, IDictionary initialValues) :
            base(key, initialValues)
        {
        }

        public MassiveCancellationRow() :
            this(MassiveCancellationRow.CreatePrimaryKey(), null)
        {
        }
        /*** Object Properties ********************************/
        /// <summary>
