 ...
 * Template: Sistran.Core.Application.Massive.MassiveRenewalRow.dict v1.0
 * FileSize=12994 Header=256 CRC=2176656541
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad MassiveRenewalRow.
    /// </summary>
    [
        PersistentClass("Sistran.Core.Application.Massive.MassiveRenewalRow.dict"),
        Serializable(),
        DescriptionKey("MASSIVE_RENEWAL_ROW_ENTITY"),
        TableMap(TableName = "MASSIVE_RENEWAL_ROW", Schema = "MSV"),
    ]
    public partial class MassiveRenewalRow :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<MassiveRenewalRow>(id);
        }
        ...
        {
            return InternalCreatePrimaryKey<MassiveRenewalRow>();
        }
        ...
        public MassiveRenewalRow(int id) :
            this(MassiveRenewalRow.CreatePrimaryKey(id), null)
        {
        }
        public MassiveRenewalRow() :
            this(MassiveRenewalRow.CreatePrimaryKey(), null)
        {
        }
        /// <summary>
        ...
        /// </param>
        public MassiveRenewalRow(PrimaryKey key, IDictionary initialValues) :
