 ...
 * Template: Sistran.Core.Application.UniquePersonV1.Employee.dict v1.0
 * FileSize=8052 Header=253 CRC=1469012463
 ******************************************/
using System;
...
namespace Sistran.Core.Application.UniquePersonV1.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePersonV1.Employee.dict"),
    Serializable(),
...
#region static
		...
		/// <summary>
		/// Atributo para la propiedad Annotation.
		/// </summary>
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad Annotation.
		/// </summary>
		/// <value>Propiedad Annotation.</value>
	    [
