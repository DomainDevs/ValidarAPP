 ...
 * Template: Sistran.Core.Application.UniquePersonV1.IndividualLegalRepresentLog.dict v1.0
...
namespace Sistran.Core.Application.UniquePersonV1.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePersonV1.IndividualLegalRepresentLog.dict"),
    Serializable(),
