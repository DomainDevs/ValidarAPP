 ...
 * Template: Sistran.Core.Application.UniquePersonV1.Entities.CompanyAddressType.dict v1.0
 * FileSize=5671 Header=263 CRC=1501374546
 ******************************************/
using System;
...
namespace Sistran.Core.Application.UniquePersonV1.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePersonV1.CompanyAddressType.dict"),
    Serializable(),
    DescriptionKey("COMPANY_ADDRESS_TYPE_ENTITY"),
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<CompanyAddressType>(addressTypeCode);
        }
        #endregion
        ...
        public CompanyAddressType(int addressTypeCode) :
            this(CompanyAddressType.CreatePrimaryKey(addressTypeCode), null)
        {
        }
        ...
        /// </param>
        public CompanyAddressType(PrimaryKey key, IDictionary initialValues) :
