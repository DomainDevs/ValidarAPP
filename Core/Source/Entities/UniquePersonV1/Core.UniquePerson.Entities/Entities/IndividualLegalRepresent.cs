 ...
 * Template: Sistran.Core.Application.UniquePersonV1.IndividualLegalRepresent.dict v1.0
 * FileSize=17673 Header=268 CRC=1166881533
 ******************************************/
...
namespace Sistran.Core.Application.UniquePersonV1.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePersonV1.IndividualLegalRepresent.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<IndividualLegalRepresent>(individualId);
        }
        #endregion
        ...
        public IndividualLegalRepresent(int individualId) :
            this(IndividualLegalRepresent.CreatePrimaryKey(individualId), null)
        {
        }
