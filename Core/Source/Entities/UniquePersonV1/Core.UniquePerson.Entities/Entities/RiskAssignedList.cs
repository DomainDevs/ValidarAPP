 ...
 * Template: Sistran.Core.Application.UniquePersonV1.RiskAssignedList.dict v1.0
...
namespace Sistran.Core.Application.UniquePersonV1.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.UniquePersonV1.RiskAssignedList.dict"),
    Serializable(),
