...
namespace Sistran.Core.Application.UniquePersonService.V1.DAOs
{
    ...
    /// Agente
    /// </summary>
    /// <seealso cref="Sistran.Core.Application.UniquePersonService.V1.Models.Agent" />
    public class AgentDAO : Models.Agent
    {
        ...
        public List<Models.Agent> GetAgentByQuery(string query)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentByQuery");
            return ModelAssembler.CreateAgents(businessCollection);
        }
        ...
        public List<Models.Agent> GetAgents()
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgents");
            return ModelAssembler.CreateAgents(businessCollection);
        }
        //
        ...
        public List<Models.Agent> GetAgentByName(string nameAgent)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentByName");
            return ModelAssembler.CreateAgents(businessCollection);
        }
        ...
        public Models.Agent CreateAgent(Models.Agent agent)
        {
            ...
            else
            {
                ...
                //    foreach (Models.CommissionAgency ca in agent.ComissionAgent)
                //    {
        ...
        public Models.Agent GetAgentByAgentId(int agentId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentByAgentId");
            return agentModel;
        }
        ...
        public Models.Agent GetAgentByIndividualId(int individualId)
        {
            ...
            if (agentEntity != null)
            {
                ...
                stopWatch.Stop();
                Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentByIndividualId");
                return agent;
            }
            else
            {
        ...
        public List<Models.Agent> GetAgentByAgentCodeFullName(int agentCode, string fullName)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentByAgentCodeFullName");
            return agents;
        }
        ...
        public List<Models.Agent> GetAgentByIndividualIdFullName(int IndividualId, string fullName)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentByIndividualIdFullName");
        ...
        public List<Models.Agent> GetAgentsByPrefix(int prefixId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentsByPrefix");
            return ListAgent;
        }
        ...
        public async Task<List<Models.Agent>> GetAgentsByIndividualIds(List<int> individualId)
        {
            ...
            var agentEntityResult = TP.Task.Run(() =>
              {
