...
namespace Sistran.Core.Application.UniquePersonService.V1.DAOs
{
    ...
    public class GuaranteeDAO
    {
        ...
        public List<Models.Guarantee> GetInsuredGuaranteesByIndividualId(int individualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetInsuredGuaranteesByIndividualId");
            return guarantee;
        }
        ...
        public Models.Guarantee GetInsuredGuaranteeByIdGuarantee(int guaranteeId)
        {
            ...
            {
                stopWatch.Stop();
                Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetInsuredGuaranteeByIdGuarantee");
        ...
        public List<Models.Guarantee> GetInsuredGuaranteeByIndividualId(int individualId)
        {
            Stopwatch stopWatch = new Stopwatch();
            stopWatch.Start();
            InsuredGuaranteeViewV1 view = new InsuredGuaranteeViewV1();
            ViewBuilder builder = new ViewBuilder("InsuredGuaranteeViewV1");
            ObjectCriteriaBuilder filter = new ObjectCriteriaBuilder();
            ...
            //////filter.Constant(1);
            //////filter.And();
            //////filter.Property(GuaranteeStatus.Properties.EnabledSubscription, typeof(GuaranteeStatus).Name);
            //////filter.Equal();
            //////filter.Constant(1);
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetInsuredGuaranteeByIndividualId");
            return guarantees;
        }
            ...
            using (Context.Current)
            {
                using (Transaction transaction = new Transaction())
                {
                    ...
                    try
                    {
                        ...
                        stopWatch.Stop();
                        Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.SaveInsuredGuarantees");
            ...
            using (Context.Current)
            {
                using (Transaction transaction = new Transaction())
                {
                    ...
                    try
                    {
                        ...
                        stopWatch.Stop();
                        Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.SaveInsuredGuarantee");
        ...
        public List<Models.Guarantee> GetInsuredGuarantees(ObjectCriteriaBuilder filter)
        {
            ...
            using (IDataReader reader = DataFacadeManager.Instance.GetDataFacade().Select(select))
            {
                ...
                while (reader.Read())
                {
                    ...
                    model.ClosedInd = (bool)reader["ClosedInd"];
                    ...
                    {
                        model.Status = new Models.GuaranteeStatus();
                        model.Status.Id = (int)reader["GuaranteeStatusCode"];
                        model.Status.Description = (string)reader["DescriptionGuaranteeStatus"];
                        model.Status.IsEnabledInd = (bool)reader["EnabledInd"];
                    }
                    ...
                    if (reader["MeasurementTypeCode"] != null)
                    {
                        ...
                        model.MeasurementType.Id = (int)reader["MeasurementTypeCode"];
                    ...
                    tmpGuarantee.HasApostille = (bool)reader["Apostille"];
                    tmpGuarantee.Code = (int)reader["GuaranteeCode"];
                    tmpGuarantee.Description = (string)reader["DescriptionGuarantee"];
                    tmpGuarantee.Type = new Models.GuaranteeType();
                    tmpGuarantee.Type.Id = (int)reader["GuaranteeTypeCodeGuaranteeType"];
                    tmpGuarantee.Type.Description = (string)reader["DescriptionGuaranteeType"];
            ...
            foreach (Models.Guarantee g in guarantee)
            {
                ...
                InsuredGuaranteeLogDAO insuredGuaranteeLogDAO = new InsuredGuaranteeLogDAO();
                g.InsuredGuarantee.InsuredGuaranteeLog = insuredGuaranteeLogDAO.GetInsuredGuaranteeLogs(g.InsuredGuarantee.IndividualId, g.InsuredGuarantee.Id).OrderByDescending(x => x.LogDate).ToList();
        ...
        public List<Models.GuaranteeType> GetGuaranteesTypes()
        {
            Stopwatch stopWatch = new Stopwatch();
            stopWatch.Start();
            BusinessCollection businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(GuaranteeType)));

            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetGuaranteesTypes");
        ...
        public List<Models.Guarantee> GetGuarantees()
        {
            Stopwatch stopWatch = new Stopwatch();
            stopWatch.Start();
            GuaranteeViewV1 view = new GuaranteeViewV1();
            ViewBuilder builder = new ViewBuilder("GuaranteeViewV1");
            DataFacadeManager.Instance.GetDataFacade().FillView(builder, view);
            List<Models.Guarantee> guarantees = ModelAssembler.CreateGuarantees(view);

            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetGuarantees");
            return guarantees;
        }
    }
}
