        ...
        public Models.InsuredGuarantee CreateNewGuarantee(Models.InsuredGuarantee insuredGuarantee)
        {
            ...
            try
            {
                ...
                if (paramGuarantee != null && paramGuarantee.NumberParameter.HasValue)
                {
                    ...
                    if (insuredGuarantee.Code == (int)UniquePersonService.V1.Enums.GuaranteesType.Pagare)
                    {
                        insuredGuarantee.DocumentNumber = insuredGuarantee.Id.ToString();
                    }
                }
                else
                {
                ...
                if (insuredGuarantee.Id == (int)Enums.GuaranteeType.Mortgage)
                {
        ...
        public Models.InsuredGuarantee UpdateGuarantee(Models.InsuredGuarantee insuredGuarantee)
        {
            try
            {
                ...
                if (updateInsuredGuarantee != null)
                {
                    ...
                    updateInsuredGuarantee.GuaranteeStatusCode = insuredGuarantee.Status != null ? (int?)insuredGuarantee.Status.Id : null;
                    ...
                    updateInsuredGuarantee.MeasurementTypeCode = insuredGuarantee.MeasurementType != null ? (int?)insuredGuarantee.MeasurementType.Id : null;
                    updateInsuredGuarantee.MeasureAreaQuantity = insuredGuarantee.MeasureArea;
                    if(insuredGuarantee.InsuranceCompany != null) { 
                    updateInsuredGuarantee.InsuranceCompanyId = (int)insuredGuarantee.InsuranceCompany.Id > 0 ? (int)insuredGuarantee.InsuranceCompany.Id : (int?)null;
                    updateInsuredGuarantee.InsuranceCompany = insuredGuarantee.InsuranceCompany.Description != null ? insuredGuarantee.InsuranceCompany.Description : null;
                    }
