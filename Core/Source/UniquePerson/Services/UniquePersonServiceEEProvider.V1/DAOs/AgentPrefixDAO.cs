...
namespace Sistran.Core.Application.UniquePersonService.V1.DAOs
{
    ...
    public class AgentPrefixDAO
    {
        ...
        public List<Models.AgentPrefix> GetAgentPrefixByIndividualId(int IndividualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgentPrefixByIndividualId");
        ...
        public async Task<List<Models.AgentPrefix>> GetAgentPrefixByIndividualId(List<int> IndividualIds)
        {
            ...
            var agentPrefixiesResult = TP.Task.Run(() =>
            {
            ...
            return await TP.Task.Run(() => ModelAssembler.CreateAgentsPrefixies(agentPrefixiesResult.Result));
        }
