...
namespace Sistran.Core.Application.UniquePersonService.V1.DAOs
{
    ...
    public class CompanyExtendedDAO
    {
        ...
        {
            BusinessCollection businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(AccountType)));
            return ModelAssembler.CreateAccountTypesV1(businessCollection);
        }
