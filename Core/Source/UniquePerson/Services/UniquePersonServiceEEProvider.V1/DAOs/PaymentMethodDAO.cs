...
//        /// <returns></returns>
//        public Models.IndividualPaymentMethod CreatePaymentMethod(Models.PaymentAccount paymentMethodAccount, int individualId)
//        {
...
//        /// <param name="individualId">individualId</param>
//        /// <returns></returns>
//        public Models.IndividualPaymentMethod UpdatePaymentMethod(Models.PaymentAccount paymentMethodAccount, int individualId)
//        {
//            ObjectCriteriaBuilder filter = new ObjectCriteriaBuilder();
//            filter.Property(IndividualPaymentMethod.Properties.IndividualId, typeof(IndividualPaymentMethod).Name);
//            filter.Equal();
