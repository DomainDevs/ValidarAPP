...
namespace Sistran.Core.Application.UniquePersonService.V1.DAOs
{
    ...
    public class AgencyDAO
    {
        ...
        public List<Models.Agency> GetAgenciesByAgentIdDescription(int agentId, string description)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgenciesByAgentIdDescription");
            return agencies;
        }
        ...
        public List<Models.Agency> GetAgenciesByAgentId(int agentId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgenciesByAgentId");
        ...
        public List<Models.Agency> GetAgencyByIndividualId(int individualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgencyByIndividualId");
            return ModelAssembler.CreateAgencies(businessCollection);
        }
        ...
        public async Task<List<Models.Agency>> GetAgenciesByIds(List<int> Id)
        {
            ...
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.V1.DAOs.GetAgenciesByAgentId");
            return await TP.Task.Run(() => ModelAssembler.CreateAgentcies(agentEntityResult.Result));
        }
        ...
        public List<Models.Agency> GetAgenciesByAgentIdDescriptionIdPrefix(int agentId, string description, int prefixId)
        {
            ...
            AgentPrefixAgentAgencyViewV1 view = new AgentPrefixAgentAgencyViewV1();
            ViewBuilder builder = new ViewBuilder("AgentPrefixAgentAgencyViewV1");
