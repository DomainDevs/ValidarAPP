...
namespace Sistran.Core.Application.UniquePersonService.Entities.views
{
    ...
    /// </summary>
    [Serializable()]
    public class IndividualDirectoryRelatedEntitiesView : BusinessView
    {

        private BusinessCollection _individualDirectory =
            new BusinessCollection();

        public IndividualDirectoryRelatedEntitiesView()
        { }

        /// <summary>
        /// Colección de elementos de la entidad <see 
        /// cref="Sistran.Core.Application.UniquePerson.Entities.IndividualDirectory">
