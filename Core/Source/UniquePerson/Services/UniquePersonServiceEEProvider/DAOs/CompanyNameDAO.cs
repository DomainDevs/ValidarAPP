...
namespace Sistran.Core.Application.UniquePersonService.DAOs
{
    ...
    public class CompanyNameDAO
    {
        ...
        {
            UniquePerson.Entities.CoCompanyName coCompanyNameEntity = EntityAssembler.CreateCoCompanyName(coCompanyName);
        ...
        public Models.CompanyName UpdateCompaniesName(Models.CompanyName coCompannyName, int individualId)
        {
            ...
            filter.Property(UniquePerson.Entities.CoCompanyName.Properties.IndividualId, typeof(UniquePerson.Entities.CoCompanyName).Name);
            filter.Equal();
            filter.Constant(individualId);
            filter.And();
            filter.Property(UniquePerson.Entities.CoCompanyName.Properties.NameNum, typeof(UniquePerson.Entities.CoCompanyName).Name);
            filter.Equal();
            ...
            {
                PrimaryKey key = UniquePerson.Entities.CoCompanyName.CreatePrimaryKey(individualId, coCompannyName.NameNum);
                UniquePerson.Entities.CoCompanyName coCompanyNameEntity = (UniquePerson.Entities.CoCompanyName)DataFacadeManager.Instance.GetDataFacade().GetObjectByPrimaryKey(key);
        ...
        {
            BusinessCollection businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(UniquePerson.Entities.CoCompanyName), filter.GetPredicate()));
        ...
        public List<Models.CompanyName> GetCompanyNamesByIndividualId(int individualId)
        {
            ...
            filterAddress.Property(UniquePerson.Entities.Address.Properties.IndividualId, typeof(UniquePerson.Entities.Address).Name);
            filterAddress.Equal();
            ...
            filterPhone.Property(UniquePerson.Entities.Phone.Properties.IndividualId, typeof(UniquePerson.Entities.Phone).Name);
            filterPhone.Equal();
            ...
            filterEmail.Property(UniquePerson.Entities.Email.Properties.IndividualId, typeof(UniquePerson.Entities.Email).Name);
            filterEmail.Equal();
            filterEmail.Constant(individualId);
            EmailDAO EmailDAO = new EmailDAO();
            List<Models.Email> email = EmailDAO.GetEmailsByFilter(filterEmail);

            businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(UniquePerson.Entities.EmailType)));
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetCompanyNamesByIndividualId");
            return businessName;
        }
        ...
        public List<Models.CompanyName> GetNotificationAddressesByIndividualId(int individualId, CustomerType customerType)
        {
            ...
            if (customerType == CustomerType.Individual)
            {
                ...
                addresses = addresses.OrderByDescending(x => x.IsMailAddress).ToList();
                ...
                emails = emails.OrderByDescending(x => x.IsMailingAddress).ToList();

                //if (businessCollection.Count > 0)
                //{
                //    companyNames = ModelAssembler.CreateCompaniesName(businessCollection);

                //    foreach (Models.CompanyName item in companyNames)
                //    {
            ...
            {
                PrimaryKey primaryKey = UniquePerson.Entities.Prospect.CreatePrimaryKey(individualId);
                UniquePerson.Entities.Prospect entityProspect = (UniquePerson.Entities.Prospect)DataFacadeManager.Instance.GetDataFacade().GetObjectByPrimaryKey(primaryKey);
        ...
        public List<Models.CompanyName> GetHolderNotificationAddressesByIndividualId(int individualId, CustomerType customerType)
        {
            ...
            {
                AddressDAO addressDAO = new AddressDAO();
                var addresses = Task.Run(() =>
                {
                    var result = addressDAO.GetAddresses(individualId)?.OrderByDescending(x => x.IsMailAddress).ToList();
                ...
                var emails = Task.Run(() =>
                {
                    var result = emailDAO.GetEmailsByIndividualId(individualId)?.OrderByDescending(x => x.IsMailingAddress).ToList();
                    DataFacadeManager.Dispose();
                    return result;
                }
                );
            ...
            {
                PrimaryKey primaryKey = UniquePerson.Entities.Prospect.CreatePrimaryKey(individualId);
                UniquePerson.Entities.Prospect entityProspect = null;
                using (var daf = DataFacadeManager.Instance.GetDataFacade())
                {
                    entityProspect = (UniquePerson.Entities.Prospect)daf.GetObjectByPrimaryKey(primaryKey);
                }
