...
namespace Sistran.Core.Application.UniquePersonService.DAOs
{
    ...
    public class InsuredGuaranteeDocumentationDAO
    {
        ...
        public List<Models.InsuredGuaranteeDocumentation> GetInsuredGuaranteeDocumentation(int individualId, int guaranteeId)
        {
            ...
            filter.Property(UniquePerson.Entities.InsuredGuaranteeDocumentation.Properties.IndividualId, typeof(UniquePerson.Entities.InsuredGuaranteeDocumentation).Name);
            filter.Equal();
            filter.Constant(individualId);
            filter.And();
            filter.Property(UniquePerson.Entities.InsuredGuaranteeDocumentation.Properties.GuaranteeId, typeof(UniquePerson.Entities.InsuredGuaranteeDocumentation).Name);
            filter.Equal();
            filter.Constant(guaranteeId);

            BusinessCollection businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(UniquePerson.Entities.InsuredGuaranteeDocumentation), filter.GetPredicate()));

            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetInsuredGuaranteeDocumentation");
        ...
        public void SaveGuaranteeDocumentation(List<Models.InsuredGuaranteeDocumentation> listDocumentation, int guaranteeId)
        {
            ...
            {
                ObjectCriteriaBuilder filter = new ObjectCriteriaBuilder();
                filter.Property(UniquePerson.Entities.InsuredGuaranteeDocumentation.Properties.IndividualId, typeof(UniquePerson.Entities.InsuredGuaranteeDocumentation.Properties).Name);
                filter.Equal();
                filter.Constant(listDocumentation.FirstOrDefault().IndividualId);
                filter.And();
                filter.Property(UniquePerson.Entities.InsuredGuaranteeDocumentation.Properties.GuaranteeId, typeof(UniquePerson.Entities.InsuredGuaranteeDocumentation.Properties).Name);
                filter.Equal();
                filter.Constant(guaranteeId);
                BusinessCollection businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(UniquePerson.Entities.InsuredGuaranteeDocumentation), filter.GetPredicate()));
                ...
                foreach (Models.InsuredGuaranteeDocumentation documentation in listDocumentation)
                {
                    ...
                    UniquePerson.Entities.InsuredGuaranteeDocumentation insuredGuaranteeDocumentationEntity = EntityAssembler.CreateInsuredGuaranteeDocumentation(documentation);
        ...
        public List<Models.GuaranteeRequiredDocument> GetDocumentationReceivedByGuaranteeId(int guaranteeId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetDocumentationReceivedByGuaranteeId");
