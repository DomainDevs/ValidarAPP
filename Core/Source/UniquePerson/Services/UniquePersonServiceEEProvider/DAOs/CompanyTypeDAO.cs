...
namespace Sistran.Core.Application.UniquePersonService.DAOs
{
    ...
    public class CompanyTypeDAO
    {
        ...
        public List<Models.CompanyType> GetCompanyTypes()
        {
            ...
            stopWatch.Start();
            BusinessCollection businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(UniquePerson.Entities.CompanyType)));

            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetCompanyTypes");
