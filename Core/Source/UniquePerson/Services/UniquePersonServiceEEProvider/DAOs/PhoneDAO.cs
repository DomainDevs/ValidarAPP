...
namespace Sistran.Core.Application.UniquePersonService.DAOs
{
    public class PhoneDAO
    {
        ...
        public List<models.PhoneType> GetPhoneTypes()
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetPhoneTypes");
        ...
        public List<models.Phone> GetPhonesByIndividualId(int individualId)
        {
            ...
            businessCollection = new BusinessCollection(DataFacadeManager.Instance.GetDataFacade().SelectObjects(typeof(PhoneType)));
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetPhonesByIndividualId");
            return phones;
        }
        ...
        public models.Phone CreatePhone(models.Phone phone, int individualId)
        {
            ...
            if (phones.Count == 0)
            {
                ...
                DataFacadeManager.Instance.GetDataFacade().InsertObject(phoneEntity);
        ...
        public models.Phone UpdatePhone(models.Phone phone, int individualId)
        {
            ...
            if (phones.Count == 0)
            {
                ...
                phoneEntity = (Phone)DataFacadeManager.Instance.GetDataFacade().GetObjectByPrimaryKey(key);
                ...
                phoneEntity.CountryCode = phone.CountryCode;
                phoneEntity.CityCode = phone.CityCode;
                phoneEntity.Extension = phone.Extension;
                phoneEntity.ScheduleAvailability = phone.ScheduleAvailability;
              
				DataFacadeManager.Instance.GetDataFacade().UpdateObject(phoneEntity);
                return ModelAssembler.CreatePhone(phoneEntity);
            }
            else
            {
