...
namespace Sistran.Core.Application.UniquePersonService.DAOs
{
    ...
    public class LegalRepresentativeDAO
    {
        ...
        public Models.LegalRepresentative CrateRepresentLegal(Models.LegalRepresentative legalRepresent, int individualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.CrateRepresentLegal");
        ...
        public Models.LegalRepresentative GetLegalRepresentByIndividualId(int individualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetLegalRepresentByIndividualId");
        ...
        public Models.LegalRepresentative UpdateLegalRepresent(Models.LegalRepresentative legalRepresent, int individualId)
        {
            ...
            {
                stopWatch.Stop();
                Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.UpdateLegalRepresent");
