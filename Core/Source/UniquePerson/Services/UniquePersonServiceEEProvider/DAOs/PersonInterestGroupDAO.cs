...
{
    public class PersonInterestGroupDAO
    {
        public List<Models.InterestGroupsType> GetInterestGroupTypes()
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetInterestGroupTypes");
        ...
        public List<Models.PersonInterestGroup> GetPersonInterestGroups(int individualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetPersonInterestGroups");
        ...
        public Models.PersonInterestGroup CreatePersonInterestGroup(Models.PersonInterestGroup personInterestGroup)
        {
            ...
            DataFacadeManager.Instance.GetDataFacade().InsertObject(EntityAssembler.CreatePersonInterestGroup(personInterestGroup));

            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.CreatePersonInterestGroups");
        ...
        public Models.PersonInterestGroup DeletePersonInterestGroup(Models.PersonInterestGroup personInterestGroup)
        {
            ...
            PersonInterestGroup personInterestGroupEntity = (PersonInterestGroup)DataFacadeManager.Instance.GetDataFacade().GetObjectByPrimaryKey(key);
            DataFacadeManager.Instance.GetDataFacade().DeleteObject(personInterestGroupEntity);

            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.DeletePersonInterestGroup");
