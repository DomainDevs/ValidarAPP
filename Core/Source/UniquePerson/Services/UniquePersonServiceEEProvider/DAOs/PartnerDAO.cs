...
namespace Sistran.Core.Application.UniquePersonService.DAOs
{
    ...
    public class PartnerDAO
    {
        ...
        public Models.Partner GetPartnerByDocumentIdDocumentTypeIndividualId(string documentId, int documentType, int IndividualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetPartnerByDocumentIdDocumentTypeIndividualId");
        ...
        public List<Models.Partner> GetPartnerByIndividualId(int individualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.GetPartnerByIndividualId");
            return partners;
        }
        ...
        public Models.Partner CreatePartner(Partner partNer, int individualId)
        {
            ...
            stopWatch.Stop();
            Debug.WriteLine(stopWatch.Elapsed.ToString(), "Sistran.Core.Application.UniquePersonService.DAOs.CreatePartner");
            return ModelAssembler.CreateParNer(individualPartnerEntity);
        }
        ...
        public Models.Partner UpdatePartner(Partner partner, int individualId)
        {
            ...
            try
            {
                ...
                if (individualPartnerEntityUpdate != null)
                {
                    ...
                    return ModelAssembler.CreateParNer(individualPartnerEntityUpdate);
                }
