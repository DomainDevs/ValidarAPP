 ...
 * Template: Sistran.Core.Application.Payment.PaymentRequestClaim.dict v1.0
...
namespace Sistran.Core.Application.ClaimServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ClaimServices.EEProvider.PaymentRequestClaim.dict"),
    Serializable(),
...
#region static
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>()
        {
            ...
            keys.Add(Properties.VoucherConceptCode, null);
	    ...
	    public PaymentRequestClaim(int paymentRequestCode, int claimCode, int subClaim, int estimationTypeCode, int voucherConceptCode):
			this(PaymentRequestClaim.CreatePrimaryKey(paymentRequestCode, claimCode, subClaim, estimationTypeCode, voucherConceptCode), null)
	    {
	    }
