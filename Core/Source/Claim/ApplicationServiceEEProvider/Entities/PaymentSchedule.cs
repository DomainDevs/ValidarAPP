 ...
 * Template: Sistran.Core.Application.Payment.PaymentSchedule.dict v1.0
...
namespace Sistran.Core.Application.ClaimServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ClaimServices.EEProvider.PaymentSchedule.dict"),
    Serializable(),
