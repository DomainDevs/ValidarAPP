...
namespace Sistran.Core.Application.ReinsuranceOperatingQuotaServices.EEProvider
{
    public static class DelegateService
    {
        ...
        public static readonly IEconomicGroupIntegrationService economicGroupIntegrationService = ServiceProvider.Instance.getServiceManager().GetService<IEconomicGroupIntegrationService>();
    }
}