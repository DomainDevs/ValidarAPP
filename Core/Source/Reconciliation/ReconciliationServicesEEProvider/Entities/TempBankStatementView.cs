 ...
 * Template: Sistran.Core.Application.ReconciliationServices.EEProvider.TempBankStatementView.dict v1.0
 * FileSize=17641 Header=283 CRC=3423977055
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad TempBankStatementView.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ReconciliationServices.EEProvider.TempBankStatementView.dict"),
    Serializable(),
    DescriptionKey("TEMP_BANK_STATEMENT_V_ENTITY"),
    TableMap(TableName="TEMP_BANK_STATEMENT_V", Schema="GL"),
    ]
    public partial class TempBankStatementView :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<TempBankStatementView>(bankStatementId);
		}
#endregion
	    ...
	    public TempBankStatementView(int bankStatementId):
			this(TempBankStatementView.CreatePrimaryKey(bankStatementId), null)
	    {
	    }
		...
		/// </param>
	    public TempBankStatementView(PrimaryKey key, IDictionary initialValues):
