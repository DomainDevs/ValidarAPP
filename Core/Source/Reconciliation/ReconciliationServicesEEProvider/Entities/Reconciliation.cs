 ...
 * Template: Sistran.Core.Application.ReconciliationServices.EEProvider.Reconciliation.dict v1.0
 * FileSize=14102 Header=279 CRC=3281355684
 ******************************************/
using System;
...
namespace Sistran.Core.Application.ReconciliationServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ReconciliationServices.EEProvider.Reconciliation.dict"),
    Serializable(),
    DescriptionKey("RECONCILIATION_ENTITY"),
    TableMap(TableName="RECONCILIATION", Schema="GL"),
    ]
...
#region static
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int reconciliationCode, int journalEntryCode, int ledgerEntryCode, string accountingNature, int bankStatementCode)
	    {
		...
		/// <param name="accountingNature">Propiedad clave AccountingNature.</param>
		/// <param name="bankStatementCode">Propiedad clave BankStatementCode.</param>
		public static PrimaryKey CreatePrimaryKey(int reconciliationCode, int journalEntryCode, int ledgerEntryCode, string accountingNature, int bankStatementCode)
	    {
			return InternalCreatePrimaryKey<Reconciliation>(reconciliationCode, journalEntryCode, ledgerEntryCode, accountingNature, bankStatementCode);
		}
#endregion
		...
		/// <summary>
		/// Atributo para la propiedad JournalEntryCdInt.
		/// </summary>
        private int _journalEntryCdInt;
		/// <summary>
		/// Atributo para la propiedad LedgerEntryCdInt.
		/// </summary>
        private int _ledgerEntryCdInt;
		/// <summary>
	    ...
	    public Reconciliation(int reconciliationCode, int journalEntryCode, int ledgerEntryCode, string accountingNature, int bankStatementCode):
			this(Reconciliation.CreatePrimaryKey(reconciliationCode, journalEntryCode, ledgerEntryCode, accountingNature, bankStatementCode), null)
	    {
	    }
        ...
        public int JournalEntryCdInt
	    {
		    get
		    {
			    return this._journalEntryCdInt;
		    }
		    set
		    {
				this._journalEntryCdInt = value;
			}
	    }
        ...
        public int LedgerEntryCdInt
	    {
		    get
		    {
			    return this._ledgerEntryCdInt;
		    }
		    set
		    {
				this._ledgerEntryCdInt = value;
			}
	    }
