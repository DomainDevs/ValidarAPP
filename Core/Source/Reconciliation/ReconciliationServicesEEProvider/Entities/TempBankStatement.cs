 ...
 * Template: Sistran.Core.Application.ReconciliationServices.EEProvider.TempBankStatement.dict v1.0
 * FileSize=14735 Header=282 CRC=2270714963
 ******************************************/
using System;
...
namespace Sistran.Core.Application.ReconciliationServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ReconciliationServices.EEProvider.TempBankStatement.dict"),
    Serializable(),
    DescriptionKey("TEMP_BANK_STATEMENT_ENTITY"),
    TableMap(TableName="TEMP_BANK_STATEMENT", Schema="GL"),
    ]
