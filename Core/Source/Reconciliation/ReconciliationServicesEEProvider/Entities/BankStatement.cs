 ...
 * Template: Sistran.Core.Application.ReconciliationServices.EEProvider.BankStatement.dict v1.0
 * FileSize=13979 Header=278 CRC=2534806137
 ******************************************/
using System;
...
namespace Sistran.Core.Application.ReconciliationServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ReconciliationServices.EEProvider.BankStatement.dict"),
    Serializable(),
    DescriptionKey("BANK_STATEMENT_ENTITY"),
    TableMap(TableName="BANK_STATEMENT", Schema="GL"),
    ]
