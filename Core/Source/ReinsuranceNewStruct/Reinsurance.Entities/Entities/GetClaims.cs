 ...
 * Template: Sistran.Core.Application.Reinsurance.GetClaims.dict v1.0
...
namespace Sistran.Core.Application.Reinsurance.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Reinsurance.GetClaims.dict"),
    Serializable(),
...
#region static
		...
		public static class Properties
		{
            ...
            public static readonly string VersionCd = "VersionCd";
        ...
        /// <summary>
        /// Atributo para la propiedad VersionCd.
        /// </summary>
        private int _versionCd;
        //*** Object Constructors ********************************
		...
		/// <value>Propiedad ClaimCoverageCd.</value>
	    [
        DescriptionKey("VERSION_CD_PROPERTY"),
        PersistentProperty(),
        ColumnMap(ColumnName = "VERSION_CD", DbType = System.Data.DbType.String),
        ]
        public int VersionCd
        {
            get
            {
                return this._versionCd;
            }
            set
            {
                this._versionCd = value;
            }
        }
