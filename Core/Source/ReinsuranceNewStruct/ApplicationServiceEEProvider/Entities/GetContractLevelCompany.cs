 ...
 * Template: Sistran.Core.Application.ReinsuranceServices.EEProvider.GetContractLevelCompany.dict v1.0
 * FileSize=15273 Header=285 CRC=1521792607
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad GetContractLevelCompany.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ReinsuranceServices.EEProvider.GetContractLevelCompany.dict"),
    Serializable(),
    DescriptionKey("GET_CONTRACT_LEVEL_COMPANY_ENTITY"),
    TableMap(TableName="GET_CONTRACT_LEVEL_COMPANY", Schema="REINS"),
    ]
    public partial class GetContractLevelCompany :
        BusinessObject2
    {
#region static
		/// <summary>
		...
		public static class Properties
		{
			...
			public static readonly string BrokerReinsuranceCompanyName = "BrokerReinsuranceCompanyName";
			public static readonly string ReinsuranceCompanyId = "ReinsuranceCompanyId";
			public static readonly string ReinsuranceCompanyName = "ReinsuranceCompanyName";
			...
			public static readonly string DifferentialCommissionPercentage = "DifferentialCommissionPerc_773";
		}
	    ...
	    {
			return InternalCreatePrimaryKey<GetContractLevelCompany>(levelCompanyId);
		}
#endregion
		...
		/// <summary>
		/// Atributo para la propiedad BrokerReinsuranceCompanyName.
		/// </summary>
        private string _brokerReinsuranceCompanyName = null;
		/// <summary>
		/// Atributo para la propiedad ReinsuranceCompanyId.
		/// </summary>
        private int _reinsuranceCompanyId;
		/// <summary>
		/// Atributo para la propiedad ReinsuranceCompanyName.
		/// </summary>
        private string _reinsuranceCompanyName = null;
		/// <summary>
	    ...
	    public GetContractLevelCompany(int levelCompanyId):
			this(GetContractLevelCompany.CreatePrimaryKey(levelCompanyId), null)
	    {
	    }
		...
		/// </param>
	    public GetContractLevelCompany(PrimaryKey key, IDictionary initialValues):
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad BrokerReinsuranceCompanyName.
		/// </summary>
		/// <value>Propiedad BrokerReinsuranceCompanyName.</value>
	    [
		DescriptionKey("BROKER_REINSURANCE_COMPANY_NAME_PROPERTY"),
		PersistentProperty(IsNullable = true),
        ColumnMap(ColumnName="BROKER_REINSURANCE_COMPANY_NAME", DbType=System.Data.DbType.String),
	    ]
        public string BrokerReinsuranceCompanyName
	    {
		    get
		    {
			    return this._brokerReinsuranceCompanyName;
		    }
		    set
		    {
				this._brokerReinsuranceCompanyName = value;
			}
	    }
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad ReinsuranceCompanyName.
		/// </summary>
		/// <value>Propiedad ReinsuranceCompanyName.</value>
	    [
		DescriptionKey("REINSURANCE_COMPANY_NAME_PROPERTY"),
		PersistentProperty(IsNullable = true),
        ColumnMap(ColumnName="REINSURANCE_COMPANY_NAME", DbType=System.Data.DbType.String),
	    ]
        public string ReinsuranceCompanyName
	    {
		    get
		    {
			    return this._reinsuranceCompanyName;
		    }
		    set
		    {
				this._reinsuranceCompanyName = value;
			}
	    }
		...
		PersistentProperty(IsNullable = true, DataName = "DifferentialCommissionPerc_773"),
