 ...
 * Template: Sistran.Core.Application.ReinsuranceServices.EEProvider.DistributionClaimLayerView.dict v1.0
 * FileSize=10241 Header=285 CRC=3160595589
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad DistributionClaimLayerView.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.ReinsuranceServices.EEProvider.DistributionClaimLayerView.dict"),
    Serializable(),
    DescriptionKey("DISTRIBUTION_CLAIM_LAYER_V_ENTITY"),
    TableMap(TableName="DISTRIBUTION_CLAIM_LAYER_V", Schema="REINS"),
    ]
    public partial class DistributionClaimLayerView :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<DistributionClaimLayerView>();
		}
#endregion
		...
		/// </summary>
	    public DistributionClaimLayerView():
			this(DistributionClaimLayerView.CreatePrimaryKey(), null)
	    {
	    }
		...
		/// </param>
	    public DistributionClaimLayerView(PrimaryKey key, IDictionary initialValues):
        ...
        public string Broker
	    {
		    ...
		    set
		    {
				if(value == null)
				{
					throw new PropertyNotNullableException(this.GetType().FullName, Properties.Broker);
				}
				this._broker = value;
			}
	    }
        ...
        public string Reinsurer
	    {
		    ...
		    set
		    {
				if(value == null)
				{
					throw new PropertyNotNullableException(this.GetType().FullName, Properties.Reinsurer);
				}
