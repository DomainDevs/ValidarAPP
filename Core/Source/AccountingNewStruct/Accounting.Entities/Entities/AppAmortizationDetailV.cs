 ...
 * Template: Sistran.Core.Application.Accounting.AppAmortizationDetailV.dict v1.0
 * FileSize=22945 Header=264 CRC=2036052428
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AppAmortizationDetailV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.AppAmortizationDetailV.dict"),
    Serializable(),
    DescriptionKey("APP_AMORTIZATION_DETAIL_V_ENTITY"),
    TableMap(TableName="APP_AMORTIZATION_DETAIL_V", Schema="ACC"),
    ]
    public partial class AppAmortizationDetailV :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int logSpecialProcessId, int policyId, int endorsementId, int correlativeNumber)
	    {
		...
		/// <param name="endorsementId">Propiedad clave EndorsementId.</param>
		/// <param name="correlativeNumber">Propiedad clave CorrelativeNumber.</param>
		public static PrimaryKey CreatePrimaryKey(int logSpecialProcessId, int policyId, int endorsementId, int correlativeNumber)
	    {
			return InternalCreatePrimaryKey<AppAmortizationDetailV>(logSpecialProcessId, policyId, endorsementId, correlativeNumber);
		}
#endregion
	    ...
	    public AppAmortizationDetailV(int logSpecialProcessId, int policyId, int endorsementId, int correlativeNumber):
			this(AppAmortizationDetailV.CreatePrimaryKey(logSpecialProcessId, policyId, endorsementId, correlativeNumber), null)
	    {
	    }
		...
		/// </param>
	    public AppAmortizationDetailV(PrimaryKey key, IDictionary initialValues):
