 ...
 * Template: Sistran.Core.Application.Accounting.GetBrokerCheckingAccountNotPaid.dict v1.0
...
namespace Sistran.Core.Application.Accounting.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.GetBrokerCheckingAccountNotPaid.dict"),
    Serializable(),
