 ...
 * Template: Sistran.Core.Application.Accounting.PolicyAmortizationV.dict v1.0
 * FileSize=11261 Header=261 CRC=2475855528
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad PolicyAmortizationV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.PolicyAmortizationV.dict"),
    Serializable(),
    DescriptionKey("POLICY_AMORTIZATION_V_ENTITY"),
    TableMap(TableName="POLICY_AMORTIZATION_V", Schema="ACC"),
    ]
    public partial class PolicyAmortizationV :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<PolicyAmortizationV>(policyId);
		}
#endregion
	    ...
	    public PolicyAmortizationV(int policyId):
			this(PolicyAmortizationV.CreatePrimaryKey(policyId), null)
	    {
	    }
		...
		/// </param>
	    public PolicyAmortizationV(PrimaryKey key, IDictionary initialValues):
