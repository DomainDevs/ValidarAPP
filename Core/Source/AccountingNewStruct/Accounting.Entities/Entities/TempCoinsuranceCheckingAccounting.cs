 ...
 * Template: Sistran.Core.Application.Accounting.GetTempCoinsuranceCheckingAccount.dict v1.0
...
namespace Sistran.Core.Application.Accounting.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.TempCoinsuranceCheckingAccounting.dict"),
    Serializable(),
