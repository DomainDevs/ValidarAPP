 ...
 * FileSize=20044 Header=265 CRC=2567603646
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad GetLogProcessCreditNote.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.GetLogProcessCreditNote.dict"),
    Serializable(),
    DescriptionKey("GET_LOG_PROCESS_CREDIT_NOTE_ENTITY"),
    TableMap(TableName="GET_LOG_PROCESS_CREDIT_NOTE", Schema="ACC"),
    ]
    public partial class GetLogProcessCreditNote :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<GetLogProcessCreditNote>();
		}
#endregion
		...
		/// </summary>
	    public GetLogProcessCreditNote():
			this(GetLogProcessCreditNote.CreatePrimaryKey(), null)
	    {
	    }
		...
		/// </param>
	    public GetLogProcessCreditNote(PrimaryKey key, IDictionary initialValues):
