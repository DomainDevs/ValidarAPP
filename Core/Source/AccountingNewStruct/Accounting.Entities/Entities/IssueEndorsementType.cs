 ...
 * Template: Sistran.Core.Application.Accounting.IssueEndorsementTypeV.dict v1.0
...
namespace Sistran.Core.Application.Accounting.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.IssueEndorsementType.dict"),
    Serializable(),
