 ...
 * Template: Sistran.Core.Application.Accounting.AppPayerOrderUnauthorizedV.dict v1.0
 * FileSize=12311 Header=268 CRC=1766722302
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AppPayerOrderUnauthorizedV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.AppPayerOrderUnauthorizedV.dict"),
    Serializable(),
    DescriptionKey("APP_PAYER_ORDER_UNAUTHORIZED_V_ENTITY"),
    TableMap(TableName="APP_PAYER_ORDER_UNAUTHORIZED_V", Schema="ACC"),
    ]
    public partial class AppPayerOrderUnauthorizedV :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<AppPayerOrderUnauthorizedV>(paymentOrderCode);
		}
#endregion
	    ...
	    public AppPayerOrderUnauthorizedV(int paymentOrderCode):
			this(AppPayerOrderUnauthorizedV.CreatePrimaryKey(paymentOrderCode), null)
	    {
	    }
		...
		/// </param>
	    public AppPayerOrderUnauthorizedV(PrimaryKey key, IDictionary initialValues):
