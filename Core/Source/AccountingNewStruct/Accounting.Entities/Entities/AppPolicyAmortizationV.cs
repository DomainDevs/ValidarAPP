 ...
 * Template: Sistran.Core.Application.Accounting.AppPolicyAmortizationV.dict v1.0
 * FileSize=11264 Header=264 CRC=2934753396
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AppPolicyAmortizationV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.AppPolicyAmortizationV.dict"),
    Serializable(),
    DescriptionKey("APP_POLICY_AMORTIZATION_V_ENTITY"),
    TableMap(TableName="APP_POLICY_AMORTIZATION_V", Schema="ACC"),
    ]
    public partial class AppPolicyAmortizationV :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<AppPolicyAmortizationV>(policyId);
		}
#endregion
	    ...
	    public AppPolicyAmortizationV(int policyId):
			this(AppPolicyAmortizationV.CreatePrimaryKey(policyId), null)
	    {
	    }
		...
		/// </param>
	    public AppPolicyAmortizationV(PrimaryKey key, IDictionary initialValues):
