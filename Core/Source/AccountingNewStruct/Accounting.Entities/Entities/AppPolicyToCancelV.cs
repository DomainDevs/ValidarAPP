 ...
 * Template: Sistran.Core.Application.Accounting.AppPolicyToCancelV.dict v1.0
 * FileSize=26979 Header=260 CRC=1172812289
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AppPolicyToCancelV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.AppPolicyToCancelV.dict"),
    Serializable(),
    DescriptionKey("APP_POLICY_TO_CANCEL_V_ENTITY"),
    TableMap(TableName="APP_POLICY_TO_CANCEL_V", Schema="ACC"),
    ]
    public partial class AppPolicyToCancelV :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<AppPolicyToCancelV>();
		}
#endregion
		...
		/// </summary>
	    public AppPolicyToCancelV():
			this(AppPolicyToCancelV.CreatePrimaryKey(), null)
	    {
	    }
		...
		/// </param>
	    public AppPolicyToCancelV(PrimaryKey key, IDictionary initialValues):
