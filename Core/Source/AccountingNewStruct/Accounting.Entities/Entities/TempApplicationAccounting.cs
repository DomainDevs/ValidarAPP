 ...
 * Template: Sistran.Core.Application.Accounting.TempApplicationAccounting.dict v1.0
 * FileSize=15719 Header=266 CRC=459290227
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad TempApplicationAccounting.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.TempApplicationAccounting.dict"),
    Serializable(),
    DescriptionKey("TEMP_APPLICATION_ACCOUNTING_ENTITY"),
    TableMap(TableName="TEMP_APPLICATION_ACCOUNTING", Schema="ACC"),
    ]
    public partial class TempApplicationAccounting :
        BusinessObject2
    {
#region static
		/// <summary>
		...
		/// <param name="tempAppAccountingCode">Propiedad clave TempAppAccountingCode.</param>
		/// <returns>Clave primaria.</returns>
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int tempAppAccountingCode)
	    {
		    Dictionary<string, object> keys = new Dictionary<string, object>();
		    keys.Add(Properties.TempAppAccountingCode, tempAppAccountingCode);
		...
		/// </summary>
		/// <param name="tempAppAccountingCode">Propiedad clave TempAppAccountingCode.</param>
		public static PrimaryKey CreatePrimaryKey(int tempAppAccountingCode)
	    {
			return InternalCreatePrimaryKey<TempApplicationAccounting>(tempAppAccountingCode);
		}
#endregion
		...
		/// </summary>
		/// <param name="tempAppAccountingCode">TempAppAccountingCode key property.</param>
	    public TempApplicationAccounting(int tempAppAccountingCode):
			this(TempApplicationAccounting.CreatePrimaryKey(tempAppAccountingCode), null)
	    {
	    }
		...
		/// </param>
	    public TempApplicationAccounting(PrimaryKey key, IDictionary initialValues):
        ...
        public int TempAppAccountingCode
	    {
		    get
		    {
				return (int)this._primaryKey[Properties.TempAppAccountingCode];
		    }
		    set
		    {
				this._primaryKey[Properties.TempAppAccountingCode] = value;
			}
	    }
