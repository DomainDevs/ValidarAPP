 ...
 * Template: Sistran.Core.Application.Accounting.BranchPreliquidationV.dict v1.0
...
namespace Sistran.Core.Application.Accounting.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.BranchPreliquidationV.dict"),
    Serializable(),
