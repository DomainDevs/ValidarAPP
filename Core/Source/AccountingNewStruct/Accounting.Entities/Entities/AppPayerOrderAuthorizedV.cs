 ...
 * Template: Sistran.Core.Application.Accounting.AppPayerOrderAuthorizedV.dict v1.0
 * FileSize=14144 Header=266 CRC=3485291052
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad AppPayerOrderAuthorizedV.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.AppPayerOrderAuthorizedV.dict"),
    Serializable(),
    DescriptionKey("APP_PAYER_ORDER_AUTHORIZED_V_ENTITY"),
    TableMap(TableName="APP_PAYER_ORDER_AUTHORIZED_V", Schema="ACC"),
    ]
    public partial class AppPayerOrderAuthorizedV :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<AppPayerOrderAuthorizedV>();
		}
#endregion
		...
		/// <summary>
		/// Atributo para la propiedad AuthorizationLevel.
		/// </summary>
		...
		/// </summary>
	    public AppPayerOrderAuthorizedV():
			this(AppPayerOrderAuthorizedV.CreatePrimaryKey(), null)
	    {
	    }
		...
		/// </param>
	    public AppPayerOrderAuthorizedV(PrimaryKey key, IDictionary initialValues):
