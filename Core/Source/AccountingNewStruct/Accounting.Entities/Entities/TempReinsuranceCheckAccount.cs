 ...
 * Template: Sistran.Core.Application.Accounting.GetTempReinsuranceCheckingAccount.dict v1.0
 * FileSize=33020 Header=294 CRC=2165174909
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad TempReinsuranceCheckAccount View.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.TempReinsuranceCheckAccount.dict"),
    Serializable(),
    DescriptionKey("GET_TEMP_REINSURANCE_CHECKING_ACCOUNT_ENTITY"),
    TableMap(TableName="GET_TEMP_REINSURANCE_CHECKING_ACCOUNT", Schema="ACC"),
    ]
    public partial class TempReinsuranceCheckAccount :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<TempReinsuranceCheckAccount>(tempReinsCheckingAccTransCode);
		}
#endregion
	    ...
	    public TempReinsuranceCheckAccount(int tempReinsCheckingAccTransCode):
			this(TempReinsuranceCheckAccount.CreatePrimaryKey(tempReinsCheckingAccTransCode), null)
	    {
	    }
		...
		/// </param>
	    public TempReinsuranceCheckAccount(PrimaryKey key, IDictionary initialValues):
