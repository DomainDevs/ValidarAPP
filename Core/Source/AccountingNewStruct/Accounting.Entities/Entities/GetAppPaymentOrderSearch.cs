 ...
 * Template: Sistran.Core.Application.Accounting.GetAppPaymentOrderSearch.dict v1.0
 * FileSize=32563 Header=266 CRC=1932663067
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad GetAppPaymentOrderSearch.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.GetAppPaymentOrderSearch.dict"),
    Serializable(),
    DescriptionKey("GET_APP_PAYMENT_ORDER_SEARCH_ENTITY"),
    TableMap(TableName="GET_APP_PAYMENT_ORDER_SEARCH", Schema="ACC"),
    ]
    public partial class GetAppPaymentOrderSearch :
        BusinessObject2
    {
#region static
		/// <summary>
		...
		public static class Properties
		{
			...
			public static readonly string BankAccountNamePerson = "BankAccountNamePerson";
	    ...
	    {
			return InternalCreatePrimaryKey<GetAppPaymentOrderSearch>(paymentOrderCode);
		}
#endregion
		...
		/// <summary>
		/// Atributo para la propiedad BankAccountNumberPerson.
		/// </summary>
        private string _bankAccountNumberPerson = null;
		/// <summary>
		/// Atributo para la propiedad BankAccountNamePerson.
		/// </summary>
	    ...
	    public GetAppPaymentOrderSearch(int paymentOrderCode):
			this(GetAppPaymentOrderSearch.CreatePrimaryKey(paymentOrderCode), null)
	    {
	    }
		...
		/// </param>
	    public GetAppPaymentOrderSearch(PrimaryKey key, IDictionary initialValues):
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad BankAccountNumberPerson.
		/// </summary>
		/// <value>Propiedad BankAccountNumberPerson.</value>
	    [
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad BankAccountNamePerson.
		/// </summary>
		/// <value>Propiedad BankAccountNamePerson.</value>
	    [
