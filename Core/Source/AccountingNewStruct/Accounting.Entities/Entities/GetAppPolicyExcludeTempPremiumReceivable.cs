 ...
 * Template: Sistran.Core.Application.Accounting.GetAppPolicyExcludeTempPremiumReceivable.dict v1.0
 * FileSize=28962 Header=282 CRC=2107418894
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad GetAppPolicyExcludeTempPremiumReceivable.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.Accounting.GetAppPolicyExcludeTempPremiumReceivable.dict"),
    Serializable(),
    DescriptionKey("GET_APP_POLICY_EXCLUDE_TEMP_PREMIUM_RECEIVABLE_ENTITY"),
    TableMap(TableName="GET_APP_POLICY_EXCLUDE_TEMP_PREMIUM_RECEIVABLE", Schema="ACC"),
    ]
    public partial class GetAppPolicyExcludeTempPremiumReceivable :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<GetAppPolicyExcludeTempPremiumReceivable>();
		}
#endregion
		...
		/// </summary>
	    public GetAppPolicyExcludeTempPremiumReceivable():
			this(GetAppPolicyExcludeTempPremiumReceivable.CreatePrimaryKey(), null)
	    {
	    }
		...
		/// </param>
	    public GetAppPolicyExcludeTempPremiumReceivable(PrimaryKey key, IDictionary initialValues):
