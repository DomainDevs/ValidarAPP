 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.TempBankStatement.dict v1.0
 * FileSize=14625 Header=278 CRC=2477919229
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad TempBankStatement.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.TempBankStatement.dict"),
    Serializable(),
    DescriptionKey("TEMP_BANK_STATEMENT_ENTITY"),
    TableMap(TableName="TEMP_BANK_STATEMENT", Schema="ACC"),
    ]
    public partial class TempBankStatement :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<TempBankStatement>(bankStatementId);
		}
#endregion
	    ...
	    public TempBankStatement(int bankStatementId):
			this(TempBankStatement.CreatePrimaryKey(bankStatementId), null)
	    {
	    }
		...
		/// </param>
	    public TempBankStatement(PrimaryKey key, IDictionary initialValues):
