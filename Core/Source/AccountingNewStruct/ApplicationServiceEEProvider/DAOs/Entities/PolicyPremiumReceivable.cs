 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.PolicyPremiumReceivable.dict v1.0
 * FileSize=35088 Header=290 CRC=3822102960
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad View PolicyPremiumReceivable.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.PolicyPremiumReceivable.dict"),
    Serializable(),
    DescriptionKey("RECEIVABLE_PREMIUM_STATUS_SEARCH_ENTITY"),
    TableMap(TableName="RECEIVABLE_PREMIUM_STATUS_SEARCH", Schema="ACC"),
    ]
    public partial class PolicyPremiumReceivable :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<PolicyPremiumReceivable>(policyId, paymentMethodId, paymentScheduleId);
        }
        #endregion
        ...
        public PolicyPremiumReceivable(int policyId, int paymentMethodId, int paymentScheduleId) :
            this(PolicyPremiumReceivable.CreatePrimaryKey(policyId, paymentMethodId, paymentScheduleId), null)
        {
        }
        ...
        /// </param>
        public PolicyPremiumReceivable(PrimaryKey key, IDictionary initialValues) :
