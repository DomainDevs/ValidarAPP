 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetCoinsuranceCheckingAccount.dict v1.0
 * FileSize=25671 Header=290 CRC=2504235215
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad CoinsuranceCheckingAccount View.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.CoinsuranceCheckingAccount.dict"),
    Serializable(),
    DescriptionKey("GET_COINSURANCE_CHECKING_ACCOUNT_ENTITY"),
    TableMap(TableName = "GET_COINSURANCE_CHECKING_ACCOUNT", Schema = "ACC"),
    ]
    public partial class CoinsuranceCheckingAccount :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<CoinsuranceCheckingAccount>(coinsCheckingAccTransId);
        }
        #endregion
        ...
        public CoinsuranceCheckingAccount(int coinsCheckingAccTransId) :
            this(CoinsuranceCheckingAccount.CreatePrimaryKey(coinsCheckingAccTransId), null)
        {
        }
        ...
        /// </param>
        public CoinsuranceCheckingAccount(PrimaryKey key, IDictionary initialValues) :
