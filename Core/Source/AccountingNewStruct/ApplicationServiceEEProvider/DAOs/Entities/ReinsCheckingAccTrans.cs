 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.ReinsCheckingAccTrans.dict v1.0
 * FileSize=24193 Header=282 CRC=1812777550
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad ReinsCheckingAccTrans.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.ReinsCheckingAccTrans.dict"),
    Serializable(),
    DescriptionKey("REINS_CHECKING_ACC_TRANS_ENTITY"),
    TableMap(TableName="REINS_CHECKING_ACC_TRANS", Schema="ACC"),
    ]
    public partial class ReinsCheckingAccTrans :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<ReinsCheckingAccTrans>(reinsCheckingAccTransId);
		}
#endregion
	    ...
	    public ReinsCheckingAccTrans(int reinsCheckingAccTransId):
			this(ReinsCheckingAccTrans.CreatePrimaryKey(reinsCheckingAccTransId), null)
	    {
	    }
		...
		/// </param>
	    public ReinsCheckingAccTrans(PrimaryKey key, IDictionary initialValues):
