 ...
 * Template: Sistran.Core.Application.AccountingServices.GetUsersCloseBox.dict v1.0
 * FileSize=4964 Header=261 CRC=2249320134
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad UniqueUsersCloseBox View.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.UniqueUsersCloseBox.dict"),
    Serializable(),
    DescriptionKey("GET_USERS_CLOSE_BOX_ENTITY"),
    TableMap(TableName = "GET_USERS_CLOSE_BOX", Schema = "ACC"),
    ]
    public partial class UniqueUsersCloseBox :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<UniqueUsersCloseBox>();
        }
        #endregion
        ...
        /// </summary>
        public UniqueUsersCloseBox() :
            this(UniqueUsersCloseBox.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public UniqueUsersCloseBox(PrimaryKey key, IDictionary initialValues) :
