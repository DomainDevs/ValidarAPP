 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetCommissionBalance.dict v1.0
 * FileSize=27582 Header=281 CRC=4225389524
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad GetCommissionBalance.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.GetCommissionBalance.dict"),
    Serializable(),
    DescriptionKey("GET_COMMISSION_BALANCE_ENTITY"),
    TableMap(TableName="GET_COMMISSION_BALANCE", Schema="ACC"),
    ]
    public partial class GetCommissionBalance :
        BusinessObject2
    {
#region static
		/// <summary>
		...
		public static class Properties
		{
			...
			public static readonly string CommissionAmountTotal = "CommissionAmountTotal";
	    ...
	    {
			return InternalCreatePrimaryKey<GetCommissionBalance>();
		}
#endregion
		...
		/// <summary>
		/// Atributo para la propiedad BrokerCheckingAccountTransId.
		/// </summary>
        private int _brokerCheckingAccountTransId;
		/// <summary>
		...
		/// </summary>
        private int _documentNumEndorsement;
		/// <summary>
		...
		/// <summary>
		/// Atributo para la propiedad CommissionAmountTotal.
		/// </summary>
        private decimal? _commissionAmountTotal = null;
		/// <summary>
		...
		/// </summary>
	    public GetCommissionBalance():
			this(GetCommissionBalance.CreatePrimaryKey(), null)
	    {
	    }
		...
		/// </param>
	    public GetCommissionBalance(PrimaryKey key, IDictionary initialValues):
        ...
        public int BrokerCheckingAccountTransId
	    {
		    get
		    {
			    return this._brokerCheckingAccountTransId;
		    }
		    set
		    {
				this._brokerCheckingAccountTransId = value;
			}
	    }
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad CommissionAmountTotal.
		/// </summary>
		/// <value>Propiedad CommissionAmountTotal.</value>
	    [
		DescriptionKey("COMMISSION_AMOUNT_TOTAL_PROPERTY"),
		PersistentProperty(IsNullable = true),
        ColumnMap(ColumnName="COMMISSION_AMOUNT_TOTAL", DbType=System.Data.DbType.Decimal),
	    ]
        public decimal? CommissionAmountTotal
	    {
		    get
		    {
			    return this._commissionAmountTotal;
		    }
		    set
		    {
				this._commissionAmountTotal = value;
			}
	    }
