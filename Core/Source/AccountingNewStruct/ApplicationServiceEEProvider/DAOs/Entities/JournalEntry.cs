 ...
 * Template: Sistran.Core.Application.AccountingServices.JournalEntry.dict v1.0
 * FileSize=9414 Header=255 CRC=97597061
 ******************************************/
using System;
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.JournalEntry.dict"),
    Serializable(),
    DescriptionKey("JOURNAL_ENTRY_ENTITY"),
    TableMap(TableName = "JOURNAL_ENTRY", Schema = "ACC"),
    ]
...
#region static
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int journalEntryCode)
	    {
		...
		/// </summary>
		/// <param name="journalEntryCode">Propiedad clave JournalEntryCode.</param>
		public static PrimaryKey CreatePrimaryKey(int journalEntryCode)
	    {
			return InternalCreatePrimaryKey<JournalEntry>(journalEntryCode);
		}
#endregion
	    ...
	    public JournalEntry(int journalEntryCode):
			this(JournalEntry.CreatePrimaryKey(journalEntryCode), null)
	    {
	    }
