 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetBrokerCheckingAccount.dict v1.0
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.BrokerCheckAccountTrans.dict"),
    Serializable(),
