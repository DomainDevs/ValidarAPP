 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.PayerOrderAuthorizedView.dict v1.0
 * FileSize=13038 Header=282 CRC=3707407477
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad PayerOrderAuthorizedView.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.PayerOrderAuthorizedView.dict"),
    Serializable(),
    DescriptionKey("PAYER_ORDER_AUTHORIZED_V_ENTITY"),
    TableMap(TableName="PAYER_ORDER_AUTHORIZED_V", Schema="ACC"),
    ]
    public partial class PayerOrderAuthorizedView :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<PayerOrderAuthorizedView>(paymentOrderCode);
		}
#endregion
	    ...
	    public PayerOrderAuthorizedView(int paymentOrderCode):
			this(PayerOrderAuthorizedView.CreatePrimaryKey(paymentOrderCode), null)
	    {
	    }
		...
		/// </param>
	    public PayerOrderAuthorizedView(PrimaryKey key, IDictionary initialValues):
