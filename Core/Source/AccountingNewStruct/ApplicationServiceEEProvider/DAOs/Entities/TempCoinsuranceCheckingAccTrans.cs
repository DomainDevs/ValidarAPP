 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetCoinsuranceCheckingAccountItem.dict v1.0
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.TempCoinsuranceCheckingAccTrans.dict"),
    Serializable(),
