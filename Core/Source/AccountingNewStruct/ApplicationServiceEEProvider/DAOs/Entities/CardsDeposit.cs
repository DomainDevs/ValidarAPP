 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetCardToDeposit.dict v1.0
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.CardsDeposit.dict"),
    Serializable(),
