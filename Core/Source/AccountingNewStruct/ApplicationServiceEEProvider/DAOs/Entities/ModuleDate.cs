 ...
 * Template: Sistran.Core.Application.CommonService3GProvider.ModuleDate.dict v1.0
 * FileSize=8863 Header=264 CRC=2510986337
 ******************************************/
using System;
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.ModuleDate.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        public ModuleDate(int moduleCode) :
