 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetBrokerCheckingAccountItem.dict v1.0
 * FileSize=27513 Header=289 CRC=1143427977
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad TempBrokerCheckingAccountItems View.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.TempBrokerCheckingAccountItems.dict"),
    Serializable(),
    DescriptionKey("GET_BROKER_CHECKING_ACCOUNT_ITEM_ENTITY"),
    TableMap(TableName = "GET_BROKER_CHECKING_ACCOUNT_ITEM", Schema = "ACC"),
    ]
    public partial class TempBrokerCheckingAccountItems :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        public static class Properties
        {
            ...
            public static readonly string TempBrokerCheckingAccountItemCode = "TempBrokerCheckingAccountI_326";
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int brokerCheckingAccountTransId, int tempBrokerCheckingAccountItemCode, int prefixCode)
        {
        ...
        /// <param name="tempBrokerCheckingAccountItemCode">Propiedad clave TempBrokerCheckingAccountItemCode.</param>
        /// <param name="prefixCode">Propiedad clave PrefixCode.</param>
        public static PrimaryKey CreatePrimaryKey(int brokerCheckingAccountTransId, int tempBrokerCheckingAccountItemCode, int prefixCode)
        {
            return InternalCreatePrimaryKey<TempBrokerCheckingAccountItems>(brokerCheckingAccountTransId, tempBrokerCheckingAccountItemCode, prefixCode);
        }
        #endregion
        ...
        /// <summary>
        /// Atributo para la propiedad TempBrokerCheckingAccountCode.
        /// </summary>
        ...
        public TempBrokerCheckingAccountItems(int brokerCheckingAccountTransId, int tempBrokerCheckingAccountItemCode, int prefixCode) :
            this(TempBrokerCheckingAccountItems.CreatePrimaryKey(brokerCheckingAccountTransId, tempBrokerCheckingAccountItemCode, prefixCode), null)
        {
        }
        ...
        /// </param>
        public TempBrokerCheckingAccountItems(PrimaryKey key, IDictionary initialValues) :
        ...
        PersistentProperty(IsKey = true, DataName = "TempBrokerCheckingAccountI_326"),
        ...
        /// <summary>
        /// Devuelve o setea el valor de la propiedad TempBrokerCheckingAccountCode.
        /// </summary>
        /// <value>Propiedad TempBrokerCheckingAccountCode.</value>
        [
        DescriptionKey("TEMP_BROKER_CHECKING_ACCOUNT_CODE_PROPERTY"),
        PersistentProperty(IsNullable = true),
        ColumnMap(ColumnName = "TEMP_BROKER_CHECKING_ACCOUNT_CD", DbType = System.Data.DbType.String),
        ]
        public int? TempBrokerCheckingAccountCode
        {
            get
            {
