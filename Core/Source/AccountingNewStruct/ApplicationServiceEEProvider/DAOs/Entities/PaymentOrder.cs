 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.PaymentOrder.dict v1.0
 * FileSize=18064 Header=273 CRC=1398029498
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad PaymentOrder.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.PaymentOrder.dict"),
    Serializable(),
    DescriptionKey("PAYMENT_ORDER_ENTITY"),
    TableMap(TableName="PAYMENT_ORDER", Schema="ACC"),
    ]
...
#region static
	    ...
	    {
			return InternalCreatePrimaryKey<PaymentOrder>(paymentOrderCode);
		}
#endregion
	    ...
	    public PaymentOrder(int paymentOrderCode):
			this(PaymentOrder.CreatePrimaryKey(paymentOrderCode), null)
	    {
	    }
		...
		/// </param>
	    public PaymentOrder(PrimaryKey key, IDictionary initialValues):
