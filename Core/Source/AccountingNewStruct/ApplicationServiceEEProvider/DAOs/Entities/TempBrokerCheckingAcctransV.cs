 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.TempBrokerCheckingAcctransV.dict v1.0
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.TempBrokerCheckin.dict"),
    Serializable(),
