 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetPremiumReceivableAgent.dict v1.0
 * FileSize=12956 Header=286 CRC=2460660483
 ******************************************/
using System;
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.GetPremiumReceivableAgent.dict"),
    Serializable(),
...
#region static
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int premiumReceivableTransId, int businessTypeCode)
	    {
		...
		/// <param name="premiumReceivableTransId">Propiedad clave PremiumReceivableTransId.</param>
		/// <param name="businessTypeCode">Propiedad clave BusinessTypeCode.</param>
		public static PrimaryKey CreatePrimaryKey(int premiumReceivableTransId, int businessTypeCode)
	    {
			return InternalCreatePrimaryKey<GetPremiumReceivableAgent>(premiumReceivableTransId, businessTypeCode);
		}
#endregion
	    ...
	    public GetPremiumReceivableAgent(int premiumReceivableTransId, int businessTypeCode):
			this(GetPremiumReceivableAgent.CreatePrimaryKey(premiumReceivableTransId, businessTypeCode), null)
	    {
	    }
