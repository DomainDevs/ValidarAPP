 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.Format.dict v1.0
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.Format.dict"),
    Serializable(),
    DescriptionKey("FORMAT_ENTITY"),
    TableMap(TableName="FORMAT", Schema="ACC"),
    ]
