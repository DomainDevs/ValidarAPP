 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.LogSpecialProcess.dict v1.0
 * FileSize=14792 Header=277 CRC=977706133
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad LogSpecialProcess.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.LogSpecialProcess.dict"),
    Serializable(),
    DescriptionKey("LOG_SPECIAL_PROCESS_ENTITY"),
    TableMap(TableName="LOG_SPECIAL_PROCESS", Schema="ACC"),
    ]
    public partial class LogSpecialProcess :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<LogSpecialProcess>(logSpecialProcessId);
		}
#endregion
	    ...
	    public LogSpecialProcess(int logSpecialProcessId):
			this(LogSpecialProcess.CreatePrimaryKey(logSpecialProcessId), null)
	    {
	    }
		...
		/// </param>
	    public LogSpecialProcess(PrimaryKey key, IDictionary initialValues):
