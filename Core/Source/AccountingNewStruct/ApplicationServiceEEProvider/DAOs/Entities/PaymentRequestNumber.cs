 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.PaymentRequestNumber.dict v1.0
 * FileSize=3827 Header=280 CRC=1904493578
 ******************************************/
using System;
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.PaymentRequestNumber.dict"),
    Serializable(),
    DescriptionKey("PAYMENT_REQUEST_NUMBER_ENTITY"),
    TableMap(TableName="PAYMENT_REQUEST_NUMBER", Schema="ACC"),
    ]
