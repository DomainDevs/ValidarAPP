 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetCreditNoteAutomaticProcess.dict v1.0
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.CreditNoteAutomaticProcess.dict"),
    Serializable(),
