 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.GetReinsuranceCheckingAccount.dict v1.0
 * FileSize=33031 Header=290 CRC=3020439554
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad ReinsuranceCheckingAccount View.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.ReinsuranceCheckingAccount.dict"),
    Serializable(),
    DescriptionKey("GET_REINSURANCE_CHECKING_ACCOUNT_ENTITY"),
    TableMap(TableName="GET_REINSURANCE_CHECKING_ACCOUNT", Schema="ACC"),
    ]
    public partial class ReinsuranceCheckingAccount :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int reinsCheckingAccTransId)
	    {
		...
		/// </summary>
		/// <param name="reinsCheckingAccTransId">Propiedad clave ReinsCheckingAccTransId.</param>
		public static PrimaryKey CreatePrimaryKey(int reinsCheckingAccTransId)
	    {
			return InternalCreatePrimaryKey<ReinsuranceCheckingAccount>(reinsCheckingAccTransId);
		}
#endregion
	    ...
	    public ReinsuranceCheckingAccount(int reinsCheckingAccTransId):
			this(ReinsuranceCheckingAccount.CreatePrimaryKey(reinsCheckingAccTransId), null)
	    {
	    }
		...
		/// </param>
	    public ReinsuranceCheckingAccount(PrimaryKey key, IDictionary initialValues):
