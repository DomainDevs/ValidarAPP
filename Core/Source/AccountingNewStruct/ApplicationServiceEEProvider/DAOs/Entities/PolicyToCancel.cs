 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.PolicyToCancelV.dict v1.0
 * FileSize=21952 Header=275 CRC=246320010
 ******************************************/
using System;
...
namespace Sistran.Core.Application.AccountingServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.PolicyToCancelV.dict"),
    Serializable(),
    DescriptionKey("POLICY_TO_CANCEL_V_ENTITY"),
    TableMap(TableName="POLICY_TO_CANCEL_V", Schema="ACC"),
    ]
    public partial class PolicyToCancel :
        BusinessObject2
    {
#region static
		/// <summary>
		...
		/// <param name="endorsementTypeCode">Propiedad clave EndorsementTypeCode.</param>
		/// <param name="policyId">Propiedad clave PolicyId.</param>
		/// <returns>Clave primaria.</returns>
	    protected static PrimaryKey InternalCreatePrimaryKey<T>(int endorsementTypeCode, int policyId)
	    {
		    Dictionary<string, object> keys = new Dictionary<string, object>();
		    keys.Add(Properties.EndorsementTypeCode, endorsementTypeCode);
		...
		/// <param name="endorsementTypeCode">Propiedad clave EndorsementTypeCode.</param>
		/// <param name="policyId">Propiedad clave PolicyId.</param>
		public static PrimaryKey CreatePrimaryKey(int endorsementTypeCode, int policyId)
	    {
			return InternalCreatePrimaryKey<PolicyToCancel>(endorsementTypeCode, policyId);
		}
#endregion
		...
		/// </summary>
		/// <param name="endorsementTypeCode">EndorsementTypeCode key property.</param>
		/// <param name="policyId">PolicyId key property.</param>
	    public PolicyToCancel(int endorsementTypeCode, int policyId):
			this(PolicyToCancel.CreatePrimaryKey(endorsementTypeCode, policyId), null)
	    {
	    }
		...
		/// </param>
	    public PolicyToCancel(PrimaryKey key, IDictionary initialValues):
        ...
        public int EndorsementTypeCode
	    {
		    get
		    {
				return (int)this._primaryKey[Properties.EndorsementTypeCode];
		    }
		    set
		    {
				this._primaryKey[Properties.EndorsementTypeCode] = value;
			}
	    }
        ...
        public string AgentDocumentNumber
	    {
		    ...
		    set
		    {
				if(value == null)
				{
					throw new PropertyNotNullableException(this.GetType().FullName, Properties.AgentDocumentNumber);
				}
