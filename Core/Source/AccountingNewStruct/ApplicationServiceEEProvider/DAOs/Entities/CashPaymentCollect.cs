 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.CashPaymentCollect.dict v1.0
 * FileSize=12478 Header=280 CRC=768428584
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad CashPaymentCollectView.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.CashPaymentCollect.dict"),
    Serializable(),
    DescriptionKey("GET_CASH_AMOUNT_TO_CLOSE_ENTITY"),
    TableMap(TableName = "GET_CASH_AMOUNT_TO_CLOSE", Schema = "ACC"),
    ]
    public partial class CashPaymentCollect :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<CashPaymentCollect>(paymentCode, collectControlId);
        }
        #endregion
        ...
        public CashPaymentCollect(int paymentCode, int collectControlId) :
            this(CashPaymentCollect.CreatePrimaryKey(paymentCode, collectControlId), null)
        {
        }
        ...
        /// </param>
        public CashPaymentCollect(PrimaryKey key, IDictionary initialValues) :
