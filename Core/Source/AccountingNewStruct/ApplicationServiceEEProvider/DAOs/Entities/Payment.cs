 ...
 * Template: Sistran.Core.Application.AccountingServices.EEProvider.Payment.dict v1.0
 * FileSize=20784 Header=267 CRC=876754233
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad Payment.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.AccountingServices.EEProvider.Payment.dict"),
    Serializable(),
    DescriptionKey("PAYMENT_ENTITY"),
    TableMap(TableName="PAYMENT", Schema="ACC"),
    ]
...
#region static
	    ...
	    {
			return InternalCreatePrimaryKey<Payment>(paymentCode);
		}
#endregion
	    ...
	    public Payment(int paymentCode):
			this(Payment.CreatePrimaryKey(paymentCode), null)
	    {
	    }
		...
		/// </param>
	    public Payment(PrimaryKey key, IDictionary initialValues):
