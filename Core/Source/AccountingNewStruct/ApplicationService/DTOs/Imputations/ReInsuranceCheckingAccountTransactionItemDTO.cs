...
namespace Sistran.Core.Application.AccountingServices.DTOs.Imputations
{
    ...
    /// </summary>
    [DataContract]
    public class ReInsuranceCheckingAccountTransactionItemDTO : CheckingAccountTransactionDTO
    {
        /// <summary>
        /// Id 
        /// </summary>        
        ...
        /// <returns></returns>
        [DataMember]
        public List<ReInsuranceCheckingAccountTransactionItemDTO> ReInsuranceCheckingAccountTransactionChild
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public List<ReinsuranceCheckingAccountItemDTO> ReinsurancesCheckingAccountItems
        {
            get;
            set;
        }
