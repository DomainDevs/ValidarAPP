 ...
 * Template: Sistran.Core.Application.MassiveUnderwritingServices.EEProvider.Email.dict v1.0
 * FileSize=6082 Header=262 CRC=3537892984
 ******************************************/
using System;
...
namespace Sistran.Core.Application.CollectiveServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.CollectiveServices.EEProvider.Email.dict"),
    Serializable(),
    DescriptionKey("EMAIL_ENTITY"),
    TableMap(TableName="EMAIL", Schema="UP"),
    ]
