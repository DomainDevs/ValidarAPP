 ...
 * Template: Sistran.Core.Application.MassiveUnderwritingServices.EEProvider.MassiveCollectiveRelation.dict v1.0
 * FileSize=8158 Header=294 CRC=1826246851
 ******************************************/
using System;
...
namespace Sistran.Core.Application.CollectiveServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.CollectiveServices.EEProvider.CollectiveRelation.dict"),
    Serializable(),
    DescriptionKey("MASSIVE_COLLECTIVE_RELATION_ENTITY"),
    TableMap(TableName = "MASSIVE_COLLECTIVE_RELATION", Schema = "MSV"),
    ]
    public partial class MassiveCollectiveRelation :
        BusinessObject2
    {
        #region static
        /// <summary>
