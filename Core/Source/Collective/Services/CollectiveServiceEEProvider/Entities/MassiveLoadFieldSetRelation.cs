 ...
 * Template: Sistran.Core.Application.MassiveUnderwritingServices.EEProvider.MassiveLoadFieldSetRelation.dict v1.0
 * FileSize=4582 Header=284 CRC=3049609598
 ******************************************/
using System;
...
namespace Sistran.Core.Application.CollectiveServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.CollectiveServices.EEProvider.MassiveLoadFieldSetRelation.dict"),
    Serializable(), DescriptionKey("MASSIVE_LOAD_FIELD_SET_RELATION_ENTITY")
    ]
    public class MassiveLoadFieldSetRelation : BusinessObject
    {
#region static
		/// <summary>
