...
namespace Sistran.Core.Application.MarineEndorsementCancellationService.EEProvider
{
    public class MarineCancellationServiceEEProvider : CancellationEndorsementEEProvider, IMarineCancellationService
    {
        /// <summary>
