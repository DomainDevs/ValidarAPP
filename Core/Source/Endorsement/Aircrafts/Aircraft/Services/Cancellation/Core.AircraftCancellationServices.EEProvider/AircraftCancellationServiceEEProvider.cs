...
namespace Sistran.Core.Application.AircraftEndorsementCancellationService.EEProvider
{
    public class AircraftCancellationServiceEEProvider : CancellationEndorsementEEProvider, IAircraftCancellationService
    {
        /// <summary>
