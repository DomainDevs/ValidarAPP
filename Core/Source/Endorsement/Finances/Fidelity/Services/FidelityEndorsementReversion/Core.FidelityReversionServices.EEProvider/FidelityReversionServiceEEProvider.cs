...
using Sistran.Core.Application.FidelityEndorsementReversionService3GProvider.DAOs;
...
namespace Sistran.Core.Application.FidelityEndorsementReversionService.EEProvider
{
    public class FidelityReversionServiceEEProvider : ReversionEndorsementEEProvider, IFidelityReversionService
    {
