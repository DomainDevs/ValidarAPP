using Sistran.Core.Application.FidelityEndorsementCancellationService.EEProvider;
using System;
...
namespace Sistran.Core.Application.FidelityEndorsementCancellationService3GProvider.DAOs
{
