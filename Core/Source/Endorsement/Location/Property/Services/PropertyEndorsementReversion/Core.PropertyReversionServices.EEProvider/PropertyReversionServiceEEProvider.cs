...
using Sistran.Core.Application.PropertyEndorsementReversionService3GProvider.DAOs;
...
namespace Sistran.Core.Application.PropertyEndorsementReversionService.EEProvider
{
    public class PropertyReversionServiceEEProvider : ReversionEndorsementEEProvider, IPropertyReversionService
    {
