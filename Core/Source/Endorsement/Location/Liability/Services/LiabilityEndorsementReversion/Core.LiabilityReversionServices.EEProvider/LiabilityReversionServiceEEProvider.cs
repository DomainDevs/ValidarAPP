...
using Sistran.Core.Application.LiabilityEndorsementReversionService3GProvider.DAOs;
...
namespace Sistran.Core.Application.LiabilityEndorsementReversionService.EEProvider
{
    public class LiabilityReversionServiceEEProvider : ReversionEndorsementEEProvider, ILiabilityReversionService
    {
