using Sistran.Core.Application.ThirdPartyLiabilityEndorsementCancellationService.EEProvider;
using System;
...
namespace Sistran.Core.Application.ThirdPartyLiabilityEndorsementCancellationService3GProvider.DAOs
{
    public class CancellationDAO
    {
        ...
        public int CreateTemporalEndorsementCancellation(Policy policy, int cancellationFactor, string userName)
        {
            ...
            {
                result = pdb.ExecuteSPScalar("TMP.CANCELLATION_POLICY_VEHICLE", parameters);
            }
