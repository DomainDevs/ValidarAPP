...
namespace Sistran.Core.Application.ThirdPartyLiabilityEndorsementCancellationService
{
    [ServiceContract]
    public interface IThirdPartyLiabilityCancellationService : ICancellationEndorsement
    {
        /// <summary>
