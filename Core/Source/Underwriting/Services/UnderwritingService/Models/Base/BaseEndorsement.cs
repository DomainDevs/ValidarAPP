...
namespace Sistran.Core.Application.UnderwritingServices.Models.Base
{
    ...
    public class BaseEndorsement : Extension
    {
        ...
        /// </summary>
        [DataMember]
        public int CapacityOfCode { get; set; }
        /// <summary>
        /// ExchangeRate
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        public int SubscriptionReqId { get; set; }

        [DataMember]
        public int UserId { get; set; }

        /// <summary>
        /// Cancelacion Vigencia Inicial
        /// </summary>
        [DataMember]
        public DateTime CancelationCurrentFrom { get; set; }

        /// <summary>
        /// Cancelacion Vigencia Final
        /// </summary>
        [DataMember]
        public DateTime CancelationCurrentTo { get; set; }
    }
}
