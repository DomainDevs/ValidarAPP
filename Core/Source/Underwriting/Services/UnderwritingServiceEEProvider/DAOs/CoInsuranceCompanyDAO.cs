...
namespace Sistran.Core.Application.UniquePersonService.DAO
{
    public class CoInsuranceCompanyDAO
    {
        /// <summary>
        /// Obtener la lista de compañias Coaseguradoras
        /// </summary>
        /// <returns></returns>
        public List<IssuanceCoInsuranceCompany> GetCoInsuranceCompanies()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IssuanceCoInsuranceCompany GetCoInsuranceCompanyByCoinsuranceId(int coInsuranceId)
        {
            Stopwatch stopWatch = new Stopwatch();
            stopWatch.Start();
