...
namespace Sistran.Core.Application.AccountingClosingServices.EEProvider.Assemblers
{
    public static class DTOAssembler
    {
        ...
        public static MassiveReportDTO ToDTO(this MassiveReport massiveReport)
        {
            var config = CreateMapMassiveReport();
            return config.Map<MassiveReport, MassiveReportDTO>(massiveReport);
        }

        public static List<MassiveReportDTO> ToDTOs(this List<MassiveReport> massiveReports)
        {
            return massiveReports.Select(ToDTO).ToList();
        }
        ...
        public static IMapper CreateMapExchangeRate()
        {
        ...
        public static ExchangeRateDTO ToDTO(this ExchangeRate accountingAccount)
        {
            var config = CreateMapAccountingAccounts();
            return config.Map<ExchangeRate, ExchangeRateDTO>(accountingAccount);
        }

        public static IEnumerable<ExchangeRateDTO> ToDTOs(this IEnumerable<ExchangeRate> exchangeRates)
        {
        ...
        public static IMapper CreateMapEntryTypeItems()
        {
            var config = MapperCache.GetMapper<EntryTypeItem, EntryTypeItemDTO>(cfg =>
            {
                ...
                cfg.CreateMap<AccountingMovementType, AccountingMovementTypeDTO>();
                cfg.CreateMap<AccountingAccount, AccountingAccountDTO>();
                cfg.CreateMap<AccountingConcept, GeneralLedgerServices.DTOs.AccountingConcepts.AccountingConceptDTO>();
                cfg.CreateMap<Currency, CurrencyDTO>();
                cfg.CreateMap<Analysis, AnalysisDTO>();
                cfg.CreateMap<CostCenter, CostCenterDTO>();
            });
        ...
        {
            var config = MapperCache.GetMapper<Models.GeneralLedger.AccountingRules.Parameter, ParameterDTO>(cfg =>
            {
                cfg.CreateMap<Models.GeneralLedger.AccountingRules.Parameter, ParameterDTO>();
            });
            return config;
        }

        public static ParameterDTO ToDTO(this Models.GeneralLedger.AccountingRules.Parameter parameter)
        {
            var config = CreateMapAccountingAccountMasks();
            return config.Map<Models.GeneralLedger.AccountingRules.Parameter, ParameterDTO>(parameter);
        }

        public static IEnumerable<ParameterDTO> ToDTOs(this IEnumerable<Models.GeneralLedger.AccountingRules.Parameter> parameters)
        {
        ...
        {
            var config = MapperCache.GetMapper<AccountingConcept, GeneralLedgerServices.DTOs.AccountingConcepts.AccountingConceptDTO>(cfg =>
            {
                cfg.CreateMap<AccountingConcept, GeneralLedgerServices.DTOs.AccountingConcepts.AccountingConceptDTO>();
                cfg.CreateMap<AccountingAccount, AccountingAccountDTO>();
            });
        ...
        public static GeneralLedgerServices.DTOs.AccountingConcepts.AccountingConceptDTO ToDTO(this AccountingConcept accountingConcept)
        {
            var config = CreateMapAccountingConcepts();
            return config.Map<AccountingConcept, GeneralLedgerServices.DTOs.AccountingConcepts.AccountingConceptDTO>(accountingConcept);
        }

        public static IEnumerable<GeneralLedgerServices.DTOs.AccountingConcepts.AccountingConceptDTO> ToDTOs(this IEnumerable<AccountingConcept> accountingConcept)
        {
        ...
        internal static void ToDTO(object v)
        {
        ...
        public static IMapper CreateMapGLLedgerEntry()
        {
            var config = MapperCache.GetMapper<LedgerEntryDTO, GL.LedgerEntryDTO>(cfg =>
            {
                cfg.CreateMap<LedgerEntryDTO, GL.LedgerEntryDTO>();
                cfg.CreateMap<AccountingCompanyDTO, GL.AccountingCompanyDTO>();
                cfg.CreateMap<AccountingMovementTypeDTO, GL.AccountingMovementTypeDTO>();
                cfg.CreateMap<BranchDTO, GL.BranchDTO>();
                cfg.CreateMap<SalePointDTO, GL.SalePointDTO>();
                cfg.CreateMap<EntryDestinationDTO, GL.EntryDestinationDTO>();
                cfg.CreateMap<LedgerEntryItemDTO, GL.LedgerEntryItemDTO>().ReverseMap();
            });
            return config;
        }

        public static GL.LedgerEntryDTO ToDTO(this LedgerEntryDTO ledgerEntryDTO)
        {
            var config = CreateMapGLLedgerEntry();
            return config.Map<LedgerEntryDTO, GL.LedgerEntryDTO>(ledgerEntryDTO);
        }

        public static IEnumerable<GL.LedgerEntryDTO> ToDTOs(this IEnumerable<LedgerEntryDTO> ledgerEntrysDTO)
        {
            return ledgerEntrysDTO.Select(ToDTO);
        }

        public static IMapper CreateMapGLAccountingAccount()
        {
            var config = MapperCache.GetMapper<AccountingAccountDTO, GL.AccountingAccountDTO>(cfg =>
            {
                cfg.CreateMap<AccountingAccountDTO, GL.AccountingAccountDTO>();
                cfg.CreateMap<PaymentConceptDTO, GL.PaymentConceptDTO>();
                cfg.CreateMap<CostCenterDTO, GL.CostCenterDTO>();
                cfg.CreateMap<AnalysisDTO, GL.AnalysisDTO>();
                cfg.CreateMap<CurrencyDTO, GL.CurrencyDTO>();
                cfg.CreateMap<BranchDTO, GL.BranchDTO>();
                cfg.CreateMap<AccountingAccountTypeDTO, GL.AccountingAccountTypeDTO>();
                cfg.CreateMap<PrefixDTO, GL.PrefixDTO>().ReverseMap();
            });
            return config;
        }

        public static GL.AccountingAccountDTO ToDTO(this AccountingAccountDTO accountingAccountDTO)
        {
            var config = CreateMapGLAccountingAccount();
            return config.Map<AccountingAccountDTO, GL.AccountingAccountDTO>(accountingAccountDTO);
        }

        public static IEnumerable<GL.AccountingAccountDTO> ToDTOs(this IEnumerable<AccountingAccountDTO> accountingAccountsDTO)
        {
            return accountingAccountsDTO.Select(ToDTO);
        }
        ...
        public static AccountingAccountDTO ToDTO(this GL.AccountingAccountDTO accountingAccountDTO)
        {
            var config = CreateMapGLAccountingAccount();
            return config.Map<GL.AccountingAccountDTO, AccountingAccountDTO>(accountingAccountDTO);
        }

        public static IEnumerable<AccountingAccountDTO> ToDTOs(this IEnumerable<GL.AccountingAccountDTO> accountingAccountsDTO)
        {
            return accountingAccountsDTO.Select(ToDTO);
        }
