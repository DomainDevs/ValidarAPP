...
{
    public class RuleConceptPaymentMethods
    {
        public static int Id = int.Parse(EnumHelper.GetEnumParameterValue(Enums.FacadeType.RULE_FACADE_PAYMENT_METHODS).ToString());
