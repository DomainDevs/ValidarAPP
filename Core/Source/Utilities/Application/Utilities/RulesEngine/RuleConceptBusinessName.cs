...
{
    public class RuleConceptBusinessName
    {
        public static int Id = int.Parse(EnumHelper.GetEnumParameterValue(Enums.FacadeType.RULE_FACADE_BUSINESS_NAME).ToString());
