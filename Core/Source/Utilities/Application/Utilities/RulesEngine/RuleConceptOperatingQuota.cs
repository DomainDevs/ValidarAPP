...
{
    public class RuleConceptOperatingQuota
    {
        public static int Id = int.Parse(EnumHelper.GetEnumParameterValue(Enums.FacadeType.RULE_FACADE_OPERATING_QUOTA).ToString());
