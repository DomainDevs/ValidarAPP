...
{
    [Serializable()]
    public class SupplierBranchAccountingConceptView : BusinessView
    {
        ...
        public BusinessCollection SupplierAccountingConcepts
        {
            get
            {
                return this["SupplierAccountingConcept"];
            }
        }
