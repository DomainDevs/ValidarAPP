 ...
 * Template: Sistran.Core.Application.GeneralLedger.AnalysisConceptKey.dict v1.0
...
namespace Sistran.Core.Application.GeneralLedger.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.GeneralLedger.AnalysisConceptKey.dict"),
    Serializable(),
