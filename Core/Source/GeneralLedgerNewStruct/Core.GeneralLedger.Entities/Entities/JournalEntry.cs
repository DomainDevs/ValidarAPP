 ...
 * Template: Sistran.Core.Application.GeneralLedger.JournalEntry.dict v1.0
 * FileSize=10953 Header=257 CRC=3906041646
 ******************************************/
using System;
...
namespace Sistran.Core.Application.GeneralLedger.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.GeneralLedger.JournalEntry.dict"),
    Serializable(),
...
#region static
        ...
        {
            Dictionary<string, object> keys = new Dictionary<string, object>();
            keys.Add(Properties.JournalEntryId, null);
        ...
        {
            return InternalCreatePrimaryKey<JournalEntry>();
        }
        #endregion
        ...
        public JournalEntry() :
            this(JournalEntry.CreatePrimaryKey(), null)
        {
        }
