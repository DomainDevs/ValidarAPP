 ...
 * Template: Sistran.Core.Application.GeneralLedger.AccountingAccountMask.dict v1.0
...
namespace Sistran.Core.Application.GeneralLedger.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.GeneralLedger.AccountingAccountMask.dict"),
    Serializable(),
