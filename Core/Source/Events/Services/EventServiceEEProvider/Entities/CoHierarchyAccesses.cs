 ...
 * Template: Sistran.Core.Application.EventsServices.EEProvider.CoHierarchyAccesses.dict v1.0
...
namespace Sistran.Core.Application.EventsServices.EEProvider.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.EventsServices.EEProvider.CoHierarchyAccesses.dict"),
    Serializable(),
