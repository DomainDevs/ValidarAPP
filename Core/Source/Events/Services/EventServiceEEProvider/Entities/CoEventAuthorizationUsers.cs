 ...
 * Template: Sistran.Core.Application.EventsServices.EEProvider.CoEventAuthorizationUsers.dict v1.0
 * FileSize=5930 Header=281 CRC=1939998002
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad CoEventAuthorizationUsers.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.EventsServices.EEProvider.CoEventAuthorizationUsers.dict"),
    Serializable(),
    DescriptionKey("CO_EVENT_AUTHORIZATION_USERS_ENTITY"),
    TableMap(TableName = "CO_EVENT_AUTHORIZATION_USERS", Schema = "EVE"),
    ]
    public partial class CoEventAuthorizationUsers :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        {
            return InternalCreatePrimaryKey<CoEventAuthorizationUsers>(groupEventId, eventId, delegationId, userId);
        }
        #endregion
        ...
        public CoEventAuthorizationUsers(int groupEventId, int eventId, int delegationId, int userId) :
            this(CoEventAuthorizationUsers.CreatePrimaryKey(groupEventId, eventId, delegationId, userId), null)
        {
        }
        ...
        /// </param>
        public CoEventAuthorizationUsers(PrimaryKey key, IDictionary initialValues) :
