 ...
 * Template: Sistran.Core.Application.EndorsementServicesEEProvider.EndorsementReason.dict v1.0
 * FileSize=6527 Header=277 CRC=2239295294
 ******************************************/
using System;
...
namespace Sistran.Core.Application.BaseEndorsementService.EEProvider.Entities
{
    /// <summary>
    /// Definición de entidad EndorsementReason.
    /// </summary>
    [
    PersistentClass("Sistran.Core.Application.BaseEndorsementService.EEProvider.EndorsementReason.dict"),
    Serializable(),
