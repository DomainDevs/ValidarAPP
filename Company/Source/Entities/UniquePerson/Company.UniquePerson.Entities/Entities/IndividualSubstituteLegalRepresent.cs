 ...
 * Template: Sistran.Company.Application.UniquePerson.Entities.IndividualSubstituteLegalRepresent.dict v1.0
 * FileSize=18525 Header=290 CRC=2423635303
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad IndividualSubstituteLegalRepresent.
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.UniquePerson.IndividualSubstituteLegalRepresent.dict"),
    Serializable(),
    DescriptionKey("INDIVIDUAL_SUBSTITUTE_LEGAL_REPRESENT_ENTITY"),
    TableMap(TableName = "INDIVIDUAL_SUBSTITUTE_LEGAL_REPRESENT", Schema = "UP"),
    ]
    public partial class IndividualSubstituteLegalRepresent :
        BusinessObject2
    {
        #region static
        /// <summary>
        ...
        public static class Properties
        {
            ...
            public static readonly string LegalRepresentCode = "LegalRepresentCode";
        }
        ...
        {
            return InternalCreatePrimaryKey<IndividualSubstituteLegalRepresent>(individualId);
        }
        #endregion
        ...
        /// <summary>
        /// Atributo para la propiedad LegalRepresentCode.
        /// </summary>
        private int _legalRepresentCode;
        //*** Object Constructors ********************************
        ...
        public IndividualSubstituteLegalRepresent(int individualId) :
            this(IndividualSubstituteLegalRepresent.CreatePrimaryKey(individualId), null)
        {
        }
        ...
        /// </param>
        public IndividualSubstituteLegalRepresent(PrimaryKey key, IDictionary initialValues) :
        ...
        /// <summary>
        /// Devuelve o setea el valor de la propiedad LegalRepresentCode.
        /// </summary>
        /// <value>Propiedad LegalRepresentCode.</value>
        [
        DescriptionKey("LEGAL_REPRESENT_CODE_PROPERTY"),
        PersistentProperty(),
        ColumnMap(ColumnName = "LEGAL_REPRESENT_CD", DbType = System.Data.DbType.String),
        ]
        public int LegalRepresentCode
        {
            get
            {
                return this._legalRepresentCode;
            }
            set
            {
                this._legalRepresentCode = value;
            }
        }
