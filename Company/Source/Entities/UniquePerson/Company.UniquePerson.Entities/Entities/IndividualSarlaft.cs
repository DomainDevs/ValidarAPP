 ...
 * Template: person.IndividualSarlaft.dict v1.0
 * FileSize=16376 Header=229 CRC=600814338
 ******************************************/
using System;
...
namespace Sistran.Company.Application.UniquePerson.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.UniquePerson.IndividualSarlaft.dict"),
    Serializable(),
