 ...
 * Template: Sistran.Company.Application.UniquePerson.CoOnuList.dict v1.0
 * FileSize=3739 Header=255 CRC=2776264057
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad CoOnuList.
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.UniquePerson.CoOnuList.dict"),
    Serializable(),
    DescriptionKey("CO_ONU_LIST_ENTITY"),
    TableMap(TableName="CO_ONU_LIST", Schema="UP"),
    ]
    public partial class CoOnuList :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<CoOnuList>();
		}
#endregion
		...
		/// </summary>
	    public CoOnuList():
			this(CoOnuList.CreatePrimaryKey(), null)
	    {
	    }
		...
		/// </param>
	    public CoOnuList(PrimaryKey key, IDictionary initialValues):
