 ...
 * Template: agruopadoras.CoRequestEndorsement.dict v1.0
 * FileSize=14913 Header=239 CRC=4190175631
 ******************************************/
using System;
...
namespace Sistran.Company.Application.Request.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.Request.CoRequestEndorsement.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey<CoRequestEndorsement>();
        }
        ...
        /// </summary>
        public CoRequestEndorsement() :
            this(CoRequestEndorsement.CreatePrimaryKey(), null)
        {
        }
