 ...
 * Template: Sistran.Company.Application.Request.CoPrefixRequest.dict v1.0
...
namespace Sistran.Company.Application.Request.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.Request.CoPrefixRequest.dict"),
    Serializable(),
        ...
        BusinessObject2
    {
        ...
        {
            return InternalCreatePrimaryKey(typeof(CoPrefixRequest));
        }
        ...
        /// </summary>
        public CoPrefixRequest() :
            this(CoPrefixRequest.CreatePrimaryKey(), null)
        {
        }
