 ...
 * Template: Sistran.Core.Application.Common.State.dict v1.0
 * FileSize=5597 Header=241 CRC=391778756
 ******************************************/
...
{
    /// <summary>
    /// Definición de entidad State.
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.Common.State.dict"),
    Serializable(),
    DescriptionKey("STATE_ENTITY"),
    TableMap(TableName = "STATE", Schema = "COMM"),
    ]
        ...
        BusinessObject2
    {
        ...
        protected static PrimaryKey InternalCreatePrimaryKey<T>(int countryCode, int stateCode)
        {
        ...
        /// <param name="stateCode">Propiedad clave StateCode.</param>
        /// <param name="countryCode">Propiedad clave CountryCode.</param>
        public static PrimaryKey CreatePrimaryKey(int countryCode, int stateCode)
        {
            return InternalCreatePrimaryKey<State>(countryCode, stateCode);
        }
        
        /// <summary>
        /// Creación llave primaria
        /// </summary>
        /// <author>Germán F. Grimaldo</author>
        /// <date>19/07/2018</date>
        /// <purpose>REQ_18</purpose>
        ...
        {
            return InternalCreatePrimaryKey<State>();
        }
        #endregion
        ...
        public State(int countryCode, int stateCode) :
            this(State.CreatePrimaryKey(countryCode, stateCode), null)
        {
        }
        ...
        /// <purpose>REQ_18</purpose>
        public State() :
                   this(State.CreatePrimaryKey(), null)
        {
        }
        ...
        /// </param>
        public State(PrimaryKey key, IDictionary initialValues) :
