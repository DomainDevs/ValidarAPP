...
namespace Sistran.Company.Application.Common.Entities
{
    ...
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.Common.CoCptGroupInfringement.dict"),
    Serializable(),
        ...
        BusinessObject
    {
        ...
        public static PrimaryKey CreatePrimaryKey()
        {
            ...
            return new PrimaryKey(typeof(CoCptGroupInfringement), keys);
        }
        ...
        public CoCptGroupInfringement() :
            base(CoCptGroupInfringement.CreatePrimaryKey(), null)
        {
        }
