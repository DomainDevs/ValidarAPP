 ...
 * Template: Sistran.Company.Application.CommonServices.CptParameter.dict v1.0
 * FileSize=8193 Header=257 CRC=1635364557
 ******************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad CptParameter.
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.Common.CptParameter.dict"),
    Serializable(),
    DescriptionKey("CPT_PARAMETER_ENTITY"),
    TableMap(TableName="CPT_PARAMETER", Schema="COMM"),
    ]
    public partial class CptParameter :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<CptParameter>(parameterId);
		}
#endregion
	    ...
	    public CptParameter(int parameterId):
			this(CptParameter.CreatePrimaryKey(parameterId), null)
	    {
	    }
		...
		/// </param>
	    public CptParameter(PrimaryKey key, IDictionary initialValues):
