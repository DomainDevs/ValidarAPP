 ...
 * Template: Sistran.Core.Application.Common.CiaAsynchronousProcessListriskRow.dict v1.0
...
{
    /// <summary>
    /// Definición de entidad CiaAsynchronousProcessListriskRow.
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.Common.AsynchronousProcessListriskRow.dict"),
    Serializable(),
    DescriptionKey("CIA_ASYNCHRONOUS_PROCESS_LISTRISK_ROW_ENTITY"),
    TableMap(TableName="CIA_ASYNCHRONOUS_PROCESS_LISTRISK_ROW", Schema= "COMM"),
    ]
    public partial class CiaAsynchronousProcessListriskRow :
        BusinessObject2
    {
#region static
		/// <summary>
		...
		public static class Properties
		{
			...
			public static readonly string ListriskMassiveLoadId = "ListriskMassiveLoadId";
	    ...
	    {
			return InternalCreatePrimaryKey<CiaAsynchronousProcessListriskRow>(id);
		}

        public static PrimaryKey CreatePrimaryKey()
        {
            return InternalCreatePrimaryKey<CiaAsynchronousProcessListriskRow>();
        }
        #endregion
        ...
        /// <summary>
        /// Atributo para la propiedad ListriskMassiveLoadId.
        /// </summary>
        private int _listriskMassiveLoadId;
		/// <summary>
        ...
        /// <summary>
        /// Atributo del numero de documento
        /// </summary>
	    ...
	    public CiaAsynchronousProcessListriskRow(int id):
			this(CiaAsynchronousProcessListriskRow.CreatePrimaryKey(id), null)
	    {
	    }

        public CiaAsynchronousProcessListriskRow() :
            this(CiaAsynchronousProcessListriskRow.CreatePrimaryKey(), null)
        {
        }
        /// <summary>
        ...
        /// </param>
        public CiaAsynchronousProcessListriskRow(PrimaryKey key, IDictionary initialValues):
		...
		/// <summary>
		/// Devuelve o setea el valor de la propiedad ListriskMassiveLoadId.
		/// </summary>
		/// <value>Propiedad ListriskMassiveLoadId.</value>
	    [
		DescriptionKey("LISTRISK_MASSIVE_LOAD_ID_PROPERTY"),
		PersistentProperty(),
        ColumnMap(ColumnName= "LISTRISK_MASSIVE_LOAD_ID", DbType=System.Data.DbType.String),
	    ]
        public int ListriskMassiveLoadId
	    {
		    get
		    {
			    return this._listriskMassiveLoadId;
		    }
		    set
		    {
				this._listriskMassiveLoadId = value;
			}
	    }
