 ...
 * Fecha: 18/10/2013; Asunto: Acumulacion de conceptos por objeto del seguro 
 * Entidad para acumulacion de conceptos por objeto del seguro. 
 * Compañía: 1
********************************************************************/
using System;
...
{
    /// <summary>
    /// Definición de entidad CoAccumulationConcepts.
    /// </summary>
    [
    PersistentClass("Sistran.Company.Application.Common.CoAccumulationConcepts.dict"),
    Serializable(),
    DescriptionKey("CO_ACCUMULATION_CONCEPTS_ENTITY"),
    TableMap(TableName="CO_ACCUMULATION_CONCEPTS", Schema="SCR"),
    ]
    public partial class CoAccumulationConcepts :
        BusinessObject2
    {
#region static
		/// <summary>
	    ...
	    {
			return InternalCreatePrimaryKey<CoAccumulationConcepts>(conceptId, entityId);
		}
#endregion
	    ...
	    public CoAccumulationConcepts(int conceptId, int entityId):
			this(CoAccumulationConcepts.CreatePrimaryKey(conceptId, entityId), null)
	    {
	    }
		...
		/// </param>
	    public CoAccumulationConcepts(PrimaryKey key, IDictionary initialValues):
