...
namespace Sistran.Core.Framework.UIF.Web
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            {
                bundles.Add(new ScriptBundle("~/bundle/js/Quotation/Property").Include(
                    "~/Scripts/Quotation/Quotation.js",
                    "~/Scripts/Quotation/QuotationAdvancedSearch.js"
                    ));
            }
            else
            {
                bundles.Add(new ScriptBundle("~/bundle/js/Quotation/Property").Include(
                    "~/Scripts/Quotation/Quotation.es5.min.js",
                    "~/Scripts/Quotation/QuotationAdvancedSearch.es5.min.js"
                    ));
            }
