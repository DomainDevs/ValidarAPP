...
namespace Sistran.Company.PrintingService.NASE.spResponse
{
    public class Surety
    {
        ...
        public Surety(DataTable dt1, DataTable dt2)
        {
            ...
            BeneficiariesCount = Convert.ToInt32(dt1.Rows[0]["TOTAL_LINES_COUNT"].ToString() != "" ? dt1.Rows[0]["TOTAL_LINES_COUNT"].ToString() : "0");
            TextLinesCount = Convert.ToInt32(dt1.Rows[0]["COUNT_BENEFICIARIES"].ToString() != "" ? dt1.Rows[0]["COUNT_BENEFICIARIES"].ToString() : "0" );
            /// HD-2317 04/05/2010 
            /// Autor: Edgar O. Piraneque E.
            /// Descripción: Propiedad que almacena el estado que indica si se debe imprimir o no el formato de recaudo
            /// teniendo en cuenta el valor recibido de procedimiento almacenado
