...
{
    class TmpManejo : Manejo
    {
        public TmpManejo() : base() { }
        ...
        /// <summary>
        /// Agrega el titulo del reporte
        /// </summary>
        protected override void setReportTitle()
        {
            File.Add(new DatRecord(RptFields.LBL_TEMPORAL_NUMBER_HEADER, null));
            File.Add(new DatRecord(this.Field + RptFields.FLD_POLICY_NUMBER_HEADER, this.OperationId.ToString()));
        }
    }
}
