...
namespace Sistran.Core.Framework.UIF.Authorization.Server
{
    public class WebApplicationAccess
    {
        ...
        static WebApplicationAccess()
        {
            ...
            {
                AccessKey = ConfigurationManager.AppSettings["AccessKey"],//"CgP7NyLXtaGmyOgjj3sUMwmAlrSKqa5JyZ4P1OlfQeM",
                SecretKey = ConfigurationManager.AppSettings["SecretKey"], //"UTboSKRUb13ZmztLtyB0W4BN37ndx_aK8__ry9sxfv8",
                ApplicationName  = ConfigurationManager.AppSettings["ApplicationName"],//"Sise R2",
                ClientId = ConfigurationManager.AppSettings["ClientId"],//"e84a2d13704647d18277966ec839d39e"
            });
        }
