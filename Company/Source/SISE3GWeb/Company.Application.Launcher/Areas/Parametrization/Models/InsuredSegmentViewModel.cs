// -----------------------------------------------------------------------
// <copyright file="InsuredSegmentViewModel.cs" company="SISTRAN">
...
namespace Sistran.Core.Framework.UIF.Web.Areas.Parametrization.Models
{
    ...
    /// </summary>    
    public class InsuredSegmentViewModel
    {
        /// <summary>
        /// Obtiene o establece el Id del perfil de asegurado
        /// </summary>
        [Range(0, 255, ErrorMessageResourceType = typeof(App_GlobalResources.Language), ErrorMessageResourceName = "ErrorIdInsuredSegment")]        
