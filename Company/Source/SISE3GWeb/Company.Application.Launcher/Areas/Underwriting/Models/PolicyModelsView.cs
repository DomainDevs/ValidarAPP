...
namespace Sistran.Core.Framework.UIF.Web.Areas.Underwriting.Models
{
    public class PolicyModelsView
    {
        ...
        /// <summary>
        /// HolderAssociationType
        /// </summary>
        public int HolderAssociationType { get; set; }
        ...
        public string AgencyBranchDesc { get; set; }

        public int AgencyBranchSalePointId { get; set; }

        public string AgencyBranchSalePointDesc { get; set; }
    }
}