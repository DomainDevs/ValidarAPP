class RiskFidelityCoverageRequest {
    static GetCoveragesByRiskId(riskId) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskFidelity/GetCoveragesByRiskId',
    ...
    static GetCoverageByCoverageId(coverageId) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskFidelity/GetCoverageByCoverageId',
    ...
    static QuotationCoverage(coverageModel, coverageData) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskFidelity/QuotationCoverage',
    ...
    static SaveCoverages(policyId,riskId,coverages) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskFidelity/SaveCoverages',
    ...
    static ReturnRisk(PolicyId) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskFidelity/GetPolicyModelsView',
    ...
    static GetAllyCoverageByCoverage(glbPolicyId, glbRiskId, GroupCoverageId, coverageData) {
        return $.ajax({
            type: "POST",
            url: rootPath + "Underwriting/RiskFidelity/GetAllyCoverageByCoverage",
    ...
    static GetCoveragesByProductIdGroupCoverageIdPrefixId(productId, groupCoverageId, prefixId, coveragesAdd) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskFidelity/GetCoveragesByProductIdGroupCoverageIdPrefixId',
