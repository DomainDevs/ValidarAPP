class RiskThirdPartyLiabilityRequest extends Uif2.Page {
    ...
    static GetServiceTypes() {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskThirdPartyLiability/GetServiceTypes',
            dataType: "json",
            contentType: "application/json; charset=utf-8"
        });
    }
    ...
    static GetRateTypes() {
        return $.ajax({
            type: "POST",
            url: rootPath + "Underwriting/RiskThirdPartyLiability/GetRateTypes",
            dataType: "json",
            contentType: "application/json; charset=utf-8"
        });
    }
