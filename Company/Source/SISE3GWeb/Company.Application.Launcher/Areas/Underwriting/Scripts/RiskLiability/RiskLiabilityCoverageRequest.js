...
class RiskLiabilityCoverageRequest extends Uif2.Page {
    ...
    static QuotationCoverage(coverage, riskId, runRules) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskLiability/QuotationCoverage',
            data: JSON.stringify({ coverage: coverage, riskId: riskId, runRulesPost: runRules }),
            dataType: "json",
            async: false,
            contentType: "application/json; charset=utf-8"
        });
    ...
    static GetAddCoverageByCoverage(glbPolicyId, glbRiskId, GroupCoverageId, coverageData) {
        return $.ajax({
            type: "POST",
            url: rootPath + "Underwriting/RiskLiability/GetAddCoverageByCoverage",
            data: JSON.stringify({ tempId: glbPolicyId, riskId: glbRiskId, groupCoverageId: GroupCoverageId, coverage: coverageData }),
            dataType: "json",
            async: false,
            contentType: "application/json; charset=utf-8"
    ...
    static RunRulesCoverage(temporalId, riskId, coverages) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskLiability/RunRulesCoveragePreLiability',
    ...
    static RunRulesPostCoverage(temporalId, riskId, coverages) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskLiability/RunRulesPostCoverages',
            data: JSON.stringify({ temporalId: temporalId, riskId: riskId, coverages: coverages }),
            dataType: "json",
            contentType: "application/json; charset=utf-8"
        });
    ...
    static RunRulesCoveragePreLiability(temporalId, riskId, coverages) {
        return $.ajax({
            type: "POST",
            url: rootPath + 'Underwriting/RiskLiability/RunRulesCoveragePreLiability',
            data: JSON.stringify({ temporalId: temporalId, riskId: riskId, coverages: coverages }),
    ...
    static GetDeductiblesByCoverageId(coverageId) {
        return $.ajax({
            type: "POST",
            url: rootPath + "Underwriting/RiskLiability/GetDeductiblesByCoverageId",
