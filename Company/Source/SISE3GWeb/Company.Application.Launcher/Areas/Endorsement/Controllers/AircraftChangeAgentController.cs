...
{
    public class AircraftChangeAgentController : ChangeAgentController
    {
        public ActionResult CreateTemporal(ChangeAgentViewModel changeAgentModel)
        {
            try
            {
                ...
                var policy = DelegateService.ciaAircraftChangeAgentService.CreateTemporal(CompanyPolicy, false);
                if (policy != null)
                {
        ...
        public ActionResult CreateEndorsementChangeAgent(ChangeAgentViewModel changeAgentModel)
        {
            try
            {
                if (changeAgentModel != null)
                {
                    ...
                    var policy = DelegateService.ciaAircraftChangeAgentService.CreateEndorsementChangeAgent(companyPolicy.Endorsement);
                    return new UifJsonResult(true, policy);
                }
                else
                {
