...
{
    public class JudicialSuretyChangePolicyHolderController : ChangePolicyHolderController
    {
        [Authorize]
        public ActionResult CreateTemporal(ChangePolicyHolderViewModel changePolicyHolderViewModel)
        {
            ...
            try
            {
                ...
                var changeConsolidation = DelegateService.CiaJudicialSuretyChangePolicyHolderService.CreateTemporal(companyChangePolicyHolder, false);
        ...
        public ActionResult CreateEndorsementChangePolicyHolder(ChangePolicyHolderViewModel changePolicyHolderViewModel)
        {
            try
            {
                if (changePolicyHolderViewModel != null)
                {
                    ...
                    var policy = DelegateService.CiaJudicialSuretyChangePolicyHolderService.CreateEndorsementChangePolicyHolder(companyChangePolicyHolder);
