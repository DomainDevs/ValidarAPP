...
{
    public class MarineRenewalController : RenewalController
    {
        //GET: Endorsement/MarineRenewal
        public ActionResult CreateTemporal(RenewalViewModel renewalModel)
        {
            try
            {
                ...
                var policy = DelegateService.marineRenewalService.CreateRenewal(CompanyPolicy);
                if (policy != null)
                {
