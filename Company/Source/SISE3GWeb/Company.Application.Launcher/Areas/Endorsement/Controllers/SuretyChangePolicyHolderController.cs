...
{
    public class SuretyChangePolicyHolderController : ChangePolicyHolderController
    {
        [Authorize]
        public ActionResult CreateTemporal(ChangePolicyHolderViewModel changePolicyHolderViewModel)
        {
            ...
            try
            {
                ...
                var changeConsolidation = DelegateService.ciaSuretyChangePolicyHolderService.CreateTemporal(companyChangePolicyHolder, false);
        ...
        public ActionResult CreateEndorsementChangePolicyHolder(ChangePolicyHolderViewModel changePolicyHolderViewModel)
        {
            try
            {
                if (changePolicyHolderViewModel != null)
                {
                    ...
                    var policy = DelegateService.ciaSuretyChangePolicyHolderService.CreateEndorsementChangePolicyHolder(companyChangePolicyHolder);
        ...
        public ActionResult GetRiskTemporalById(int id)
        {
            try
            {
                CompanyContract companyContract = DelegateService.ciaSuretyChangePolicyHolderService.GetCompanyContractByTemporalId(id, false);
