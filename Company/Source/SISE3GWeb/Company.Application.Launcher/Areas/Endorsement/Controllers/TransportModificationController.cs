...
{
    public class TransportModificationController : ModificationController
    {
        // GET: Endorsement/TransportModification
        public ActionResult CreateTemporal(ModificationViewModel modificationModel)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var policy = DelegateService.TransportModificationService.CreateTemporal(CompanyEndorsement, false);
            ...
            {
                if (ex.Message.ToString() == App_GlobalResources.Language.ErrorAdjustPeriodAnnual.ToString())
                {
                    return new UifJsonResult(false, App_GlobalResources.Language.ErrorAdjustPeriodAnnual);
                }
                else
                {
        ...
        public ActionResult CreateTexts(ModificationViewModel modificationModel)
        {
            ...
            try
            {
                ...
                companyPolicy = DelegateService.TransporTextService.CreateTexts(CompanyEndorsement);
        ...
        //        var policy = DelegateService.transportClauseService.CreateClauses(CompanyPolicy);
        //        if (policy != null)
        //        {
        //            return new UifJsonResult(true, policy);
        //        }
        ...
        public ActionResult CreateClauses(ModificationViewModel modificationModel)
        {
            try
            {
                ...
                var companyPolicy = DelegateService.transportClauseService.CreateClauses(policy);
