...
{
    public class JudicialSuretyExtensionController : ExtensionController
    {
        [Authorize]
        public ActionResult CreateTemporal(ExtensionViewModel extensionModel)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var policy = DelegateService.JudicialSuretyExtensionService.CreateExtension(companyPolicy);
