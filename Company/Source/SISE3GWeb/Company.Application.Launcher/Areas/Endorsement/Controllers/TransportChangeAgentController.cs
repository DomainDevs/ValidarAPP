...
{
    public class TransportChangeAgentController : ChangeAgentController
    {
        public ActionResult CreateTemporal(ChangeAgentViewModel changeAgentModel)
        {
            try
            {
                ...
                var policy = DelegateService.TransportChangeAgentService.CreateTemporal(CompanyPolicy, false);
                if (policy != null)
                {
        ...
        public ActionResult CreateEndorsementChangeAgent(ChangeAgentViewModel changeAgentModel)
        {
            try
            {
                if (changeAgentModel != null)
                {
                    ...
                    var policy = DelegateService.TransportChangeAgentService.CreateEndorsementChangeAgent(companyPolicy.Endorsement);
                    return new UifJsonResult(true, policy);
                }
                else
                {
