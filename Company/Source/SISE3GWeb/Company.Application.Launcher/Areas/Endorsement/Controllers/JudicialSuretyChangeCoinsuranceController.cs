...
{
    public class JudicialSuretyChangeCoinsuranceController : ChangeCoinsuranceController
    {
        [Authorize]
        public ActionResult CreateTemporal(ChangeCoinsuranceViewModel changeCoinsuranceViewModel)
        {
            ...
            try
            {
                ...
                var policy = DelegateService.judicialSuretyChangeCoinsuranceServiceCompany.CreateTemporal(CompanyPolicy, false);
                if (policy != null)
                {
        ...
        public ActionResult CreateEndorsementChangeCoinsurance(ChangeCoinsuranceViewModel changeCoinsuranceViewModel)
        {
            try
            {
                if (changeCoinsuranceViewModel != null)
                {
                    ...
                    var policy = DelegateService.judicialSuretyChangeCoinsuranceServiceCompany.CreateEndorsementChangeCoinsurance(companyPolicy.Endorsement);
