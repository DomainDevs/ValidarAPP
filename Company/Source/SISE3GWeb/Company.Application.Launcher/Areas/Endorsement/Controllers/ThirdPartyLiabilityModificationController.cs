...
{
    public class ThirdPartyLiabilityModificationController : ModificationController
    {
        public ActionResult CreateTemporal(ModificationViewModel modificationModel)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var policy = DelegateService.thirdPartyLiabilityModificationServiceCia.CreateTemporal(CompanyEndorsement, false);
        ...
        public ActionResult CreateTexts(ModificationViewModel modificationModel)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(CompanyEndorsement.Text.TextBody))
                    ...
                    companyPolicy = DelegateService.thirdPartyLiabilityTextServiceCia.CreateTexts(CompanyEndorsement);
        ...
        public ActionResult CreateClauses(ModificationViewModel modificationModel)
        {
            ...
            try
            {
                ...
                var companyPolicy = DelegateService.thirdPartyLiabilityClauseServiceCia.CreateClauses(policy);
