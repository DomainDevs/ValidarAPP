...
{
    public class SuretyChangeCoinsuranceController : ChangeCoinsuranceController
    {
        [Authorize]
        public ActionResult CreateTemporal(ChangeCoinsuranceViewModel changeCoinsuranceViewModel)
        {
            ...
            try
            {
                ...
                var policy = DelegateService.ciaSuretyChangeCoinsuranceService.CreateTemporal(CompanyPolicy, false);
                if (policy != null)
                {
        ...
        public ActionResult CreateEndorsementChangeCoinsurance(ChangeCoinsuranceViewModel changeCoinsuranceViewModel)
        {
            try
            {
                if (changeCoinsuranceViewModel != null)
                {
                    ...
                    var policy = DelegateService.ciaSuretyChangeCoinsuranceService.CreateEndorsementChangeCoinsurance(companyPolicy.Endorsement);
