...
{
    public class FidelityChangeAgentController : ChangeAgentController
    {
        ...
        public ActionResult CreateTemporal(ChangeAgentViewModel changeAgentModel)
        {
            try
            {
                ...
                var policy = DelegateService.fidelityChangeAgentServiceCia.CreateTemporal(CompanyPolicy, false);
                if (policy != null)
                {
        ...
        public ActionResult CreateEndorsementChangeAgent(ChangeAgentViewModel changeAgentModel)
        {
            try
            {
                if (changeAgentModel != null)
                {
                    ...
                    var policy = DelegateService.fidelityChangeAgentServiceCia.CreateEndorsementChangeAgent(companyPolicy.Endorsement);
                    return new UifJsonResult(true, policy);
                }
                else
                {
