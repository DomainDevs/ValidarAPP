    ...
    public class LiabilityModificationController : ModificationController
    {
        public ActionResult CreateTemporal(ModificationViewModel modificationModel)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var policy = DelegateService.liabilityModificationServiceCia.CreateTemporal(CompanyEndorsement, false);
        ...
        public ActionResult CreateTexts(ModificationViewModel modificationModel, CompanyModification companyModification)
        {
            ...
            try
            {
                ...
                companyPolicy = DelegateService.liabilityTextServiceCia.CreateTexts(CompanyEndorsement, companyModification);
        ...
        public ActionResult CreateClauses(ModificationViewModel modificationModel)
        {
            try
            {
                ...
                var policy = DelegateService.liabilityClauseService.CreateClauses(CompanyPolicy);
                if (policy != null)
                {
                    return new UifJsonResult(true, policy);
                }
