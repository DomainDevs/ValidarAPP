...
{
    public class FixedTermDepositViewModel
    {
        /// <summary>
        /// Sucursal
        /// </summary>
        ...
        /// Entidad emisora
        /// </summary>
        [Display(Name = "LabelIssuingEntity", ResourceType = typeof(App_GlobalResources.Language))]
        [Required(ErrorMessageResourceType = typeof(App_GlobalResources.Language), ErrorMessageResourceName = "ErrorDocument")]
        [StringLength(200, ErrorMessageResourceName = "ErrorMaxlengthCode", ErrorMessageResourceType = typeof(App_GlobalResources.Language))]
