class CoinsuranceMovementsRequest {
    ...
    static GetAccountingAccountConceptByBranchId(branchUserDefault) {
        return $.ajax({
            type: "GET",
            url: rootPath + "Accounting/Common/GetAccountingAccountConceptByBranchId?branchId=" + branchUserDefault + "&sourceId=2",
            dataType: "json",
            contentType: "application/json; charset=utf-8"
        });
    }
    ...
    static GetCoinsuranceTypes(branchUserDefault) {
        return $.ajax({
            type: "GET",
            url: rootPath + "Accounting/Common/GetCoinsuranceTypes",
            dataType: "json",
            contentType: "application/json; charset=utf-8"
        });
    }
