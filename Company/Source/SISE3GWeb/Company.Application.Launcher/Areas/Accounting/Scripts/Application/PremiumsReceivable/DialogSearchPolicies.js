...
function quotaOrderControlPremiums(branchPrefixPolicyEndorsement, quotaSelect) {
    var result = false;
    var chkErr = 0;
...
function deleteQuotaOrderControlPremiums(branchPrefixPolicyEndorsement, quotaSelect) {
...
function setDataFieldsEmptySearch() {
...
function SetTempDepositPrimeDataEmpty() {
...
function SetTempDepositPrimeData() {
...
function SetDataPremiumReceivableEmpty() {
...
function SetData(isDiscountedCommisson) {
    ...
    if (PayableAmount !=0 ) {
        ...
        oPremiumReceivableItemModel.IncomeAmount = parseFloat(ClearFormatCurrency($("#DepositAmountPayingAmount").val().replace("", ",")));
    }    
...
function showDepositPremiumEdit(data) {
...
function SetDataPremiumReceivable(data) {
...
function checkPremiumReceivable(policyId, endorsementId, paymentNum, payerIndividualId) {
...
function delRow(premiumReceivableItemId) {
...
function ValidatePolicyComponents(policyId, endorsementId) {
...
function deleteTempUPD(tempPremiumReceivableId) {
    $.ajax({
        async: false,
...
function echangeRateCollect(currencyId) {
