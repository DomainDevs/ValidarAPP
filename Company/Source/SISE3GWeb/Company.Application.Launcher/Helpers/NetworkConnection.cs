...
{
    /// <summary>
    /// Clase para conexion a red con autenticacion sobre el dominio
    /// </summary>
    public class NetworkConnection : IDisposable
    {
        ...
        public readonly int _resultConnection;
        ...
        public NetworkConnection(string networkName, NetworkCredential credentials)
        {
            ...
            {
                userDomain = credentials.Domain + @"\" + credentials.UserName;
            }
            else
            {
                userDomain = credentials.UserName;
            }

            var result = WNetAddConnection2(
                netResource, credentials.Password, userDomain, 0);

            if (result != 0)
            {
                _resultConnection = result;
            }
        }
        ...
        #region Metodos Privados Staticos
    ...
    #region Objetos necesarios para Win32
