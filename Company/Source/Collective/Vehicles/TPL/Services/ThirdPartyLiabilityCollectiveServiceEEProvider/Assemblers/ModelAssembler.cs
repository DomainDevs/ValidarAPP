...
namespace Sistran.Company.Application.Vehicles.TPLCollectiveServices.EEProvider.Assemblers
{
    public class ModelAssembler
    {
        ...
        public static CompanyTplRisk CreateTemporalCompanyTplRisk(TMPEN.TempRisk tempRisk, TMPEN.CoTempRisk coTempRisk, TMPEN.TempRiskVehicle tempRiskVehicle, TMPEN.CoTempRiskVehicle coTempRiskVehicle)
        {
            CompanyTplRisk model = new CompanyTplRisk
            {
                ...
                StandardPrice = tempRiskVehicle.StdVehiclePrice.Value,
