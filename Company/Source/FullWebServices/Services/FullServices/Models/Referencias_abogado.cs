...
{
	[DataContract]
	public class Referencias_abogado
	{

		#region InnerClass
		public enum Referencias_abogadoFields
		{
			cod_abogado,
			tipo_ref_abogado,
			sn_ref1,
		...
		[DataMember]
		public double  tipo_ref_abogado
		{
			 get { return _tipo_ref_abogado; }
			 set {_tipo_ref_abogado = value;}
		}
