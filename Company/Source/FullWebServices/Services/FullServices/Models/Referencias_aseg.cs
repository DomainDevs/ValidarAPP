...
{
	[DataContract]
	public class Referencias_aseg
	{

		#region InnerClass
		public enum Referencias_asegFields
		{
			cod_aseg,
			tipo_ref_aseg,
			sn_ref1,
		...
		[DataMember]
		public double  tipo_ref_aseg
		{
			 get { return _tipo_ref_aseg; }
			 set {_tipo_ref_aseg = value;}
		}
