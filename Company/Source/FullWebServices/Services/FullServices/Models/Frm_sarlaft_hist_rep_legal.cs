...
{
	[DataContract]
	public class Frm_sarlaft_hist_rep_legal
	{

		#region InnerClass
		public enum Frm_sarlaft_hist_rep_legalFields
		{
			id_persona,
			nro_doc_rep_legal,
			cod_tipo_doc,
		...
		#region Data Members
			...
			double _vr_facultades;
			string _txt_cargo;
			double _cod_unidad;
			string _fec_modifica;
			string _usuario_modifica;
			int _identity; 
			char _state; 
			string _connection; 
