...
namespace Sistran.Company.Application.UnderwritingServices.Assembler
{
    public class ModelAssembler
    {
        public static void CreateFacadeGeneral(CompanyPolicy companyPolicy, Rules.Facade facade)
        {
            ...
            if (companyPolicy.Holder != null)
            {
                ...
                {
                    facade.SetConcept(CompanyRuleConceptGeneral.AssociationType, companyPolicy.Holder.IndividualId);
                }
            }
            ...
            Core.Application.CommonService.Models.Parameter parameterAppSourceR2 = DelegateBaseService.commonService.GetParameterByParameterId((int)ParametersTypes.ConceptAppSourceR2);
            ...
            int? paramter = DelegateBaseService.commonService.GetParameterByParameterId(parameterTempSubscription).NumberParameter;
