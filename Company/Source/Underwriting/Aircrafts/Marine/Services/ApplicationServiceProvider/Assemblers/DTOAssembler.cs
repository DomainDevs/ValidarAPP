...
namespace Sistran.Company.Application.Marines.MarineApplicationService.EEProvider.Assemblers
{
    public class DTOAssembler
    {
        ...
        /// Crea un Marinee
        /// </summary>
        /// <param name="companyMarine">un Marinee</param>
        /// <returns>un MarineeDTO MarineDTO</returns>
        public static MarineDTO CreateMarine(CompanyMarine companyMarine)
        {
            ...
            {
                Id = companyMarine.Risk.Id,
                Description = companyMarine.Risk.Description,
                UseDescription = companyMarine.UseDescription,
                UseId = companyMarine.UseId,
                YearManufacturing = companyMarine.CurrentManufacturing,
                BoatName = companyMarine.BoatName,
                CoverageGroupId = companyMarine.Risk.GroupCoverage.Id,
                RiskId = companyMarine.Risk.RiskId,
                PolicyId = (companyMarine.Risk.Policy == null) ? 0 : companyMarine.Risk.Policy.Id,
                InsuredObjects = CreateInsuredObjects(companyMarine.InsuredObjects)
            };
        }

        /// <summary>
        /// Crea una lista de Marinees
        /// </summary>
        /// <param name="companyMarines">una lista de Marinee</param>
        /// <returns>listado de MarineeDTO List<MarineDTO></returns>
        public static List<MarineDTO> CreateMarines(List<CompanyMarine> companyMarines)
        {
            List<MarineDTO> MarineDTOs = new List<MarineDTO>();

            foreach (var companyMarine in companyMarines)
            {
                MarineDTOs.Add(CreateMarine(companyMarine));
            }
        ...
        /// <summary>
        /// Crea un tipo de Marinee
        /// </summary>
        /// <param name="MarineType">tipo de Marinee</param>
        /// <returns>un tipo de MarineeDTO MarinetypeDTO</returns>
        public static MarineTypeDTO CreateMarineType(MarineType MarineType)
        {
            if (MarineType == null)
            {
                return null;
            ...
            return new MarineTypeDTO
            {
                Id = MarineType.Id,
                Description = MarineType.Description
            };
        }

        /// <summary>
        /// Crea una lista del tipo de Marinee
        /// </summary>
        /// <param name="MarineTypes">listado de Marinee</param>
        /// <returns>Listado de tipos de Marinee List<MarineTypeDTO></returns>
        public static List<MarineTypeDTO> CreateMarineTypes(List<MarineType> MarineTypes)
        {
            List<MarineTypeDTO> MarineTypeDTO = new List<MarineTypeDTO>();

            foreach (var MarineType in MarineTypes)
            {
                MarineTypeDTO.Add(CreateMarineType(MarineType));
            }

            return MarineTypeDTO;
        }

        /// <summary>
        /// Trae la lista del tipo de Marinee
        /// </summary>
        /// <param name="MarineTypes"></param>
        /// <returns>Listado de identificadores</returns>
        public static List<int> CreateMarineTypeIds(List<MarineType> MarineTypes)
        {
            List<int> MarineTypeDTO = new List<int>();

            foreach (var MarineType in MarineTypes)
            {
                MarineTypeDTO.Add(MarineType.Id);
            }
        ...
        /// <param name="MarineTypes"></param>
        /// <returns>Listado de identificadores</returns>
        public static List<string> CreateMarineTypeDescriptions(List<MarineType> MarineTypes)
        {
            List<string> MarineTypeDTO = new List<string>();

            foreach (var MarineType in MarineTypes)
            {
                MarineTypeDTO.Add(MarineType.Description);
            }
        ...
        /// <param name="companyMarines">una lista de Marinee</param>
        /// <returns>listado de MarineeDTO List<MarineDTO></returns>
        public static List<MarineDTO> CreateMarinesByEndorsementId(List<CompanyMarine> companyMarines)
        {
            List<MarineDTO> MarineDTOs = new List<MarineDTO>();
        ...
        public static UsePrefixDTO CreateMarineUse(Use MarineUse)
        {
            if (MarineUse == null)
            {
                return null;
            ...
            return new UsePrefixDTO
            {
                Id = MarineUse.Id,
                Description = MarineUse.Description
            };
        }
        ...
        public static List<UsePrefixDTO> CreateMarineUses(List<Use> MarineUses)
        {
            List<UsePrefixDTO> useDTOs = new List<UsePrefixDTO>();

            foreach (var MarineUse in MarineUses)
            {
                useDTOs.Add(CreateMarineUse(MarineUse));
            }
