...
namespace ConsumerQueueService
{
    [RunInstaller(true)]
    public partial class ProjectInstaller : Installer
    {
        ...
        private ServiceInstaller GetServiceInstaller()
        {
            ...
            installer.ServiceName = GetConfigurationValue("ServiceName", "SistranConsumerQueue");
            installer.DisplayName = GetConfigurationValue("DisplayName", "Sistran Consumer Queue");
