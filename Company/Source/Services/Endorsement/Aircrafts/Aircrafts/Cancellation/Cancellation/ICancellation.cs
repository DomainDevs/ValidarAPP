...
namespace Sistran.Company.Application.AircraftCancellationService
{
    [ServiceContract]
    public interface ICiaAircraftCancellationService : ICiaCancellationEndorsement
    {
        /// <summary>
        ...
        [OperationContract]
        CompanyPolicy ExecuteThread(List<CompanyAircraft> risksThread, CompanyPolicy policy, List<CompanyRisk> risks);
    }
}
