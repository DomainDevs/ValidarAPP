...
using Sistran.Company.Application.TransportModificationService.EEProvider.Business;

namespace Sistran.Company.Application.TransportModificationService.EEProvider
{
    public class TransportModificationEEProvider : ITransportModificationServiceCia
    {
        /// <summary>
        /// Creacion Temporal
        /// </summary>
