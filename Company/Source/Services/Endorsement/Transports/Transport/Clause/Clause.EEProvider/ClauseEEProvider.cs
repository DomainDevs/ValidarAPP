...
using Sistran.Company.Application.TransportClauseService.EEProvider.Business;
using Sistran.Core.Framework.BAF;

namespace Sistran.Company.Application.TransportClauseService.EEProvider
{
    public class TransportClauseServiceEEProvider :  ITransportClauseService
    {
        ...
        public CompanyPolicy CreateTemporal(CompanyEndorsement companyEndorsement, bool isMassive, bool isSaveTemp)
        {
            try
            {
                TransportEndorsementBusinessCia endorsementBusinessCia = new TransportEndorsementBusinessCia();
