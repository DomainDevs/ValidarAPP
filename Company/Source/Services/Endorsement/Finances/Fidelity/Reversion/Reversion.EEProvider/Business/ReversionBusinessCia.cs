...
using Sistran.Company.Application.FidelityReversionService.EEProvider.DAOs;
using Sistran.Company.Application.FidelityReversionService.EEProvider.Resources;
...
namespace Sistran.Company.Application.FidelityReversionService.EEProvider.Business
{
    public class FidelityReversionBusinessCia
    {
        BaseBusinessCia provider;

        public FidelityReversionBusinessCia()
        {
