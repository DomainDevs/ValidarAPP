...
using Sistran.Company.Application.VehicleReversionService.EEProvider.Assemblers;
...
namespace Sistran.Company.Application.PropertyReversionService.EEProvider.DAOs
{
    public class ReversionDAOCia
    {
        ...
        public List<PoliciesAut> ValidateAuthorizationPolicies(CompanyPolicy policy)
        {
            ...
            UnderwritingServices.Assembler.ModelAssembler.CreateFacadeGeneral(policy, facade);
