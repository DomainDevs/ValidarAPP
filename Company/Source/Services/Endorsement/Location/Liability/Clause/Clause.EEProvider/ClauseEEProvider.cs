...
using Sistran.Company.Application.LiabilityClauseService.EEProvider.Business;
using Sistran.Core.Framework.BAF;

namespace Sistran.Company.Application.LiabilityClauseService.EEProvider
{
    public class LiabilityClauseServiceEEProvider: ILiabilityClauseServiceCia
    {
