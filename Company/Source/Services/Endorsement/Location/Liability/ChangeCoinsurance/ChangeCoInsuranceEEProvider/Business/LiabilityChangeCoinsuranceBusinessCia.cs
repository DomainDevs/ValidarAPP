...
namespace Sistran.Company.Application.LiabilityChangeCoinsuranceService.EEProvider.Business
{
    public class LiabilityChangeCoinsuranceBusinessCia
    {
        BaseBusinessCia baseBusinessCia;
        /// <summary>
        /// Initializes a new instance of the <see cref="LiabilityChangeCoinsuranceBusinessCia"/> class.
        /// </summary>
        public LiabilityChangeCoinsuranceBusinessCia()
        {
                ...
                if (companyLibialitys != null && companyLibialitys.Count > 0 && risks != null)
                {
                    ...
                    z =>
                    {
                        ...
                        if (companyRisk != null)
                        {
                            ...
                            companyRisk.Coverages.ForEach(x => x.IsPrimary = z.Risk.Coverages.FirstOrDefault(y => y.Id == x.Id).IsPrimary);
        ...
        public List<CompanyPolicy> CreateEndorsementChangeCoinsurance(CompanyEndorsement companyEndorsement, bool clearPolicies)
        {
            try
            {
                ...
                try
                {
                    ...
                    var createEndorsementChangeCoinsurance = CreatelibialityEndorsementChangeCoinsurance(companyEndorsement);
                ...
                catch (Exception)
                {
                    ...
                    throw new Exception(Errors.ErrorCreateTemporalChangeCoinsuranceLibiality);
                }
        ...
        /// <param name="companyEndorsement">The company endorsement.</param>
        /// <returns></returns>
        private CompanyPolicy CreatelibialityEndorsementChangeCoinsurance(CompanyEndorsement companyEndorsement)
        {
