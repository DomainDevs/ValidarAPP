...
namespace Sistran.Company.Application.JudicialSuretyChangeCoinsuranceService.EEProvider.Business
{
    public class JudicialSuretyChangeCoinsuranceBusiness
    {
        BaseBusinessCia baseBusinessCia;
        /// <summary>
        /// Initializes a new instance of the <see cref="SuretyChangeCoinsuranceBusinessCia"/> class.
        /// </summary>
        public JudicialSuretyChangeCoinsuranceBusiness()
        {
        ...
        public List<CompanyPolicy> CreateEndorsementChangeCoinsurance(CompanyEndorsement companyEndorsement, bool clearPolicies)
        {
            try
            {
                ...
                if (cancelation?.InfringementPolicies?.Count > 0)
                {
                    companyPolicies.Add(new CompanyPolicy { InfringementPolicies = cancelation?.InfringementPolicies, Endorsement = companyEndorsement });
                    return companyPolicies;
                }
                try
                {
                ...
                catch (Exception)
                {
                    ...
                    throw new Exception(Errors.ErrorCreateTemporalChangeCoinsuranceSurety);
                }
