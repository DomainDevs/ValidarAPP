...
namespace Sistran.Company.Application.SuretyTextService.EEProvider.Business
{
    using Sistran.Company.Application.BaseEndorsementService.EEProvider.Business;
    using Sistran.Company.Application.Sureties.SuretyServices.Models;
    using Sistran.Company.Application.SuretyTextService.EEProvider.Resources;
    using Sistran.Company.Application.SuretyTextService.EEProvider.Services;
    ...
    /// Endosos Autos
    /// </summary>
    public class SuretyTextBusinessCia
    {
        ...
        public CompanyPolicyResult CreateEndorsementText(CompanyEndorsement companyEndorsement, CompanyModification companyModification)
        {
            ...
            try
            {
                ...
                if (companySuretys != null && companySuretys.Count > 0)
                {
                    ...
                    return suretyServiceEEProvider.CreateCompanyPolicy(policy.Id, (int)policy.TemporalType, false, companyModification);
                }
                else
                {
