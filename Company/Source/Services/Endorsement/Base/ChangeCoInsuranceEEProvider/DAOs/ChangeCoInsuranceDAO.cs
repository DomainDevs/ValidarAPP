...
using Sistran.Company.Application.ChangeCoInsuranceEndorsement.EEProvider.Entities.Views;
using Sistran.Company.Application.UnderwritingServices;
using Sistran.Company.Application.UnderwritingServices.Models;
using Sistran.Company.ChangeCoInsuranceEndorsement.EEProvider.Assemblers;
using Sistran.Company.ChangeCoInsuranceEndorsement.EEProvider.Resources;
...
namespace Sistran.Company.ChangeCoInsuranceEndorsement.EEProvider.DAOs
{
    public class ChangeCoInsuranceDAO
    {
        /// <summary>
        ...
        public List<CompanyRisk> QuotateChangeCoinsuranceCia(CompanyPolicy policy)
        {
            ...
            if (endorsements != null && endorsements.Any())
            {
                ...
                CoverageCoinsuranceEndorsement view = new CoverageCoinsuranceEndorsement();
                ViewBuilder builder = new ViewBuilder("CoverageCoinsuranceEndorsement");
                        ...
                        Parallel.ForEach<ISSEN.EndorsementRisk, List<CompanyRisk>>(endorsementRisks,
                          ...
                          (risk, state, localrisk) =>
                          {
                              ...
                              TP.Parallel.ForEach(currenRiks.Coverages, (coverage) =>
                              {
                                  ...
                                  coverage.EndorsementType = EndorsementType.ChangeCoinsuranceEndorsement;
