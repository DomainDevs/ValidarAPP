...
using Sistran.Company.Application.ChangePolicyHolderEndorsement.EEProvider.Entities.Views;
using Sistran.Company.Application.UnderwritingServices;
using Sistran.Company.Application.UnderwritingServices.Models;
using Sistran.Company.ChangePolicyHolderEndorsement.EEProvider.Assemblers;
using Sistran.Company.ChangePolicyHolderEndorsement.EEProvider.Resources;
...
namespace Sistran.Company.ChangePolicyHolderEndorsement.EEProvider.DAOs
{
    public class ChangePolicyHolderDAO
    {
        /// <summary>
        ...
        public List<CompanyRisk> QuotateChangePolicyHolderCia(CompanyPolicy policy)
        {
            ...
            if (endorsements != null && endorsements.Any())
            {
                ...
                CoverageHolderEndorsement view = new CoverageHolderEndorsement();
                ViewBuilder builder = new ViewBuilder("CoverageHolderEndorsement");
                        ...
                        Parallel.ForEach<ISSEN.EndorsementRisk, List<CompanyRisk>>(endorsementRisks,
                          ...
                          (risk, state, localrisk) =>
                          {
                              ...
                              TP.Parallel.ForEach(currenRiks.Coverages, (coverage) =>
                              {
                                  ...
                                  coverage.EndorsementType = EndorsementType.ChangePolicyHolderEndorsement;
