using AutoMapper;
using Sistran.Company.Application.ChangeAgentEndorsement.EEProvider.Assemblers;
using Sistran.Company.Application.ChangeAgentEndorsement.EEProvider.Entities.Views;
using Sistran.Company.Application.UnderwritingServices;
using Sistran.Company.Application.UnderwritingServices.Models;
using Sistran.Company.ChangeAgentEndorsement.EEProvider.Resources;
...
namespace Sistran.Company.Application.ChangeAgentEndorsement.EEProvider.DAOs
{
    /// <summary>
    /// Cambio de intermediario
    /// </summary>
    public class CiaChangeAgentDAO
    {
        ...
        public List<CompanyRisk> QuotateChangeAgentCia(CompanyPolicy policy)
        {
            ...
            if (endorsements != null && endorsements.Any())
            {
                ...
                CompanyCoverageEndorsementAgent view = new CompanyCoverageEndorsementAgent();
                ViewBuilder builder = new ViewBuilder("CompanyCoverageEndorsementAgent");
                        ...
                        Parallel.ForEach<ISSEN.EndorsementRisk, List<CompanyRisk>>(endorsementRisks,
                          ...
                          (risk, state, localrisk) =>
                          {
                              ...
                              TP.Parallel.ForEach(currenRiks.Coverages, (coverage) =>
                              {
                                  ...
                                  coverage.EndorsementType = EndorsementType.ChangeAgentEndorsement;
        ...
        {
            var mapper = ModelAssembler.CreateMapEndorsement();
            var result = mapper.Map<Policy, CompanyPolicy>(DelegateService.baseEndorsementService.CreateEndorsement(Id));
            return result;
        }
    }
}
