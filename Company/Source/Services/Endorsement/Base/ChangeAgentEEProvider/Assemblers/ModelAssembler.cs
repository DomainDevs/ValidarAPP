...
namespace Sistran.Company.Application.ChangeAgentEndorsement.EEProvider.Assemblers
{
    public class ModelAssembler
    {
        ...
        public static List<CompanyCoverage> CreateCiaCoverages(List<ISSEN.RiskCoverage> riskCoverages)
        {
            ...
            companyCoverage.AsParallel().ForAll(x =>
            {
                ...
                {
                    Parallel.ForEach(dinamicPropertyList, item =>
                    {
        ...
        /// </summary>
        /// <param name="riskCoverage">The risk coverage.</param>
        /// <returns></returns>
