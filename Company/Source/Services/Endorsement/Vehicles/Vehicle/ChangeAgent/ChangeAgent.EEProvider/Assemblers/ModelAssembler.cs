...
namespace Sistran.Company.Application.VehicleChangeAgentService.EEProvider.Assemblers
{
    public class ModelAssembler
    {
        ...
        public static List<CRM.CompanyRisk> CreateCompanyRisk(List<RM.Risk> risk)
        {
            ...
            var config = MapperCache.GetMapper<RM.Beneficiary, CRM.CompanyBeneficiary>(cfg =>
            {
