...
using Sistran.Company.Application.ThirdPartyLiabilityClauseService.EEProvider.Business;
using Sistran.Core.Framework.BAF;

namespace Sistran.Company.Application.ThirdPartyLiabilityClauseService.EEProvider
{
    public class ThirdPartyLiabilityClauseServiceEEProvider: IThirdPartyLiabilityClauseServiceCia
    {
