...
namespace Sistran.Company.Application.ThirdPartyLiabilityCancellationService
{
    [ServiceContract]
    public interface IThirdPartyLiabilityCancellationServiceCia
    {
        /// <summary>
        ...
        [OperationContract]
        CompanyPolicy ExecuteThread(List<TPLEM.CompanyTplRisk> risksThread, CompanyPolicy policy, List<CompanyRisk> risks);
    }
}
